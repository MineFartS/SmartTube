...
package smartyoutubetv2.ui.mod.leanback.playerglue.tooltips;
...
import smartyoutubetv2.ui.playback.actions.PaddingAction;
...
public class ControlButtonPresenterSelector extends PresenterSelector {
    ...
    public static class ControlButtonPresenter extends Presenter {
        ...
        // Used inside: smartyoutubetv2.ui.mod.leanback.playerglue.tweaks.ControlBarPresenter.ViewHolder.bindControlToAction()
        // Restore focus: smartyoutubetv2.ui.mod.leanback.playerglue.tweaks.ControlBar.onRequestFocusInDescendants()
        @Override
