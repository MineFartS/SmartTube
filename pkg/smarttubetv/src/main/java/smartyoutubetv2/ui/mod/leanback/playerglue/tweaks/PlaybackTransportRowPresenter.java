 ...
 */
package smartyoutubetv2.ui.mod.leanback.playerglue.tweaks;
...
import smartyoutubetv2.ui.mod.leanback.misc.SeekBar;
import smartyoutubetv2.ui.mod.leanback.playerglue.tooltips.ControlButtonPresenterSelector;
import smartyoutubetv2.ui.mod.leanback.playerglue.tweaks.ControlBarPresenter.OnControlClickedListener;
import smartyoutubetv2.ui.mod.leanback.playerglue.tweaks.ControlBarPresenter.OnControlLongClickedListener;
import smartyoutubetv2.ui.mod.leanback.playerglue.tweaks.ControlBarPresenter.OnControlSelectedListener;
import smartyoutubetv2.ui.mod.leanback.playerglue.seekpreview.ThumbsBar;
import smartyoutubetv2.ui.mod.leanback.widget.OnActionLongClickedListener;
...
public class PlaybackTransportRowPresenter extends PlaybackRowPresenter {
    ...
    public class ViewHolder extends PlaybackRowPresenter.ViewHolder implements PlaybackSeekUi {
        ...
        public ViewHolder(View rootView, Presenter descriptionPresenter) {
            ...
            mDateTime = (TextView) rootView.findViewById(smartyoutubetv2.R.id.date_time);

            mRemainingTimeFormat = rootView.getContext().getString(smartyoutubetv2.R.string.player_remaining_time);
            mAdditionalInfo = (ViewGroup) rootView.findViewById(smartyoutubetv2.R.id.additional_info);
            mTimeInfo = (ViewGroup) rootView.findViewById(smartyoutubetv2.R.id.time_info);
            mTopEdge = (ViewGroup) rootView.findViewById(smartyoutubetv2.R.id.top_edge);
            ...
            mThumbsBarTitle = (TextView) rootView.findViewById(smartyoutubetv2.R.id.thumbs_row_title);
            mThumbsBarWrapper = (ViewGroup) rootView.findViewById(smartyoutubetv2.R.id.thumbs_row_wrapper);
        }
    ...
    public PlaybackTransportRowPresenter() {
        ...
        mPlaybackControlsPresenter = new ControlBarPresenter(smartyoutubetv2.R.layout.lb_control_bar);
        mPlaybackControlsPresenter.setDefaultFocusToMiddle(false);
        mPlaybackControlsPresenter.setFocusRecovery(true);
        mSecondaryControlsPresenter = new ControlBarPresenter(smartyoutubetv2.R.layout.lb_control_bar);
    ...
    protected RowPresenter.ViewHolder createRowViewHolder(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext()).inflate(
                smartyoutubetv2.R.layout.lb_playback_transport_controls_row, parent, false);
