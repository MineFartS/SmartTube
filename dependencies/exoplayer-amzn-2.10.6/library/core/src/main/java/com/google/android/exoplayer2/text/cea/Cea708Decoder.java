...
public final class Cea708Decoder extends CeaDecoder {
  ...
  private void handleSetPenAttributes() {
    ...
    currentCueBuilder.setPenAttributes(
  ...
  private void handleSetPenColor() {
    ...
    int foregroundColor =
        CueBuilder.getArgbColorFromCeaColor(foregroundR, foregroundG, foregroundB, foregroundO);
    // second byte
    ...
    int backgroundColor =
        CueBuilder.getArgbColorFromCeaColor(backgroundR, backgroundG, backgroundB, backgroundO);
    // third byte
  ...
  private void handleSetWindowAttributes() {
    ...
    currentCueBuilder.setWindowAttributes(
        fillColor,
        borderColor,
        wordWrapToggle,
        borderType,
