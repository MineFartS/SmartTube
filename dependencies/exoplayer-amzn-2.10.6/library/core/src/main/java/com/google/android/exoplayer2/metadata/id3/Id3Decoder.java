...
public final class Id3Decoder implements MetadataDecoder {
  ...
  private static ChapterFrame decodeChapterFrame(
    ...
    String chapterId =
        new String(id3Data.data, framePosition, chapterIdEndIndex - framePosition, "ISO-8859-1");
  ...
  private static ChapterTocFrame decodeChapterTOCFrame(
    ...
    String elementId =
        new String(id3Data.data, framePosition, elementIdEndIndex - framePosition, "ISO-8859-1");
