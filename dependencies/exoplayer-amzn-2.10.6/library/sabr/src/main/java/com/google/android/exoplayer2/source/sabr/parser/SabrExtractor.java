...
public class SabrExtractor implements Extractor {
  ...
  /**
   * @param trackType The type of the track. Typically one of the {@link
  ...
  private SabrExtractor(
      @Flags int flags, int trackType, @NonNull Format format, @NonNull SabrStream sabrStream) {
