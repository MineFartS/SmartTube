...
public abstract class Representation {
  ...
  public static Representation newInstance(Format format, String baseUrl, SegmentBase segmentBase) {
  ...
  public static Representation newInstance(
      long revisionId, Format format, String baseUrl, SegmentBase segmentBase, String cacheKey) {
    if (segmentBase instanceof SingleSegmentBase) {
      return new SingleSegmentRepresentation(
          revisionId, format, baseUrl, (SingleSegmentBase) segmentBase, cacheKey, C.LENGTH_UNSET);
  ...
  private Representation(long revisionId, Format format, String baseUrl, SegmentBase segmentBase) {
  ...
  public static class MultiSegmentRepresentation extends Representation
    ...
    public MultiSegmentRepresentation(
        long revisionId, Format format, String baseUrl, MultiSegmentBase segmentBase) {
      super(revisionId, format, baseUrl, segmentBase);
