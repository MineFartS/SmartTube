...
/**
 * Broken writer. This writer always throws an {@link IOException} from all {@link Writer} methods.
 *
 * <p>This class is mostly useful for testing error handling in code that uses a writer.
 *
 * @since 2.0
 */
