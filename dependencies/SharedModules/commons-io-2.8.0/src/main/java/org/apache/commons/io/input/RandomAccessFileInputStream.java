...
public class RandomAccessFileInputStream extends InputStream {
  ...
  /**
   * Constructs a new instance configured to leave the underlying file open when this stream is
   * closed.
   *
   ...
   * stream.
   *
   * <p>If there are more than {@link Integer#MAX_VALUE} bytes available, return {@link
   * Integer#MAX_VALUE}.
   *
