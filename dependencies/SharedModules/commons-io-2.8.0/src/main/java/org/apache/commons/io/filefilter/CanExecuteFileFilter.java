 ...
 *
 * <p>Example, showing how to print out a list of the current directory's <i>executable</i> files:
 *
 * <pre>
 * File dir = new File(".");
 ...
 * </pre>
 *
 * <p>Example, showing how to print out a list of the current directory's <i>un-executable</i>
 * files:
 *
 * <pre>
 * File dir = new File(".");
