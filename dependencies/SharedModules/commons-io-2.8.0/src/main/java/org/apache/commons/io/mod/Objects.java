...
package org.apache.commons.io.mod;

import java.util.Arrays;
import java.util.Comparator;
import java.util.List;

// MOD: API Level 17 fix. Copy file from android sdk.
 ...
 * object, returning a string for an object, and comparing two objects.
 *
 * @since 1.7
 */
public final class Objects {
   ...
   *
   * <p>Note that if one of the arguments is {@code null}, a {@code NullPointerException} may or may
   * not be thrown depending on what ordering policy, if any, the {@link Comparator Comparator}
