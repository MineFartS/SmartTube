...
public class LockableFileWriter extends Writer {
   ...
   * @since 2.3
   */
  public LockableFileWriter(File file, final Charset charset, final boolean append, String lockDir)
      throws IOException {
    super();
  ...
  public LockableFileWriter(
      final File file, final String charsetName, final boolean append, final String lockDir)
      throws IOException {
  ...
  private Writer initWriter(final File file, final Charset charset, final boolean append)
    ...
    try {
      return new OutputStreamWriter(
          new FileOutputStream(file.getAbsolutePath(), append), Charsets.toCharset(charset));
