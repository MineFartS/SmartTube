...
/**
 * Broken reader. This reader always throws an {@link IOException} from all the {@link Reader}
 * methods where the exception is declared.
 *
 * <p>This class is mostly useful for testing error handling in code that uses a reader.
 *
 * @since 2.7
 */
