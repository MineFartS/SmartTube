...
/**
 * Implementation of a buffered input stream, which is internally based on the {@link
 * CircularByteBuffer}. Unlike the {@link java.io.BufferedInputStream}, this one doesn't need to
 * reallocate byte arrays internally.
 */
public class CircularBufferInputStream extends InputStream {
   ...
   * buffer size ({@link IOUtils#DEFAULT_BUFFER_SIZE}).
   *
   * @param inputStream The input stream, which is being buffered.
   */
  ...
  /**
   * Fills the buffer from the input stream until the given number of bytes have been added to the
   * buffer.
   *
