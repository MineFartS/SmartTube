 ...
 * org.apache.commons.io.input.ObservableInputStream.Observer}, which calculates a checksum using a
...
public class MessageDigestCalculatingInputStream extends ObservableInputStream {
  ...
  public MessageDigestCalculatingInputStream(
      final InputStream inputStream, final MessageDigest MessageDigest) {
    super(inputStream);
    this.messageDigest = MessageDigest;
