 ...
 *
 * <p>The first exception in the list is used as this exception's cause and is accessible with the
 * usual {@link #getCause()} while the complete list is accessible with {@link #getCauseList()}.
 *
 * @since 2.7
 */
...
public class IOExceptionList extends IOException {
  ...
  public IOExceptionList(final List<? extends Throwable> causeList) {
    super(
        String.format("%,d exceptions: %s", causeList == null ? 0 : causeList.size(), causeList),
