...
public interface IOFunction<T, R> {
  ...
  /**
   * Returns a composed {@link IOFunction} that first applies the {@code before} function to its
   * input, and then applies this function to the result. If evaluation of either function throws an
  ...
  /**
   * Returns a composed {@link IOFunction} that first applies this function to its input, and then
  ...
  /**
   * Returns a composed {@link IOFunction} that first applies this function to its input, and then
   * applies the {@code after} consumer to the result. If evaluation of either function throws an
   * exception, it is relayed to the caller of the composed function.
   *
