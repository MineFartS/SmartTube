...
public class DeferredFileOutputStream extends ThresholdingOutputStream {
   ...
   * and save data to a file beyond that point. The initial buffer size will default to {@value
   * AbstractByteArrayOutputStream#DEFAULT_SIZE} bytes which is ByteArrayOutputStream's default
   * buffer size.
   *
