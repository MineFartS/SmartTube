...
public class ReversedLinesFileReader implements Closeable {
   ...
   */
  public ReversedLinesFileReader(final File file, final int blockSize, final String charsetName)
      throws IOException {
   ...
   * @since 2.7
   */
  public ReversedLinesFileReader(final Path file, final int blockSize, final Charset charset)
      throws IOException {
    ...
    if (maxBytesPerChar == 1f) {
      ...
      byteDecrement = 1;
    } else if (this.encoding == Charset.forName("Shift_JIS")
        || // Same as for UTF-8
        // http://www.herongyang.com/Unicode/JIS-Shift-JIS-Encoding.html
        this.encoding == Charset.forName("windows-31j")
        || // Windows code page 932 (Japanese)
        this.encoding == Charset.forName("x-windows-949")
        || // Windows code page 949 (Korean)
        this.encoding == Charset.forName("gbk")
        || // Windows code page 936 (Simplified Chinese)
        this.encoding
            == Charset.forName("x-windows-950")) { // Windows code page 950 (Traditional Chinese)
      byteDecrement = 1;
    } else if (this.encoding == StandardCharsets.UTF_16BE
   ...
   * @since 2.7
   */
  public ReversedLinesFileReader(final Path file, final int blockSize, final String charsetName)
      throws IOException {
   ...
   *
   * <p>If there are less than {@code lineCount} lines in the file, then that's what you get.
   *
   * <p>Note: You can easily flip the result with {@link Collections#reverse(List)}.
   *
