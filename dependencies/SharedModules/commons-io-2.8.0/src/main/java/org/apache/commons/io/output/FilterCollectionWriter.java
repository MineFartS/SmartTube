...
/**
 * Abstract class for writing filtered character streams to a {@link Collection} of writers. This is
 * in contrast to {@link FilterWriter} which is backed by a single {@link Writer}.
 *
 * <p>This abstract class provides default methods that pass all requests to the contained writers.
 * Subclasses should likely override some of these methods.
 *
 * <p>The class {@link Writer} defines method signatures with {@code throws} {@link IOException},
 * which in this class are actually {@link IOExceptionList} containing a list of {@link
 * IOIndexedException}.
 *
 * @since 2.7
 */
