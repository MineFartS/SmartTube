...
public class ObservableInputStream extends ProxyInputStream {
  ...
  public abstract static class Observer {
    ...
    /**
     * Called to indicate that EOF has been seen on the underlying stream. This method may be called
     * multiple times, if the reader keeps invoking either of the read methods, and they will
