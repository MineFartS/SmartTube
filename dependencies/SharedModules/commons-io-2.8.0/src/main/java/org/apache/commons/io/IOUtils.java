...
public class IOUtils {
   ...
   * @since 2.7
   */
  public static void close(final Closeable closeable, final IOConsumer<IOException> consumer)
      throws IOException {
    if (closeable != null) {
      try {
        closeable.close();
   ...
   * @since 2.0
   * @deprecated As of 2.6 deprecated without replacement. Please use the try-with-resources
   *     statement or handle suppressed exceptions manually.
  ...
  /**
   * Closes the given {@link Closeable} as a null-safe operation while consuming IOException by the
   * given {@code consumer}.
   *
   * @param closeable The resource to close, may be null.
   ...
   * @return the number of bytes copied, or -1 if &gt; Integer.MAX_VALUE, or {@code 0} if {@code
   *     input is null}.
   ...
   * @param input the <code>InputStream</code> to read from
   * @param output the <code>Writer</code> to write to
   * @param inputCharsetName the name of the requested charset for the InputStream, null means
   *     platform default
   * @throws NullPointerException if the input or output is null
   * @throws IOException if an I/O error occurs
  ...
  public static void copy(
      final InputStream input, final Writer output, final String inputCharsetName)
      throws IOException {
   ...
   * @since 2.7
   */
  public static long copy(final Reader input, final Appendable output, final CharBuffer buffer)
      throws IOException {
    long count = 0;
    int n;
   ...
   */
  public static void copy(
      final Reader input, final OutputStream output, final Charset outputCharset)
      throws IOException {
   ...
   * @param input the <code>Reader</code> to read from
   * @param output the <code>OutputStream</code> to write to
   * @param outputCharsetName the name of the requested charset for the OutputStream, null means
   *     platform default
   * @throws NullPointerException if the input or output is null
   * @throws IOException if an I/O error occurs
   * @throws java.nio.charset.UnsupportedCharsetException thrown instead of {@link java.io
   ...
   */
  public static void copy(
      final Reader input, final OutputStream output, final String outputCharsetName)
      throws IOException {
   ...
   * @since 2.6
   */
  public static String resourceToString(final String name, final Charset charset)
      throws IOException {
  ...
  public static String resourceToString(
      final String name, final Charset charset, final ClassLoader classLoader) throws IOException {
  ...
  public static long skip(final InputStream input, final long toSkip) throws IOException {
    ...
    while (remain > 0) {
      ...
      // delegating to skip()
      final long n =
          input.read(SKIP_BYTE_BUFFER, 0, (int) Math.min(remain, SKIP_BYTE_BUFFER.length));
      if (n < 0) { // EOF
        break;
      }
      remain -= n;
  ...
  public static long skip(final ReadableByteChannel input, final long toSkip) throws IOException {
    ...
    final ByteBuffer skipByteBuffer =
        ByteBuffer.allocate((int) Math.min(toSkip, SKIP_BYTE_BUFFER.length));
    long remain = toSkip;
    while (remain > 0) {
  ...
  public static long skip(final Reader input, final long toSkip) throws IOException {
    ...
    while (remain > 0) {
      ...
      // delegating to skip()
      final long n =
          input.read(SKIP_CHAR_BUFFER, 0, (int) Math.min(remain, SKIP_BYTE_BUFFER.length));
      if (n < 0) { // EOF
        break;
      }
      remain -= n;
   ...
   * @since 1.1
   */
  public static byte[] toByteArray(final Reader input, final String charsetName)
      throws IOException {
   ...
   * @since 2.3
   */
  public static char[] toCharArray(final InputStream is, final Charset charset) throws IOException {
   ...
   * @since 1.1
   */
  public static char[] toCharArray(final InputStream is, final String charsetName)
      throws IOException {
   ...
   * @since 1.1
   */
  public static void write(final byte[] data, final Writer output, final String charsetName)
      throws IOException {
  ...
  @Deprecated
  public static void write(
      final StringBuffer data, final OutputStream output, final String charsetName) // NOSONAR
      throws IOException {
    if (data != null) {
  ...
  /**
   * Returns the given Appendable if it is already a {@link Writer}, otherwise creates a Writer
   * wrapper around the given Appendable.
   *
