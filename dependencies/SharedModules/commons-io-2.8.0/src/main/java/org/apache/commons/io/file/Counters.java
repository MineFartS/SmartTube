...
public class Counters {
  ...
  private static class AbstractPathCounters implements PathCounters {
     ...
     */
    protected AbstractPathCounters(
        final Counter byteCounter, final Counter directoryCounter, final Counter fileCounter) {
      super();
  ...
  private static class BigIntegerPathCounters extends AbstractPathCounters {
    ...
    protected BigIntegerPathCounters() {
      super(
          Counters.bigIntegerCounter(), Counters.bigIntegerCounter(), Counters.bigIntegerCounter());
    }
  }
