 ...
 *
 * <p>This class captures that difference, providing an enumeration to control how file name
 * comparisons should be performed. It also provides methods that use the enumeration to perform
 * comparisons.
 *
 * <p>Wherever possible, you should use the <code>check</code> methods in this class to compare file
 * names.
 *
 * @since 1.3
 */
public enum IOCase {
   ...
   * case-insensitive when comparing file names, Unix is case-sensitive.
   *
