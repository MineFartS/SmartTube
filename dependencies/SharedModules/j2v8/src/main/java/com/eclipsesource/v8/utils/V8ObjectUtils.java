...
/**
 * A set of static helper methods to convert V8Objects / V8Arrays to java.util Maps and Lists and
 * back again. These conversions perform a deep copy.
 */
public class V8ObjectUtils {
  ...
  /**
   * Create a Java Object from a result from V8. V8 can return basic Java types, or V8Values
   * (V8Object, V8Array, etc...). This method will attempt to convert the result into a pure Java
   * object using a deep copy.
   *
   * <p>If the input is basic Java type (Integer, Double, Boolean, String) it will be returned. If
   * the input is a V8Value, it will be converted.
   *
   * <p>All elements in the V8Object are released after they are accessed. However, the root object
  ...
  /**
   * Create a Java Object from a result from V8 using a {@link TypeAdapter} to convert objects. V8
   * can return basic Java types or V8Values (V8Object, V8Array, etc...). This method will attempt
   * to convert the result into a pure Java object using a deep copy.
   *
   * <p>If the input is basic Java type (Integer, Double, Boolean, String) it will be returned. If
   * the input is a V8Value, it will be converted.
   *
  ...
  /**
   * Creates a Map from a V8Object using a deep copy. All elements in the V8Object are released
   * after they are accessed. However, the root object itself is not released.
   *
  ...
  /**
   * Creates a Map from a V8Object using a deep copy and a TypeAdapter to handle type conversions.
   * All elements in the V8Object are released after they are accessed. However, the root object
   * itself is not released.
   *
   * @param object The root of the V8Object graph.
   * @param adapter The {@link TypeAdapter} to use for the object conversions.
   * @return A map representing a deep copy of the V8Object rooted at 'object'.
   */
  public static Map<String, ? super Object> toMap(
      final V8Object object, final TypeAdapter adapter) {
    V8Map<Object> cache = new V8Map<Object>();
    try {
  ...
  /**
   * Creates a List from a V8Array using a deep copy. All elements in the V8Array are released after
   * they are accessed. However, the root array itself is not released.
   *
  ...
  /**
   * Creates a List from a V8Array using a deep copy and a TypeAdapter to handle type conversions.
   * All elements in the V8Array are released after they are accessed. However, the root array
   * itself is not released.
   *
   * @param array The root of the V8Array graph.
   * @param adapter The {@link TypeAdapter} to use for the object conversions.
  ...
  /**
   * Populates a Java array from a V8Array. The type of the array must be specified. Currently, only
   * INTEGER, DOUBLE, BOOLEAN and STRING are supported. The V8Array must only contain elements of
   * type 'arrayType'. The result can be optionally passed in as a parameter.
   *
   * <p>This method will use J2V8's bulk array copy making it faster than iterating over all the
   ...
   */
  public static Object getTypedArray(
      final V8Array array, final int arrayType, final Object result) {
  ...
  /**
   * Creates a Java array from a V8Array. The type of the Array must be specified. Currently, only
   * INTEGER, DOUBLE, BOOLEAN and STRING are supported. The V8Array must only contain elements of
   * type 'arrayType'.
   *
   * <p>This method will use J2V8's bulk array copy making it faster than iterating over all the
  ...
  /**
   * Creates a V8Object from a java.util.Map. This is a deep copy, so if the map contains other maps
   * (or lists) they will also be converted.
   *
  ...
  /**
   * Creates a V8Array from a java.util.List. This is a deep copy, so if the list contains other
   * lists (or maps) they will also be converted.
   *
   * @param v8 The runtime on which to create the result.
  ...
  /**
   * Returns an object usable with a V8 Runtime which represents the parameter 'value'. If 'value'
   * is an Integer, Boolean, Double or String, then 'value' is simply returned as these are directly
   * usable on V8. If 'value' is a map / list, then it's converted to a V8Object / V8Array first.
   *
   * <p>If the result is a V8Value, it must be released.
   *
  ...
  /**
   * Pushes a Java Object to a V8Array by first converting it to a V8Value if needed. If the value
   * is a boxed primitive, then the primitive will be pushed. If the object is a Map / List then a
   * deep copy will be performed, converting the object to a V8Object / V8Array first.
   *
  ...
  /**
   * Gets a Java Object representing the value at the given index in the V8Array. If the value is a
   * primitive (int, boolean or double) then a boxed instance is returned. If the value is a String,
   * then a String is returned. If the value is a V8Object or V8Array, then a Map or List is
   * returned.
   *
   * @param array The array on which to lookup the value. The array is not released.
  ...
  /**
   * Gets a Java Object representing the value at the given index in the V8Array. A TypeAdapter is
   * used to convert values from V8Objects to Java Objects. If the value is a primitive (int,
   * boolean or double) then a boxed instance is returned. If the value is a String, then a String
   * is returned. If the value is a V8Object or V8Array, then a Map or List is returned.
   *
   * @param array The array on which to lookup the value. The array is not released.
   * @param index The index whose element to lookup.
   * @param adapter The {@link TypeAdapter} to use for the object conversions.
  ...
  /**
   * Gets a Java Object representing the value with the given key in the V8Object. If the value is a
   * primitive (int, boolean or double) then a boxed instance is returned. If the value is a String,
   * then a String is returned. If the value is a V8Object or V8Array, then a Map or List is
   * returned.
   *
   * @param object The object on which to lookup the value. The object is not released.
  ...
  /**
   * Gets a Java Object representing the value with the given key in the V8Object. A TypeAdapter is
   * used to convert values from V8Objects to Java Objects. If the value is a primitive (int,
   * boolean or double) then a boxed instance is returned. If the value is a String, then a String
   * is returned. If the value is a V8Object or V8Array, then a Map or List is returned.
   *
   * @param v8Object The object on which to lookup the value. The object is not released.
   * @param key The key to use to lookup the value.
   * @param adapter The {@link TypeAdapter} to use for the object conversions.
   * @return A Java Object representing the value at a given key.
   */
  public static Object getValue(
      final V8Object v8Object, final String key, final TypeAdapter adapter) {
    V8Map<Object> cache = new V8Map<Object>();
    Object object = null;
    int type = V8Value.UNDEFINED;
    try {
  ...
  private static Map<String, ? super Object> toMap(
      final V8Object v8Object, final V8Map<Object> cache, final TypeAdapter adapter) {
    if (v8Object == null) {
  ...
  @SuppressWarnings("unchecked")
  private static List<? super Object> toList(
      final V8Array array, final V8Map<Object> cache, final TypeAdapter adapter) {
    if (array == null) {
  ...
  private static V8Object toV8Object(
      final V8 v8, final Map<String, ? extends Object> map, final Map<Object, V8Value> cache) {
  ...
  private static V8Array toV8Array(
      final V8 v8, final List<? extends Object> list, final Map<Object, V8Value> cache) {
  ...
  @SuppressWarnings("unchecked")
  private static Object getV8Result(
      final V8 v8, final Object value, final Map<Object, V8Value> cache) {
  ...
  private static void pushValue(
      final V8 v8, final V8Array result, final Object value, final Map<Object, V8Value> cache) {
    if (value == null) {
