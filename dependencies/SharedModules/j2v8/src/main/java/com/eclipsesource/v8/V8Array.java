...
/**
 * A V8Value that represents a JavaScript array. JavaScript Arrays contain elements by index, but
 * can also contain elements by 'key' which is why V8Array extends V8Object.
 */
public class V8Array extends V8Object {
  ...
  /**
   * Creates a new V8Array and associates it with the given runtime. V8Arrays have native resources
   * and as such, must be released.
   *
  ...
  /**
   * Gets the type of the array. Returns a 'type' if all the elements in the array have the same
   * type, otherwise UNDEFINED is returned.
   *
   * @return The type of all the elements of the array, or UNDEFINED if they are not all the same
   *     type.
   */
  public int getType() {
    v8.checkThread();
  ...
  /**
   * Gets the type of a subset of the array. The subset is specified by a start index and a length.
   * UNDEFINED is returned if all the elements in the subset are not of the same type.
   *
   * @param index The start index.
   * @param length The length.
   * @return The type of the subset of the array or UNDEFINED if the subset is not all the same
   *     type.
   */
  ...
  /**
   * Returns the integer value associated at this index. If the value at this index does not exist,
   * or if it's not an integer, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The integer value at this index or V8ResultUndefined if the index does not exist or the
  ...
  /**
   * Returns the boolean value associated at this index. If the value at this index does not exist,
   * or if it's not a boolean, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The boolean value at this index or V8ResultUndefined if the index does not exist or the
  ...
  /**
   * Returns the byte value associated at this index. If the value at this index does not exist, or
   * cannot be cast to a byte, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return
   * @return The byte value at this index or V8ResultUndefined if the index does not exist or the
   *     value cannot be cast to a byte.
   */
  ...
  /**
   * Returns the double value associated at this index. If the value at this index does not exist,
   * or if it's not a double, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The double value at this index or V8ResultUndefined if the index does not exist or the
  ...
  /**
   * Returns the String value associated at this index. If the value at this index does not exist,
   * or if it's not a String, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The String value at this index or V8ResultUndefined if the index does not exist or the
  ...
  /**
   * Returns the integers contained in a subset of a V8Array. If the subset contains elements other
   * than integers, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown.
   *
   * @param index The starting index.
   * @param length The length.
   * @return The integers contained in the subset of the array, or V8ResultUndefined exception.
   */
  ...
  /**
   * Gets the integers contained in a subset of a V8Array. If the subset contains elements other
   * than integers, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown. Finally,
   * if the resultArray is not large enough to hold the results then IndexOutOfBoundsException is
   * thrown.
   *
   * @param index The starting index.
   * @param length The length.
  ...
  /**
   * Returns the doubles contained in a subset of a V8Array. If the subset contains elements other
   * than doubles, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown.
   *
   * @param index The starting index.
   * @param length The length.
   * @return The doubles contained in the subset of the array, or V8ResultUndefined exception.
   */
  ...
  /**
   * Gets the doubles contained in a subset of a V8Array. If the subset contains elements other than
   * doubles, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown. Finally,
   * if the resultArray is not large enough to hold the results then IndexOutOfBoundsException is
   * thrown.
   *
  ...
  /**
   * Returns the booleans contained in a subset of a V8Array. If the subset contains elements other
   * than booleans, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown.
   *
   * @param index The starting index.
   * @param length The length.
   * @return The booleans contained in the subset of the array, or V8ResultUndefined exception.
   */
  ...
  /**
   * Returns the bytes contained in a subset of a V8Array. If the subset contains elements that
   * cannot be cast to bytes, then a V8ResultUndefined exception is thrown. Furthermore, if the
   * subset is not entirely contained within the array, then V8ResultUndefined exception is also
   * thrown.
   *
   * @param index The starting index.
   * @param length The length.
   * @return The bytes contained in the subset of the array, or V8ResultUndefined exception.
   */
  ...
  /**
   * Gets the booleans contained in a subset of a V8Array. If the subset contains elements other
   * than booleans, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown. Finally,
   * if the resultArray is not large enough to hold the results then IndexOutOfBoundsException is
   * thrown.
  ...
  /**
   * Gets the bytes contained in a subset of a V8Array. If the subset contains elements that cannot
   * be cast to bytes, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is
   * not entirely contained within the array, then V8ResultUndefined exception is also thrown.
   * Finally, if the resultArray is not large enough to hold the results then
  ...
  /**
   * Returns the Strings contained in a subset of a V8Array. If the subset contains elements other
   * than Strings, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown.
   *
   * @param index The starting index.
   * @param length The length.
   * @return The Strings contained in the subset of the array, or V8ResultUndefined exception.
   */
  ...
  /**
   * Gets the Strings contained in a subset of a V8Array. If the subset contains elements other than
   * Strings, then a V8ResultUndefined exception is thrown. Furthermore, if the subset is not
   * entirely contained within the array, then V8ResultUndefined exception is also thrown. Finally,
   * if the resultArray is not large enough to hold the results then IndexOutOfBoundsException is
   * thrown.
   *
  ...
  /**
   * Returns the V8Array value associated at this index. If the value at this index does not exist,
   * or if it's not a V8Array, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The V8Array value at this index or V8ResultUndefined if the index does not exist or the
   *     value is not a V8Array.
   */
  ...
  /**
   * Returns the V8Object value associated at this index. If the value at this index does not exist,
   * or if it's not a V8Object, then V8ResultUndefined exception is thrown.
   *
   * @param index The index whose value to return.
   * @return The V8Object value at this index or V8ResultUndefined if the index does not exist or
   *     the value is not a V8Object.
   */
  ...
  /**
   * Pushes an integer value to the next available spot in the Array. In particular, this[length] =
   * value;
   *
  ...
  /**
   * Pushes a boolean value to the next available spot in the Array. In particular, this[length] =
   * value;
   *
   * @param value The value to push to the array.
   * @return The receiver.
  ...
  /**
   * Pushes a double value to the next available spot in the Array. In particular, this[length] =
   * value;
   *
   * @param value The value to push to the array.
   * @return The receiver.
  ...
  /**
   * Pushes a String value to the next available spot in the Array. In particular, this[length] =
   * value;
   *
   * @param value The value to push to the array.
   * @return The receiver.
  ...
  /**
   * Pushes a V8Value to the next available spot in the Array. In particular, this[length] = value;
   *
   * @param value The value to push to the array.
   * @return The receiver.
   */
  ...
  /**
   * Pushes a Object to the next available spot in the Array. In particular, this[length] = value;
   *
   * @param value The value to push to the array.
   * @return The receiver.
   */
  ...
  /**
   * Pushes null to the next available spot in the Array. In particular, this[length] = null;
   *
   * @return The receiver.
   */
  ...
  /**
   * Pushes undefined to the next available spot in the Array. In particular, this[length] =
   * undefined;
   *
   * @return The receiver.
   */
  ...
  static class Undefined extends V8Array {
     ...
     */
    @Override
    public V8Object registerJavaMethod(
        final JavaVoidCallback callback, final String jsFunctionName) {
      throw new UnsupportedOperationException();
    }
