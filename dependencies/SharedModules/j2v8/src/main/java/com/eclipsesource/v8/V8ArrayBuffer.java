...
/**
 * V8ArrayBuffers represent ArrayBuffers from V8, but are backed by a java.nio.ByteBuffer. This
 * means that any data stored in a TypedArray can be accessed by the java.nio.ByteBuffer. This
 * significantly improves performance of data access from Java to JavaScript.
 *
 * <p>V8ArrayBuffers can either be constructed in Java, or returned from JavaScript.
 */
public class V8ArrayBuffer extends V8Value {
  ...
  /**
   * Creates a new V8ArrayBuffer on a given V8Runtime with a given capacity.
   *
