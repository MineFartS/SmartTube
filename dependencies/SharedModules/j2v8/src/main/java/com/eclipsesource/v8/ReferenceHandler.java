...
public interface ReferenceHandler {
  ...
  /**
   * Called when a native handle is first created. The V8Value referenced by that handle is passed
   * as a parameter.
   *
  ...
  /**
   * Called when a native handle is released. The V8Value referenced by that handle is passed as a
   * parameter.
   *
   * @param object The V8Value referenced by the handle
   */
