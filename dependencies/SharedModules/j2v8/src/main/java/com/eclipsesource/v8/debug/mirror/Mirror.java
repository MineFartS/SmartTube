...
/**
 * A mirror is used to represent a copy (mirror) of a runtime object during a debug session.
 *
 * <p>Mirror hierarchy: - Mirror - ValueMirror - UndefinedMirror - NullMirror - NumberMirror -
 * StringMirror - ObjectMirror - FunctionMirror - UnresolvedFunctionMirror - ArrayMirror -
 * DateMirror - RegExpMirror - ErrorMirror - PromiseMirror - PropertyMirror - InternalPropertyMirror
 * - FrameMirror - ScriptMirror
 */
public class Mirror implements Releasable {
  ...
  /**
   * Returns true if this mirror object points to the type 'undefined'. False otherwise.
   *
