...
/**
 * The concrete class for all V8 Objects. V8Objects are JavaScript objects accessible in java.
 * Specialized subclasses exist for V8Arrays and V8Functions.
 *
 * <p>V8Object are JavaScript object with key value pairs. Specific get methods exist to access
 * values as primitives. General get methods also exist, which return Java Objects and can be casted
 * to the correct subclass.
 *
 * <p>V8Object have native resources and must be released when they are no longer need in Java.
 */
public class V8Object extends V8Value {

  /**
   * Create a new V8Object and associate it with a runtime. Once created, it must be released.
   *
  ...
  /**
   * Returns all the keys associated with this JavaScript Object. Keys associated with the objects
   * prototype are not returned.
   *
   ...
   * Types are specified as integer constants. The types are all defined in V8Value.
   *
  ...
  /**
   * Returns the value associated with this key. Values are Java Objects. If the value is a
   * primitive, its boxed type is returned. If the value is a V8Value, it must be released.
   *
  ...
  /**
   * Returns the integer value associated with this key. If the value associated with this key does
   * not exist, or if it's not an integer, then V8ResultUndefined exception is thrown.
   *
   * @param key The key whose value to return.
   * @return The integer value associated with this key, or V8ResultUndefined if the key does not
   *     exist or the value is not an integer.
   */
  ...
  /**
   * Returns the boolean value associated with this key. If the value associated with this key does
   * not exist, or if it's not a boolean, then V8ResultUndefined exception is thrown.
   *
   * @param key The key whose value to return.
   * @return The boolean value associated with this key, or V8ResultUndefined if the key does not
  ...
  /**
   * Returns the double value associated with this key. If the value associated with this key does
   * not exist, or if it's not a double, then V8ResultUndefined exception is thrown.
   *
   * @param key The key whose value to return.
   * @return The double value associated with this key, or V8ResultUndefined if the key does not
  ...
  /**
   * Returns the String value associated with this key. If the value associated with this key does
   * not exist, or if it's not a String, then V8ResultUndefined exception is thrown.
   *
   * @param key The key whose value to return.
   * @return The String value associated with this key, or V8ResultUndefined if the key does not
  ...
  /**
   * Returns the V8Array value associated with this key. If the value associated with this key does
   * not exist then UNDEFINED is returned. If the value exists but is not an array then
  ...
  /**
   * Returns the V8Object value associated with this key. If the value associated with this key does
   * not exist then UNDEFINED is returned. If the value exists but is not an JS Object then
   * V8ResultUndefined exception is thrown.
   *
   * @param key The key whose value to return.
  ...
  /**
   * Invoke a JavaScript function and return the result as a integer. If the result is not an
   * integer, or does not exist, then V8ResultUndefined is thrown.
   *
   ...
   * @return An integer representing the result of the function call or V8ResultUndefined if the
  ...
  /**
   * Invoke a JavaScript function and return the result as a double. If the result is not a double,
   * or does not exist, then V8ResultUndefined is thrown.
   *
   * @param name The name of the JS Function to call.
   * @param parameters The parameters to pass to the function. Parameters must be released.
   * @return A double representing the result of the function call or V8ResultUndefined if the
   *     result is not a double.
   */
  ...
  /**
   * Invoke a JavaScript function and return the result as a String. If the result is not a String,
   * or does not exist, then V8ResultUndefined is thrown.
   *
   * @param name The name of the JS Function to call.
   * @param parameters The parameters to pass to the function. Parameters must be released.
   * @return A String representing the result of the function call or V8ResultUndefined if the
  ...
  /**
   * Invoke a JavaScript function and return the result as a boolean. If the result is not a
   * boolean, or does not exist, then V8ResultUndefined is thrown.
   *
   * @param name The name of the JS Function to call.
   * @param parameters The parameters to pass to the function. Parameters must be released.
   * @return A boolean representing the result of the function call or V8ResultUndefined if the
  ...
  /**
   * Invoke a JavaScript function and return the result as a V8Array. If the result is not a V8Array
   * then V8ResultUndefined is thrown.
   *
   * @param name The name of the JS Function to call.
   * @param parameters The parameters to pass to the function. Parameters must be released.
   * @return A V8Array representing the result of the function call or V8ResultUndefined if the
   *     result is not a V8Array. The result must be released.
   */
  public V8Array executeArrayFunction(final String name, final V8Array parameters) {
    ...
    long parametersHandle = parameters == null ? 0 : parameters.getHandle();
    Object result =
        v8.executeFunction(v8.getV8RuntimePtr(), V8_ARRAY, objectHandle, name, parametersHandle);
  ...
  /**
   * Invoke a JavaScript function and return the result as a V8Object. If the result is not a
   * V8Object then V8ResultUndefined is thrown.
   *
   * @param name The name of the JS Function to call.
   * @param parameters The parameters to pass to the function. Parameters must be released.
   * @return A V8Object representing the result of the function call or V8ResultUndefined if the
   *     result is not a V8Object. The result must be released.
   */
  public V8Object executeObjectFunction(final String name, final V8Array parameters) {
    ...
    long parametersHandle = parameters == null ? 0 : parameters.getHandle();
    Object result =
        v8.executeFunction(v8.getV8RuntimePtr(), V8_OBJECT, objectHandle, name, parametersHandle);
  ...
  /**
   * Register a Java method as a JavaScript function. When the JS Function is invoked the Java
  ...
  /**
   * Register a void Java method as a JavaScript function. When the JS Function is invoked the Java
   * method will be called.
   *
   ...
   * @param jsFunctionName The name of the JavaScript function to register the method with.
  ...
  /**
   * Register a Java method reflectively given it's name a signature. The option to include the JS
   * Object in the callback can be specified by setting includeReceiver true.
   *
   * @param object The Java Object on which the method is defined.
   * @param methodName The name of the method to register.
   * @param jsFunctionName The name of the JavaScript function to register the method with.
   * @param parameterTypes The parameter types of the method.
   * @param includeReceiver True if the first parameter should include the JS Object, false
   *     otherwise.
   * @return The receiver.
   */
  public V8Object registerJavaMethod(
