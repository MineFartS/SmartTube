 ...
 *
 * <p>This class is only available on some platforms. In particular any methods on this class, on an
 * Android device, will lead to an UnsupportedOperationException.
 */
public class NodeJS {
  ...
  private static final String STARTUP_SCRIPT =
      "global." + STARTUP_CALLBACK + "(require, exports, module, __filename, __dirname);";
   ...
   *     <p>May throw an UnsupportedOperationException if node.js integration has not been compiled
   *     for your platform.
   */
  ...
  /**
   * Returns the version of Node.js that is runtime is built against. This uses
   * process.versions.node to get the version.
   *
  ...
  /**
   * Handles the next message in the message loop. Returns True if there are more messages to
  ...
  /**
   * Invokes NodeJS require() on the specified file. This will load the module, execute it and
   * return the exports object to the caller. The exports object must be released.
   *
  ...
  /**
   * Execute a NodeJS script. This will load the script and execute it on the next tick. This is the
   * same as how NodeJS executes scripts at startup. Since the script won't actually run until the
   * next tick, this method does not return a result.
   *
