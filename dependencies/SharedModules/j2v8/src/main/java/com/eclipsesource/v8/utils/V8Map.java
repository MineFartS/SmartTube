...
/**
 * A Map that maps V8Values to arbitrary Java Objects. Once stored in the map, the keys (V8Values)
 * can be released as the map will handle their resource management for you.
 *
 * <p>Once the map is no longer needed, it should be released. To tie a map to the lifecycle of a V8
 * runtime, it can be registered as a resource with V8.registerResource.
 */
public class V8Map<V> implements Map<V8Value, V>, Releasable {
  ...
  /**
   * Releases all the resources associated with this map. A map can be used again once it's
   * released, although if it's used again it should be released again.
   */
  @Override
  @Deprecated
  public void release() {
