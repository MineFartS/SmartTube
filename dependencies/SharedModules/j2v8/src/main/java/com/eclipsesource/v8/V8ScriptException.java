...
/**
 * An exception that indicates that the execution of a script failed. Details about the exception,
 * such as the line number, stack trace, and message can retrieved using the accessors.
 */
