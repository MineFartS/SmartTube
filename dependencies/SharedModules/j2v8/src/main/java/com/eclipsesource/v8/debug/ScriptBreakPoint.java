...
public class ScriptBreakPoint implements Releasable {
  ...
  /**
   * Sets a condition to be evaluated before determining if the breakpoint event should be fired.
   *
  ...
  /**
   * Returns the condition set on this breakpoint or the String 'undefined' if a condition was not
   * set.
   *
