 ...
 * but can be returned as the result of invoking a JS script or JS Function.
 */
public class V8Function extends V8Object {

  /**
   * Create a JavaScript function, that when invoked will call the javaCallback passed to the
   * receiver.
   *
   ...
   *
   * @param receiver The object on which to call the function on. The receiver will be mapped to
   *     'this' in JavaScript. If receiver is null or undefined, then the V8 runtime will be used
   *     instead.
