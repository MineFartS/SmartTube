...
/**
 * Represents the current execution state at a break. The execution state provides methods for
 * inspecting the stack, variables and scopes.
 *
 * <p>The ExecutionState should not be persisted as it will be released when the debugger continues.
 */
public class ExecutionState implements Releasable {
  ...
  /**
   * Indicates to the debugger how to proceed. If not called, the debugger will continue running
   * until the next breakpoint is hit.
   *
