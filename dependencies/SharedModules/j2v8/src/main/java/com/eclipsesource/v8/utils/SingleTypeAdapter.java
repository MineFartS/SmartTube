...
/**
 * Adapt all instances of a single type from JavaScript to Java. The TypeAdapter can be used with
 * the V8ObjectUtils to allow users to customize the conversion.
 */
