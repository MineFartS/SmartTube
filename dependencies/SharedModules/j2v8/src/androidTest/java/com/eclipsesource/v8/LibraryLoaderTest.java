...
public class LibraryLoaderTest {
  ...
  static void makeFinalStaticAccessible(final Field field) {
    ...
    try {
      // on certain JVMs this is not present and will throw the exceptions below (e.g. the Android
      // Dalvik VM)
  ...
  private static final String skipMessage =
      "Skipped test (Cannot detect other platforms when running on Android)";
