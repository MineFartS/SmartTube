...
public class V8CallbackTest {
  ...
  public interface ICallback {
    ...
    public void voidMethodWithParameters(
        final int a, final double b, final boolean c, final String d, V8Object e);
    ...
    public void voidMethodVarArgsReceiverAndOthers(
  ...
  public void testCallbackWithFunctionInParameterList() {
    ...
    v8.registerJavaMethod(
        callback, "voidMethodWithObjectParameter", "foo", new Class<?>[] {V8Object.class});
  ...
  public void testCallbackWithExplicitFunctionInParameterList() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodWithFunctionParameter", "foo", new Class<?>[] {V8Function.class});
  ...
  public void testCallbackWithNullInStringParameterList() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodWithStringParameter", "foo", new Class<?>[] {String.class});
  ...
  public void testCallbackStringVarArgs() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodStringVarArgs", "foo", new Class<?>[] {String[].class});
  ...
  public void testCallbackV8ObjectVarArgs() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodV8ObjectVarArgs", "foo", new Class<?>[] {V8Object[].class});
    ...
    JavaCallback callback =
        new JavaCallback() {
          ...
          public Boolean invoke(final V8Object receiver, final V8Array parameters) {
            V8TypedArray result =
                ((TypedArray) V8ObjectUtils.getValue(parameters, 0)).getV8TypedArray();
            try {
  ...
  public void testV8ObjectFunctionCallOnJSObject() {
    ICallback callback = mock(ICallback.class);
    doReturn(v8.executeObjectScript("x = {first:'bob'}; x"))
        .when(callback)
        .v8ObjectMethodNoParameters();
    V8Object v8Object = new V8Object(v8);
  ...
  public void testV8ArrayFunctionCallOnJSObject() {
    ICallback callback = mock(ICallback.class);
    doReturn(v8.executeArrayScript("x = ['a','b','c']; x"))
        .when(callback)
  ...
  public void testVoidMethodCalledWithParameters() {
    ...
    v8.registerJavaMethod(
        callback,
        "voidMethodWithParameters",
        "foo",
        new Class<?>[] {Integer.TYPE, Double.TYPE, Boolean.TYPE, String.class, V8Object.class});
  ...
  public void testIntMethodCalledWithParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .intMethodWithParameters(anyInt(), anyInt());
    v8.registerJavaMethod(
        callback, "intMethodWithParameters", "foo", new Class<?>[] {Integer.TYPE, Integer.TYPE});
  ...
  public void testDoubleMethodCalledWithParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .doubleMethodWithParameters(anyDouble(), anyDouble());
    v8.registerJavaMethod(
        callback, "doubleMethodWithParameters", "foo", new Class<?>[] {Double.TYPE, Double.TYPE});
  ...
  public void testVoidMethodCalledWithArrayParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .voidMethodWithArrayParameter(any(V8Array.class));
    v8.registerJavaMethod(
        callback, "voidMethodWithArrayParameter", "foo", new Class<?>[] {V8Array.class});
  ...
  public void testIntMethodCalledWithArrayParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .intMethodWithArrayParameter(any(V8Array.class));
    v8.registerJavaMethod(
        callback, "intMethodWithArrayParameter", "foo", new Class<?>[] {V8Array.class});
  ...
  public void testBooleanMethodCalledWithArrayParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .booleanMethodWithArrayParameter(any(V8Array.class));
    v8.registerJavaMethod(
        callback, "booleanMethodWithArrayParameter", "foo", new Class<?>[] {V8Array.class});
  ...
  public void testStringMethodCalledWithArrayParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .stringMethodWithArrayParameter(any(V8Array.class));
    v8.registerJavaMethod(
        callback, "stringMethodWithArrayParameter", "foo", new Class<?>[] {V8Array.class});
  ...
  public void testArrayMethodCalledWithParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .v8ArrayMethodWithStringParameter(any(String.class));
    v8.registerJavaMethod(
        callback, "v8ArrayMethodWithStringParameter", "foo", new Class<?>[] {String.class});
  ...
  public void testVoidMethodCalledWithObjectParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .voidMethodWithObjectParameter(any(V8Object.class));
    v8.registerJavaMethod(
        callback, "voidMethodWithObjectParameter", "foo", new Class<?>[] {V8Object.class});
  ...
  public void testObjectMethodCalledWithObjectParameters() {
    ...
    doAnswer(
        ...
        .when(callback)
        .v8ObjectMethodWithObjectParameter(any(V8Object.class));
    v8.registerJavaMethod(
        callback, "v8ObjectMethodWithObjectParameter", "foo", new Class<?>[] {V8Object.class});
  ...
  public void testCatchJavaExceptionInJS() {
    ...
    v8.executeVoidScript(
        "var caught = false; try {foo();} catch (e) {if ( e === 'My Runtime Exception' )"
            + " caught=true;}");
  ...
  public void testCatchJavaExceptionInJSWithoutMessage() {
    ...
    v8.executeVoidScript(
        "var caught = false; try {foo();} catch (e) {if ( e === 'Unhandled Java Exception' )"
            + " caught=true;}");
  ...
  public void testNonVoidCallbackCatchJavaExceptionInJS() {
    ICallback callback = mock(ICallback.class);
    doThrow(new RuntimeException("My Runtime Exception"))
        .when(callback)
  ...
  public void testJSCatchWillCatchJavaException() {
    ...
    v8.registerJavaMethod(callback, "voidMethodNoParameters", "foo", new Class<?>[] {});
    v8.registerJavaMethod(
        callback, "voidMethodWithStringParameter", "bar", new Class<?>[] {String.class});
  ...
  public void testVarArgParametersString() {
    ...
    v8.registerJavaMethod(
        callback,
        "voidMethodVarArgsAndOthers",
        "foo",
        new Class<?>[] {Integer.TYPE, Integer.TYPE, Object[].class});
  ...
  public void testVarArgParametersObject() {
    ...
    verify(callback)
        .voidMethodVarArgsAndOthers(eq(1), eq(2), any(V8Object.class), any(V8Object.class));
  }
  ...
  public void testVarArgsNoReciver() {
    ...
    v8.registerJavaMethod(
        callback,
        "voidMethodVarArgsReceiverAndOthers",
        "foo",
        new Class<?>[] {V8Object.class, Integer.TYPE, Integer.TYPE, Object[].class},
        false);
  ...
  public void testVarArgsWithReciver() {
    ...
    doAnswer(constructReflectiveAnswer(v8, parameters, null))
        .when(callback)
        .voidMethodVarArgsReceiverAndOthers(any(V8Object.class), anyInt(), anyInt());
  ...
  public void testAvailableVarArgsWithNoReciver() {
    ...
    doAnswer(constructReflectiveAnswer(null, parameters, null))
        .when(callback)
        .voidMethodVarArgsReceiverAndOthers(any(V8Object.class), anyInt(), anyInt());
  ...
  public void testMissingParamtersWithObjectParameters() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodWithObjectParameters", "foo", new Class<?>[] {Integer.class});
  ...
  public void testCallJavaMethodMissingInt() {
    ICallback callback = mock(ICallback.class);
    v8.registerJavaMethod(
        callback, "voidMethodWithIntParameter", "foo", new Class<?>[] {Integer.TYPE});
  ...
  public void testInvokeCallbackWithParameters() {
    ...
    doAnswer(constructAnswer(null, parameters, null))
        .when(callback)
        .invoke(any(V8Object.class), any(V8Array.class));
  ...
  public void testInvokeCallbackWithReturnValue() {
    JavaCallback callback = mock(JavaCallback.class);
    v8.registerJavaMethod(callback, "foo");
    doAnswer(constructAnswer(null, null, 77))
        .when(callback)
        .invoke(any(V8Object.class), any(V8Array.class));
  ...
  public void testInvokeCallbackFunctionUsesReciver() {
    ...
    doAnswer(constructAnswer(bar, null, 77))
        .when(callback)
        .invoke(any(V8Object.class), any(V8Array.class));
  ...
  public void testInvokeCallbackOnGlobalFunctionUsesGlobalScopeAsReciver() {
    JavaVoidCallback callback = mock(JavaVoidCallback.class);
    v8.registerJavaMethod(callback, "foo");
    doAnswer(constructAnswer(v8, null, null))
        .when(callback)
        .invoke(any(V8Object.class), any(V8Array.class));
  ...
  private Answer<Object> constructAnswer(
  ...
  private Answer<Object> constructReflectiveAnswer(
      final V8Object receiver, final V8Array parameters, final Object result) {
    return new Answer<Object>() {
