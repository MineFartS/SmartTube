...
public class V8ObjectUtilsTest {
  ...
  public void testCreateMixedMapFromV8Object() {
    V8Object object =
        v8.executeObjectScript("x = {boolean:true, integer:1, double:3.14159, string:'hello'}; x");
  ...
  public void testCreateNestedMapFromV8Object() {
    V8Object object =
        v8.executeObjectScript("x = { name : { first :'john', last: 'smith'}, age: 7}; x");
  ...
  public void testCreateMatrixFromV8Array() {
    V8Array array =
        v8.executeArrayScript("x = [[1,2,3],[true,false,true],['this','that','other']]; x");
  ...
  public void testCloneV8Object() {
    V8Object list =
        v8.executeObjectScript(
            "var l = [{first:'ian', last:'bull'}, {first:'sadie', last:'bull'}]; l;");
  ...
  public void testTypedArrayInMap() {
    TypedArray int8Array =
        new TypedArray(
            v8, new ArrayBuffer(v8, ByteBuffer.allocateDirect(8)), V8Value.INT_8_ARRAY, 0, 8);
  ...
  public void testIntegerTypeAdapter_Map() {
    ...
    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.INTEGER) {
  ...
  public void testDoubleTypeAdapter_Map() {
    ...
    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.DOUBLE) {
  ...
  public void testBooleanTypeAdapter_Map() {
    ...
    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.BOOLEAN) {
  ...
  public void testStringTypeAdapter_Map() {
    ...
    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.STRING) {
  ...
  public void testObjectTypeAdapter_Map() {
    ...
    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.V8_OBJECT) {
  ...
  public void testCreateFunctionMapFromV8Object() {
    V8Object object =
        v8.executeObjectScript("x = {a:function() {return 'a'}, b:function(){return 'b'}}; x");
    MemoryManager memoryManager = new MemoryManager(v8);

    Map<String, ? super Object> map =
        V8ObjectUtils.toMap(
            object,
            new SingleTypeAdapter(V8Value.V8_FUNCTION) {
  ...
  public void testCreateFunctionListFromV8Object() {
    V8Array object =
        v8.executeArrayScript("x = [function() {return 'a'}, function(){return 'b'}]; x");
    MemoryManager memoryManager = new MemoryManager(v8);
  ...
  public void testCloneV8Array_GetValue() {
    ...
    V8Array v8Object =
        V8ObjectUtils.toV8Array(v8, (List<? extends Object>) V8ObjectUtils.getValue(list));
  ...
  public void testCloneV8ObjectsWithCircularStructure_GetValue() {
    ...
    V8Object v8Object =
        V8ObjectUtils.toV8Object(
            v8, (Map<String, ? extends Object>) V8ObjectUtils.getValue(parent));
  ...
  public void testTypedArrayGetValue_Int8ArrayWithoutBackingStore() {
    V8Array intsArray =
        v8.executeArrayScript("" + "var intsArray = new Int8Array(24);\n" + "intsArray");
  ...
  public void testArrayBufferGetValue() {
    V8ArrayBuffer buf =
        (V8ArrayBuffer) v8.executeScript("var buf = new ArrayBuffer(100);\n" + "buf;\n");
