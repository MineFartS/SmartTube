...
public class V8ObjectTest {
  ...
  public void testSetPrototypeOfObject() {
    v8.executeVoidScript(
        "function Mammal(){}; Mammal.prototype.breathe=function(){return 'breathe';};");
  ...
  public void testTwinIsArrayBuffer() {
    V8ArrayBuffer arrayBuffer =
        (V8ArrayBuffer) v8.executeScript("var buf = new ArrayBuffer(100);  buf;");
