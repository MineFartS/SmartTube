...
public class V8InspectorTest {
  ...
  private void startInspector() {
    ...
    inspector.dispatchProtocolMessage(
        "{\"id\":3,\"method\":\"Debugger.enable\",\"params\":{\"maxScriptsCacheSize\":10000000}}");
    inspector.dispatchProtocolMessage(
        "{\"id\":4,\"method\":\"Debugger.setPauseOnExceptions\",\"params\":{\"state\":\"uncaught\"}}");
    inspector.dispatchProtocolMessage(
  ...
  public void testDebuggerConnection() {
    inspector.addDebuggerConnectionListener(
        new DebuggerConnectionListener() {
          @Override
          ...
          new DebuggerConnectionListener() {
            ...
            public void onDebuggerConnected() {
              String protocolMessage =
                  "{\"method\":\"Debugger.setBreakpointByUrl\",\"params\":{\"lineNumber\":0,\"urlRegex\":\"^[^/\\\\]+-\\d+\\.([jJ][sS])$\"},\"id\":8}";
