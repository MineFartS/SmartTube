...
public class RoundedBackgroundSpan extends ReplacementSpan {
  ...
  public RoundedBackgroundSpan(
      int backgroundColor, int paddingLeft, int paddingRight, int marginLeft, int marginRight) {
  ...
  public void draw(
    ...
    RectF rect =
        new RectF(
            x + mMarginLeft,
            top - paint.getFontMetricsInt().top + paint.getFontMetricsInt().ascent,
            x + width + mMarginLeft + mPaddingLeft + mPaddingRight,
            bottom);
    ...
    canvas.drawText(
        ...
        x + mMarginLeft + mPaddingLeft,
        y - paint.getFontMetricsInt().descent / 2,
        paint);
  }
}
