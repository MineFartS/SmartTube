...
public final class DeviceHelpers {
  ...
  /**
   * The app version code that corresponds to the last update of the media tunneling device
   * blacklist.
   *
   * <p>The value of this variable needs to be updated everytime a new device that does not support
   * media tunneling to match the <strong>upcoming</strong> version code.
   *
   ...
   *
   * <p>Blacklist reason: black screen
   *
   * <p>Board: HiSilicon Hi3798MV200
   */
  private static final boolean HI3798MV200 =
      Build.VERSION.SDK_INT == 24 && Build.DEVICE.equals("Hi3798MV200");
  ...
  private static final boolean CVT_MT5886_EU_1G =
      Build.VERSION.SDK_INT == 24 && Build.DEVICE.equals("cvt_mt5886_eu_1g");
  ...
  private static final boolean REALTEKATV =
      Build.VERSION.SDK_INT == 25 && Build.DEVICE.equals("RealtekATV");

  /** Phillips 4K (O)LED TV. Supports custom ROMs with different API levels */
  private static final boolean PH7M_EU_5596 =
      Build.VERSION.SDK_INT >= 26 && Build.DEVICE.equals("PH7M_EU_5596");
  ...
  private static final boolean QM16XE_U =
      Build.VERSION.SDK_INT == 23 && Build.DEVICE.equals("QM16XE_U");
   ...
   * <p>Processor: MT5895
   *
   * <p>Blacklist reason: fullscreen crash / stuttering
   */
  private static final boolean BRAVIA_VH1 =
      Build.VERSION.SDK_INT == 29 && Build.DEVICE.equals("BRAVIA_VH1");

  /**
   * Sony Bravia VH2.
   *
   * <p>Blacklist reason: fullscreen crash; this includes model A90J as reported in <a
   * href="https://github.com/TeamNewPipe/NewPipe/issues/9023#issuecomment-1387106242">#9023</a>
   */
  private static final boolean BRAVIA_VH2 =
      Build.VERSION.SDK_INT == 29 && Build.DEVICE.equals("BRAVIA_VH2");

  /**
   * Sony Bravia Android TV platform 2. Uses a MediaTek MT5891 (MT5596) SoC.
   *
   ...
   *
   * <p>Uses ARM MT5891 and a {@link #BRAVIA_ATV2} motherboard.
   *
   ...
   * Panasonic 4KTV-JUP.
   *
   * <p>Blacklist reason: fullscreen crash
   */
   ...
   *
   * <p>Blacklist reason: black screen; reported at <a
   * href="https://github.com/TeamNewPipe/NewPipe/pull/10122#issuecomment-1638475769">#10122</a>
   */
  ...
  public static int dpToPx(
      @Dimension(unit = Dimension.DP) final int dp, @NonNull final Context context) {
    return (int)
        TypedValue.applyDimension(
            TypedValue.COMPLEX_UNIT_DIP, dp, context.getResources().getDisplayMetrics());
  }

  public static int spToPx(
      @Dimension(unit = Dimension.SP) final int sp, @NonNull final Context context) {
    return (int)
        TypedValue.applyDimension(
   ...
   *
   * <p>This can cause a black video player surface while attempting to play a video or crashes
   * while entering or exiting the full screen player. The issue effects Android TVs most commonly.
   * See <a href="https://github.com/TeamNewPipe/NewPipe/issues/5911">#5911</a> and <a
   * href="https://github.com/TeamNewPipe/NewPipe/issues/9023">#9023</a> for more info. @Note Update
   * {@link #MEDIA_TUNNELING_DEVICE_BLACKLIST_VERSION} when adding a new device to the method.
   *
  ...
  /**
   * @return whether the device has support for WebView, see <a
   *     href="https://stackoverflow.com/a/69626735">https://stackoverflow.com/a/69626735</a>
   */
  ...
  private static boolean isTCL() {
    return Build.MANUFACTURER.toLowerCase().contains("tcl")
        || Build.BRAND.toLowerCase().contains("tcl");
  }
