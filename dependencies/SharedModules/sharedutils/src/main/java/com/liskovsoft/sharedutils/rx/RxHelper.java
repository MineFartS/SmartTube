...
/**
 * <a
 * href="https://medium.com/android-news/rxjava-schedulers-what-when-and-how-to-use-it-6cfc27293add">Info
 * about schedulers</a>
 */
public class RxHelper {
  ...
  public static <T> Disposable execute(
    ...
    return observable.subscribe(onResult::onResult, onError::onError, onFinish::run);
  }
  ...
  public static <T> Disposable execute(
      Observable<T> observable, OnResult<T> onResult, OnError onError) {
  ...
  public static <T> Disposable execute(
      Observable<T> observable, OnError onError, Runnable onFinish) {
  ...
  public static Disposable runAsyncUser(
      Runnable callback, @Nullable OnError onError, @Nullable Runnable onFinish) {
    return Completable.fromRunnable(callback)
        .subscribeOn(Schedulers.io())
  ...
  /**
   * <a
   * href="https://stackoverflow.com/questions/43525052/rxjava2-observable-take-throws-undeliverableexception">More
   * info 1</a> <a
   * href="https://github.com/ReactiveX/RxJava/wiki/What's-different-in-2.0#error-handling">More
   * info 2</a>
   */
    ...
    RxJavaPlugins.setErrorHandler(
        e -> {
          ...
          if (e instanceof NullPointerException
              && Helpers.equals(e.getStackTrace()[0].getClassName(), "java.net.SocksSocketImpl")) {
    ...
    return create(
        emitter -> {
          ...
          if (result != null) {
            ...
            // Be aware of OnErrorNotImplementedException exception if error handler not
            // implemented!
  ...
  /**
   * Fix fall back on the global error handler. <a
   * href="https://stackoverflow.com/questions/44420422/crash-when-sending-exception-through-rxjava">More
   * info</a><br>
   * Be aware of {@link OnErrorNotImplementedException} exception if error handler not implemented
   * inside subscribe clause!
   */
  ...
  /** Catch errors thrown after Observer is disposed. Such errors cannot be caught anywhere else. */
