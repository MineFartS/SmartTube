...
class FileLogger extends MyLogger {
  ...
  public FileLogger(Context context, String customLabel) {
    ...
    MessageHelpers.showLongMessage(
        mContext, mContext.getString(R.string.log_stored_in_path, getLogPath(mContext)));
  }
  ...
  private BufferedWriter getWriter() throws IOException {
    if (mWriter == null) {
      ...
      MessageHelpers.showLongMessage(
          mContext, mContext.getString(R.string.log_to_file_started, getLogPath(mContext)));
    }
  ...
  private void writeLogHeader() {
    String versionFull =
        String.format("%s (%s)", AppInfoHelpers.getAppVersionName(mContext), mCustomLabel);
