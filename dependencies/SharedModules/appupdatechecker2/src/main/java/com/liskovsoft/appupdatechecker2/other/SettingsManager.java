...
public class SettingsManager {
  ...
  private static final String SHARED_PREFERENCES_NAME =
      "com.liskovsoft.appupdatechecker2.preferences";
  ...
  public SettingsManager(Context context) {
    ...
    // android.preference.PreferenceManager.setDefaultValues(context, SHARED_PREFERENCES_NAME,
    // Context.MODE_PRIVATE, R.xml.upd_prefs, true);
  }
