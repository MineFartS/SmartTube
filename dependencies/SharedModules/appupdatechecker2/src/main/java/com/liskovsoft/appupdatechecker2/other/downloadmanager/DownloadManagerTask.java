...
public class DownloadManagerTask extends AsyncTask<Void, Integer, Integer> {
  ...
  public abstract static class DownloadListener {
     ...
     *
     * @param status The download status defined in android.app.DownloadManager. The value maybe
     *     STATUS_FAILED or STATUS_PAUSED
     * @param error The download error defined in android.app.DownloadManager. This parameter only
     *     makes sense when the status is STATUS_FAILED
     */
