...
/**
 * Interface used to control the instantiation of {@link Fragment} instances. Implementations can be
 * registered with a {@link FragmentManager} via {@link
...
public class FragmentFactory {
   ...
   * @return true if <code>className</code> is <code>androidx.fragment.app.Fragment</code> or a
   ...
   * cache, bypassing the {@link Class#forName(String)} calls when passed the same class name again.
   *
   * @param classLoader The default classloader to use for loading the Class
   * @param className The class name of the fragment to parse.
   * @return Returns the parsed Fragment Class
   * @throws Fragment.InstantiationException If there is a failure in parsing the given fragment
   *     class. This is a runtime exception; it is not normally expected to happen.
   */
  ...
  public static Class<? extends Fragment> loadFragmentClass(
    ...
    try {
      ...
      throw new Fragment.InstantiationException(
          "Unable to instantiate fragment " + className + ": make sure class name exists", e);
  ...
  /**
   * Create a new instance of a Fragment with the given class name. This uses {@link
   * #loadFragmentClass(ClassLoader, String)} and the empty constructor of the resulting Class by
   * default.
   *
   ...
   * @throws Fragment.InstantiationException If there is a failure in instantiating the given
   *     fragment class. This is a runtime exception; it is not normally expected to happen.
   */
  @NonNull
