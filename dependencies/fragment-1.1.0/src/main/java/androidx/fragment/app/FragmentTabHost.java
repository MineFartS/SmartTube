 ...
 * this in a view hierarchy, after inflating the hierarchy you must call {@link #setup(Context,
 * FragmentManager, int)} to complete the initialization of the tab host.
 *
...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
  ...
  private void initFragmentTabHost(Context context, AttributeSet attrs) {
    final TypedArray a =
        context.obtainStyledAttributes(attrs, new int[] {android.R.attr.inflatedId}, 0, 0);
  ...
  @Deprecated
  public void addTab(
      @NonNull TabHost.TabSpec tabSpec, @NonNull Class<?> clss, @Nullable Bundle args) {
      ...
      if (newTab != null) {
        if (newTab.fragment == null) {
          newTab.fragment =
              mFragmentManager
                  .getFragmentFactory()
                  .instantiate(mContext.getClassLoader(), newTab.clss.getName());
