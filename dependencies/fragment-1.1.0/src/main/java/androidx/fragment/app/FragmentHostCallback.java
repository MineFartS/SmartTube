 ...
 *
 * <p>Fragments may be hosted by any object; such as an {@link Activity}. In order to host
 * fragments, implement {@link FragmentHostCallback}, overriding the methods applicable to the host.
 */
public abstract class FragmentHostCallback<E> extends FragmentContainer {
  ...
  public FragmentHostCallback(
      @NonNull Context context, @NonNull Handler handler, int windowAnimations) {
    this(
  ...
  /**
   * Invalidates the activity's options menu. See {@link
  ...
  /**
   * Starts a new {@link IntentSender} from the given fragment. See {@link
   * Activity#startIntentSender(IntentSender, Intent, int, int, int, Bundle)}.
   */
  public void onStartIntentSenderFromFragment(
    ...
    ActivityCompat.startIntentSenderForResult(
        mActivity, intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options);
  }

  /**
   * Requests permissions from the given fragment. See {@link
   * FragmentActivity#requestPermissions(String[], int)}
   */
  public void onRequestPermissionsFromFragment(
      @NonNull Fragment fragment, @NonNull String[] permissions, int requestCode) {}

  /**
   * Checks whether to show permission rationale UI from a fragment. See {@link
   * FragmentActivity#shouldShowRequestPermissionRationale(String)}
   */
