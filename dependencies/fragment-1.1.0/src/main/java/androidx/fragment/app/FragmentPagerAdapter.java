...
/**
 * Implementation of {@link PagerAdapter} that represents each page as a {@link Fragment} that is
 ...
 * arbitrary amount of state. For larger sets of pages, consider {@link FragmentStatePagerAdapter}.
 *
 ...
 *
 * <p>{@sample
 * frameworks/support/samples/Support4Demos/src/main/java/com/example/android/supportv4/app/FragmentPagerSupport.java
 * complete}
 *
...
public abstract class FragmentPagerAdapter extends PagerAdapter {
   ...
   * @deprecated use {@link #FragmentPagerAdapter(FragmentManager, int)} with {@link
   ...
   * method if the positions of items can change.
   *
