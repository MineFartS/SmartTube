 ...
 *
 * <p>It is the responsibility of the host to take care of the Fragment's lifecycle. The methods
 * provided by {@link FragmentController} are for that purpose.
 */
public class FragmentController {
  ...
  public LoaderManager getSupportLoaderManager() {
    throw new UnsupportedOperationException(
        "Loaders are managed separately from "
  ...
  public List<Fragment> getActiveFragments(
      @SuppressLint("UnknownNullness") List<Fragment> actives) {
    return mHost.mFragmentManager.getActiveFragments();
  }

  /**
   * Attaches the host to the FragmentManager for this controller. The host must be attached before
   * the FragmentManager can be used to manage Fragments.
   */
   ...
   *
   * @param parent The parent that the created view will be placed in; <em>note that this may be
   *     null</em>.
  ...
  /**
   * Restores the saved state for all Fragments. The given Fragment list are Fragment instances
   * retained across configuration changes.
   *
   * @deprecated Have your {@link FragmentHostCallback} implement {@link ViewModelStoreOwner} to
   *     automatically restore the Fragment's non configuration state and use {@link
   *     #restoreSaveState(Parcelable)} to restore the Fragment's save state.
   */
  @Deprecated
  public void restoreAllState(@Nullable Parcelable state, @Nullable List<Fragment> nonConfigList) {
    mHost.mFragmentManager.restoreAllState(
        state, new FragmentManagerNonConfig(nonConfigList, null, null));
  }
  ...
  public void restoreAllState(
      @Nullable Parcelable state, @Nullable FragmentManagerNonConfig nonConfig) {
  ...
  public void restoreSaveState(@Nullable Parcelable state) {
    if (!(mHost instanceof ViewModelStoreOwner)) {
      throw new IllegalStateException(
          "Your FragmentHostCallback must implement "
  ...
  /**
   * Returns a list of Fragments that have opted to retain their instance across configuration
   * changes.
   *
   * @deprecated Have your {@link FragmentHostCallback} implement {@link ViewModelStoreOwner} to
   *     automatically retain the Fragment's non configuration state.
   */
  @Deprecated
  @Nullable
  ...
  /**
   * Moves all Fragments managed by the controller's FragmentManager into the activity created
   * state.
   *
   ...
   *
   * <p>If the {@link androidx.fragment.app.FragmentHostCallback} is an instance of {@link
   * ViewModelStoreOwner}, then retained Fragments and any other non configuration state such as any
   * {@link androidx.lifecycle.ViewModel} attached to Fragments will only be destroyed if {@link
   * androidx.lifecycle.ViewModelStore#clear()} is called prior to this method.
   *
   * <p>Otherwise, the FragmentManager will look to see if the {@link FragmentHostCallback host's}
   * Context is an {@link Activity} and if {@link Activity#isChangingConfigurations()} returns true.
   * In only that case will non configuration state be retained.
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know the picture-in-picture mode
   * of the activity changed.
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know a configuration change
   * occurred.
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know the device is in a low
   * memory condition.
   *
   * <p>Call when the device is low on memory and Fragment's should trim their memory usage.
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know they should create an
   * options menu.
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know they should prepare their
   * options menu for display.
   *
  ...
  /**
   * Sends an option item selection event to the Fragments managed by the controller's
   * FragmentManager. Once the event has been consumed, no additional handling will be performed.
   *
  ...
  /**
   * Sends a context item selection event to the Fragments managed by the controller's
   * FragmentManager. Once the event has been consumed, no additional handling will be performed.
   *
   * <p>Call immediately after an options menu item has been selected
   *
  ...
  /**
   * Lets all Fragments managed by the controller's FragmentManager know their options menu has
   * closed.
   *
   ...
   *
   * <p>Call when queued actions can be performed [eg when the Fragment moves into a start or resume
   * state].
   *
  ...
  /**
   * Stops the loaders, optionally retaining their state. This is useful for keeping the loader
   * state across configuration changes.
   *
   * @param retain When {@code true}, the loaders aren't stopped, but, their instances are retained
   *     in a started state
   * @deprecated Loaders are managed separately from FragmentController
   */
  @Deprecated
  ...
  /**
   * Returns a list of LoaderManagers that have opted to retain their instance across configuration
   * changes.
   *
   * @deprecated Loaders are managed separately from FragmentController
   */
  ...
  /**
   * Restores the saved state for all LoaderManagers. The given LoaderManager list are LoaderManager
  ...
  public void restoreLoaderNonConfig(
      @SuppressLint("UnknownNullness") SimpleArrayMap<String, LoaderManager> loaderManagers) {}
