 ...
 * and programs, however in a real-world setting this might be run at other times to synchronize a
 * server's database with the TV provider database. This code will ensure that the channels from
...
public class UpdateChannelsJobService extends JobService {
  ...
  public static void schedule(Context context) {
    if (VERSION.SDK_INT >= 23) {
      ...
      scheduler.schedule(
          new JobInfo.Builder(
                  SYNC_JOB_ID, new ComponentName(context, UpdateChannelsJobService.class))
