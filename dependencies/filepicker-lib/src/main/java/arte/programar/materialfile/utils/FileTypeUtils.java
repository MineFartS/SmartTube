...
public class FileTypeUtils {
  ...
  public enum FileType {
    ...
    CERTIFICATE(
        R.drawable.ic_app_certificate,
        R.string.type_certificate,
        "cer",
        "der",
        "pfx",
        "p12",
        ...
        "pem"),
    COMPRESS(
        R.drawable.ic_app_compress,
        R.string.type_archive,
        "cab",
        "7z",
        "alz",
        "arj",
    ...
    WORD(
        ...
        "ott"),
    DRAWING(
        R.drawable.ic_app_drawing,
        R.string.type_drawing,
        "ai",
        "cdr",
        "dfx",
        "eps",
    ...
    PRESENTATION(
        R.drawable.ic_app_presentation,
        R.string.type_power_point,
        "pptx",
        "keynote",
        "ppt",
        "pps",
