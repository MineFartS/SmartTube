 ...
 * containing the results. The results are rendered into a {@link RowsFragment}, in the same way
 * that they are in a {@link BrowseFragment}.
 *
...
public class SearchFragment extends Fragment {
  ...
  public static interface SearchResultProvider {
     ...
     * the ObjectAdapter to instruct the SearchFragment to update the results.
     *
  ...
  final Runnable mResultsChangedCallback =
      new Runnable() {
        ...
        public void run() {
          ...
          if (mRowsFragment != null && mRowsFragment.getAdapter() != mResultAdapter) {
  ...
  public View onCreateView(
    ...
    if (getChildFragmentManager().findFragmentById(R.id.lb_results_frame) == null) {
      ...
      getChildFragmentManager()
          .beginTransaction()
          .replace(R.id.lb_results_frame, mRowsFragment)
          .commit();
    } else {
      mRowsFragment =
          (RowsFragment) getChildFragmentManager().findFragmentById(R.id.lb_results_frame);
    }
    mRowsFragment.setOnItemViewSelectedListener(
  ...
  public void onResume() {
    ...
    if (mSpeechRecognitionCallback == null && null == mSpeechRecognizer) {
      mSpeechRecognizer =
          SpeechRecognizer.createSpeechRecognizer(FragmentUtil.getContext(SearchFragment.this));
   ...
   * user clicks a MIC button. Note that SearchFragment automatically starts speech recognition at
   * first time created, there is no need to call startRecognition() when fragment is created.
   */
