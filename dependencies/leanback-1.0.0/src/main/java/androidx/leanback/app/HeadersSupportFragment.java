 ...
 *
 * <ul>
 *   <li>{@link DividerRow} rendered by {@link DividerPresenter}.
 *   <li>{@link Row} rendered by {@link RowHeaderPresenter}.
 *   <li>{@link SectionRow} rendered by {@link RowHeaderPresenter}.
 * </ul>
 *
...
public class HeadersSupportFragment extends BaseRowSupportFragment {
  ...
  private static final PresenterSelector sHeaderPresenter =
      new ClassPresenterSelector()
          ...
          .addClassPresenter(
              SectionRow.class, new RowHeaderPresenter(R.layout.lb_section_header, false))
  ...
  final ItemBridgeAdapter.Wrapper mWrapper =
      new ItemBridgeAdapter.Wrapper() {
        @Override
  ...
  private void updateFadingEdgeToBrandColor(int backgroundColor) {
    ...
    if (background instanceof GradientDrawable) {
      background.mutate();
      ((GradientDrawable) background).setColors(new int[] {Color.TRANSPARENT, backgroundColor});
    }
  }
