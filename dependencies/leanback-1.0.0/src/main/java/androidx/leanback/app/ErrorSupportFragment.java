...
public class ErrorSupportFragment extends BrandedSupportFragment {
  ...
  public void setBackgroundDrawable(Drawable drawable) {
    ...
    if (drawable != null) {
      ...
      mIsBackgroundTranslucent =
          (opacity == PixelFormat.TRANSLUCENT || opacity == PixelFormat.TRANSPARENT);
    }
    updateBackground();
    updateMessage();
  }
  ...
  public View onCreateView(
    ...
    int underMessageBaselineMargin =
        container
            .getResources()
  ...
  private void updateBackground() {
    if (mErrorFrame != null) {
      if (mBackgroundDrawable != null) {
        ...
        mErrorFrame.setBackgroundColor(
            mErrorFrame
                .getResources()
                .getColor(
                    mIsBackgroundTranslucent
