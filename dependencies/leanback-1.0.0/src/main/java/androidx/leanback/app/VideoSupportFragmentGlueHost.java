...
/**
 * {@link PlaybackGlueHost} implementation the interaction between {@link PlaybackGlue} and {@link
...
public class VideoSupportFragmentGlueHost extends PlaybackSupportFragmentGlueHost
  ...
  /**
   * Sets the {@link android.view.SurfaceHolder.Callback} on the host. {@link PlaybackGlueHost} is
   * assumed to either host the {@link SurfaceHolder} or have a reference to the component hosting
   * it for rendering the video.
   */
  @Override
