...
/**
 * Subclass of {@link PlaybackFragment} that is responsible for providing a {@link SurfaceView} and
 * rendering video.
 *
...
public class VideoFragment extends PlaybackFragment {
  ...
  public View onCreateView(
    ...
    mVideoSurface =
        (SurfaceView)
            LayoutInflater.from(FragmentUtil.getContext(VideoFragment.this))
                .inflate(R.layout.lb_video_surface, root, false);
