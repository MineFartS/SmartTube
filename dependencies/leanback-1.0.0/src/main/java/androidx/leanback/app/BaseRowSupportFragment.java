...
abstract class BaseRowSupportFragment extends Fragment {
  ...
  private final OnChildViewHolderSelectedListener mRowSelectedListener =
      new OnChildViewHolderSelectedListener() {
        ...
        public void onChildViewHolderSelected(
            RecyclerView parent, RecyclerView.ViewHolder view, int position, int subposition) {
  ...
  /** This class waits for the adapter to be updated before setting the selected row. */
