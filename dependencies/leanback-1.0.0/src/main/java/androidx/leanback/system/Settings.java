 ...
 *
 * <p>Note this class is not thread safe and its methods should only be invoked from the UI thread
 */
public class Settings {
  ...
  /**
   * Sets the boolean preference for the given key. If an app uses this api to override a default
   * preference, it must do so on every activity create.
   */
    ...
    if (ShadowOverlayContainer.supportsDynamicShadow()) {
      ...
      if (customizations != null) {
        mPreferStaticShadows =
            customizations.getBoolean("leanback_prefer_static_shadows", mPreferStaticShadows);
      }
    } else {
