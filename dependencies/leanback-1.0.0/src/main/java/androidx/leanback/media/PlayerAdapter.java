 ...
 * {@link PlaybackTransportControlGlue} is bound to a PlayerAdapter. This class is intended to be
 * subclassed, {@link MediaPlayerAdapter} is a concrete subclass using {@link
 * android.media.MediaPlayer}. ExoPlayer also provides a leanback extension that implements
 * PlayerAdapter. Please see <a
 * href="https://developer.android.com/guide/topics/media/exoplayer">ExoPlayer</a>
...
public abstract class PlayerAdapter {
  ...
  public static class Callback {
    ...
    /**
     * Event for {@link #getDuration()} changed. Usually the duration does not change after playing
     * except for live stream.
     *
  ...
  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_SKIP_TO_NEXT} to skip to next item.
   */
  public void next() {}

  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_SKIP_TO_PREVIOUS} to skip to previous item.
   */
  public void previous() {}

  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_FAST_FORWARD} to fast forward current media item.
   */
  public void fastForward() {}

  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_REWIND} to rewind in current media item.
   */
  public void rewind() {}
  ...
  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_SHUFFLE} to set the shuffle action.
   *
   * @param shuffleActionIndex The repeat action. Must be one of the followings: {@link
   *     androidx.leanback.widget.PlaybackControlsRow.ShuffleAction#INDEX_OFF} {@link
   *     androidx.leanback.widget.PlaybackControlsRow.ShuffleAction#INDEX_ON}
   */
  public void setShuffleAction(int shuffleActionIndex) {}

  /**
   * Optional method. Override this method if {@link #getSupportedActions()} include {@link
   * PlaybackBaseControlGlue#ACTION_REPEAT} to set the repeat action.
   *
   * @param repeatActionIndex The shuffle action. Must be one of the followings: {@link
   *     androidx.leanback.widget.PlaybackControlsRow.RepeatAction#INDEX_ONE} {@link
   *     androidx.leanback.widget.PlaybackControlsRow.RepeatAction#INDEX_ALL}, {@link
   *     androidx.leanback.widget.PlaybackControlsRow.RepeatAction#INDEX_NONE},
   */
  ...
  /**
   * Return xor combination of values defined in PlaybackBaseControlGlue. Default is PLAY_PAUSE
   * (unless subclass enforce to be 0)
   */
   ...
   * different {@link PlaybackGlue} or {@link PlaybackGlueHost} is destroyed. Subclass may override.
   * A typical implementation will release resources (e.g. MediaPlayer or connection to playback
