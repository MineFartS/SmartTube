...
/**
 * This class represents the UI (e.g. Fragment/Activity) hosting playback controls and defines the
 * interaction between {@link PlaybackGlue} and the host. PlaybackGlueHost provides the following
 * functions:
 * <li>Render UI of PlaybackGlue: {@link #setPlaybackRow(Row)}, {@link
 ...
 *     {@link #setOnActionClickedListener(OnActionClickedListener)}. Subclass of PlaybackGlueHost
 *     may implement optional interfaces:
 * <li>{@link SurfaceHolderGlueHost} to provide SurfaceView for video playback.
 * <li>{@link PlaybackSeekUi} to provide seek UI to glue These optional interfaces should be
 *     accessed by glue in {@link PlaybackGlue#onAttachedToHost(PlaybackGlueHost)}.
 */
public abstract class PlaybackGlueHost {
  ...
  /**
   * Enables or disables view fading. If enabled, the view will be faded in when the fragment starts
   * and will fade out after a time period.
   *
  ...
  /**
   * Enables or disables controls overlay auto hidden. If enabled, the view will be faded out after
   * a time period.
   *
  ...
  /**
   * Sets the {@link android.view.View.OnKeyListener} on the host. This would trigger the listener
   * when a {@link android.view.KeyEvent} is unhandled by the host.
   */
  ...
  /**
   * Sets the host {@link HostCallback} callback on the host. This method should only be called by
   * {@link PlaybackGlue}. App should not directly call this method, app should override {@link
   * PlaybackGlue#onHostStart()} etc.
   */
  ...
  /**
   * Sets the {@link Row} that represents the information on control items that needs to be
   * rendered.
   */
