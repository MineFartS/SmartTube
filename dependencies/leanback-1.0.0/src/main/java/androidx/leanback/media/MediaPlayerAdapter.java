...
public class MediaPlayerAdapter extends PlayerAdapter {
  ...
  final MediaPlayer.OnInfoListener mOnInfoListener =
  ...
  void notifyBufferingStartEnd() {
    getCallback()
        .onBufferingStateChanged(MediaPlayerAdapter.this, mBufferingStart || !mInitialized);
  }
   ...
   *       <li><code>MEDIA_INFO_NETWORK_BANDWIDTH (703)</code> - bandwidth information is available
   *           (as <code>extra</code> kbps)
   ...
   * PlayerAdapter class. {@link MediaPlayer#setOnPreparedListener} {@link
   * MediaPlayer#setOnVideoSizeChangedListener} {@link MediaPlayer#setOnErrorListener} {@link
   * MediaPlayer#setOnSeekCompleteListener} {@link MediaPlayer#setOnCompletionListener} {@link
   * MediaPlayer#setOnInfoListener} {@link MediaPlayer#setOnBufferingUpdateListener}
   *
  ...
  /**
   * @return True if MediaPlayer OnPreparedListener is invoked and got a SurfaceHolder if {@link
