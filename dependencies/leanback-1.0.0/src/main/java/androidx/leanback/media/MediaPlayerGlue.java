...
/**
 * This glue extends the {@link androidx.leanback.media.PlaybackControlGlue} with a {@link
 * MediaPlayer} synchronization. It supports 7 actions:
 *
 * <ul>
 ...
 *   <li>{@link androidx.leanback.widget.PlaybackControlsRow.PlayPauseAction}
 ...
 *
 * @hide
 * @deprecated Use {@link MediaPlayerAdapter} with {@link PlaybackTransportControlGlue} or {@link
...
public class MediaPlayerGlue extends PlaybackControlGlue implements OnItemViewSelectedListener {
  ...
  /**
   * Will reset the {@link MediaPlayer} and the glue such that a new file can be played. You are not
   * required to call this method before playing the first file. However you have to call it before
   ...
   *
   * @return Returns <code>true</code> if uri represents a new media; <code>false</code> otherwise.
   ...
   *
   * @return Returns <code>true</code> if path represents a new media; <code>false</code> otherwise.
   * @see MediaPlayer#setDataSource(String)
   */
   ...
   * implementation is required in order to detect KEY_DOWN events on the {@link
   * androidx.leanback.widget.PlaybackControlsRow.FastForwardAction} and {@link
   * androidx.leanback.widget.PlaybackControlsRow.RewindAction}. Thus you should <u>NOT</u> set
   * another {@link OnItemViewSelectedListener} on your Fragment. Instead, override this method and
   * call its super (this) implementation.
   *
