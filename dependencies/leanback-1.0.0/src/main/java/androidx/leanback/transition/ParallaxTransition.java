...
/**
 * A slide transition changes TRANSLATION attribute of view which is not exposed by any event. In
 * order to run a parallax effect with Slide transition, ParallaxTransition is running on the side,
 * calling ParallaxSource.updateValues() on every frame. User should make sure slide and
 * ParallaxTransition are using same duration and startDelay.
 *
 * @hide
 */
@RequiresApi(21)
