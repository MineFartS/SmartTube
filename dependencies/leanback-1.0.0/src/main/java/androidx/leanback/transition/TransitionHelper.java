...
public final class TransitionHelper {
  ...
  public static Object createTransitionSet(boolean sequential) {
    if (Build.VERSION.SDK_INT >= 19) {
      ...
      set.setOrdering(
          sequential ? TransitionSet.ORDERING_SEQUENTIAL : TransitionSet.ORDERING_TOGETHER);
      return set;
    }
    return new TransitionStub();
  }
  ...
  public static void setSharedElementEnterTransition(
      android.app.Fragment fragment, Object transition) {
    if (Build.VERSION.SDK_INT >= 21) {
  ...
  public static void addSharedElement(
      android.app.FragmentTransaction ft, View view, String transitionName) {
    if (Build.VERSION.SDK_INT >= 21) {
  ...
  public static void setEpicenterCallback(
      Object transition, final TransitionEpicenterCallback callback) {
    if (Build.VERSION.SDK_INT >= 21) {
      if (callback == null) {
