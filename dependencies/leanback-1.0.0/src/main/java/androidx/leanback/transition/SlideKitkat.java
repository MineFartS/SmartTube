...
/**
 * Slide distance toward/from a edge. This is a limited Slide implementation for KitKat without
 * propagation support.
 */
@RequiresApi(19)
class SlideKitkat extends Visibility {
   ...
   *     {@link android.view.Gravity#LEFT}, {@link android.view.Gravity#TOP}, {@link
   *     android.view.Gravity#RIGHT}, {@link android.view.Gravity#BOTTOM}, {@link
   *     android.view.Gravity#START}, {@link android.view.Gravity#END}.
   */
   ...
   *
   * @return the edge of the scene to use for Views appearing and disappearing. One of {@link
   *     android.view.Gravity#LEFT}, {@link android.view.Gravity#TOP}, {@link
   *     android.view.Gravity#RIGHT}, {@link android.view.Gravity#BOTTOM}, {@link
   *     android.view.Gravity#START}, {@link android.view.Gravity#END}.
   */
  ...
  private Animator createAnimation(
    ...
    SlideAnimatorListener listener =
        new SlideAnimatorListener(view, property, terminalValue, end, finalVisibility);
  ...
  public Animator onAppear(
    ...
    return createAnimation(
        view, mSlideCalculator.getProperty(), start, end, end, sDecelerate, View.VISIBLE);
  }
  ...
  public Animator onDisappear(
    ...
    return createAnimation(
        view, mSlideCalculator.getProperty(), start, end, start, sAccelerate, View.INVISIBLE);
  }
