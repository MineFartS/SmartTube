...
public final class ColorFilterCache {
  ...
  /**
   * Get a ColorDimmer for a given color. Only the RGB values are used; the alpha channel is ignored
   * in color. Subsequent calls to this method with the same color value will return the same cache.
   *
   ...
   * @return A ColorFilter at the alpha level for the color represented by the cache.
   */
