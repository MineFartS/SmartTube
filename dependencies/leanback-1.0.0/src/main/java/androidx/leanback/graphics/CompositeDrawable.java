...
/**
 * Generic drawable class that can be composed of multiple children. Whenever the bounds changes for
 * this class, it updates those of its children.
 */
public class CompositeDrawable extends Drawable implements Drawable.Callback {
  ...
  /**
   * Wrapper class holding a drawable object and {@link BoundsRule} to update drawable bounds when
  ...
  public static final class ChildDrawable {
    ...
    /**
     * After changing the {@link BoundsRule}, user should call this function for the drawable to
    ...
    public static final Property<CompositeDrawable.ChildDrawable, Integer> BOTTOM_ABSOLUTE =
        new Property<CompositeDrawable.ChildDrawable, Integer>(Integer.class, "absoluteBottom") {
          @Override
          public void set(CompositeDrawable.ChildDrawable obj, Integer value) {
    ...
    public static final Property<CompositeDrawable.ChildDrawable, Integer> LEFT_ABSOLUTE =
        new Property<CompositeDrawable.ChildDrawable, Integer>(Integer.class, "absoluteLeft") {
          @Override
          public void set(CompositeDrawable.ChildDrawable obj, Integer value) {
    ...
    public static final Property<CompositeDrawable.ChildDrawable, Integer> RIGHT_ABSOLUTE =
        new Property<CompositeDrawable.ChildDrawable, Integer>(Integer.class, "absoluteRight") {
          @Override
          public void set(CompositeDrawable.ChildDrawable obj, Integer value) {
    ...
    /**
     * Implementation of {@link Property} for overwriting the bottom attribute of {@link BoundsRule}
     * associated with this {@link ChildDrawable}. This allows users to change the bounds rules as a
     * percentage of parent size. This is preferable over {@link #TOP_ABSOLUTE} when the exact
     * start/end position of scroll movement isn't available at compile time.
     */
     ...
     * Implementation of {@link Property} for overwriting the bottom attribute of {@link BoundsRule}
     * associated with this {@link ChildDrawable}. This allows users to change the bounds rules as a
     * percentage of parent size. This is preferable over {@link #BOTTOM_ABSOLUTE} when the exact
     * start/end position of scroll movement isn't available at compile time.
     */
    public static final Property<CompositeDrawable.ChildDrawable, Float> BOTTOM_FRACTION =
        new Property<CompositeDrawable.ChildDrawable, Float>(Float.class, "fractionBottom") {
          @Override
          public void set(CompositeDrawable.ChildDrawable obj, Float value) {
            if (obj.getBoundsRule().bottom == null) {
     ...
     * Implementation of {@link Property} for overwriting the bottom attribute of {@link BoundsRule}
     * associated with this {@link ChildDrawable}. This allows users to change the bounds rules as a
     * percentage of parent size. This is preferable over {@link #LEFT_ABSOLUTE} when the exact
     * start/end position of scroll movement isn't available at compile time.
     */
     ...
     * Implementation of {@link Property} for overwriting the bottom attribute of {@link BoundsRule}
     * associated with this {@link ChildDrawable}. This allows users to change the bounds rules as a
     * percentage of parent size. This is preferable over {@link #RIGHT_ABSOLUTE} when the exact
     * start/end position of scroll movement isn't available at compile time.
     */
