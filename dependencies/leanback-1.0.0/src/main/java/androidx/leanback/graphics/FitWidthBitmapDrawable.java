...
/**
 * Subclass of {@link Drawable} that can be used to draw a bitmap into a region. Bitmap will be
 * scaled to fit the full width of the region and will be aligned to the top left corner. Any region
 * outside the bounds will be clipped during {@link #draw(Canvas)} call. Top position of the bitmap
 * can be controlled by {@link #setVerticalOffset(int)} call or {@link #PROPERTY_VERTICAL_OFFSET}.
 */
public class FitWidthBitmapDrawable extends Drawable {
  ...
  /**
   * Sets the vertical offset which will be used for drawing the bitmap. The bitmap drawing will
   * start the provided vertical offset.
   *
  ...
  static {
    if (Build.VERSION.SDK_INT >= 24) {
      ...
      PROPERTY_VERTICAL_OFFSET =
          new Property<FitWidthBitmapDrawable, Integer>(Integer.class, "verticalOffset") {
            @Override
