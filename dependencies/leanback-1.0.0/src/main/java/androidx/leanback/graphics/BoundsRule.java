...
/**
 * This class contains the rules for updating the bounds of a {@link
 * CompositeDrawable.ChildDrawable}. It contains four rules, one for each value of the rectangular
