...
/**
 * Subclass of Parallax object that tracks overview row's top and bottom edge in DetailsFragment or
 * DetailsSupportFragment.
 *
 * <p>It can be used for both creating cover image parallax effect and controlling video playing
 * when transitioning to/from half/full screen. A direct use case is {@link
...
public class DetailsParallax extends RecyclerViewParallax {
  ...
  public DetailsParallax() {
    ...
    mFrameTop = addProperty("overviewRowTop").adapterPosition(0).viewId(R.id.details_frame);
  ...
  /**
   * Returns the top of the details overview row. This is tracked for implementing the parallax
   * effect.
   */
  ...
  /**
   * Returns the bottom of the details overview row. This is tracked for implementing the parallax
   * effect.
   */
