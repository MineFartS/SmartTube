...
/**
 * The presenter displaying a custom action in {@link AbstractMediaItemPresenter}. This is the
 * default presenter for actions in media rows if no action presenter is provided by the user.
 *
 * <p>Binds to items of type {@link MultiActionsProvider.MultiAction}.
 */
class MediaItemActionPresenter extends Presenter {
  ...
  public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
    ...
    View actionView =
        LayoutInflater.from(context).inflate(R.layout.lb_row_media_item_action, parent, false);
