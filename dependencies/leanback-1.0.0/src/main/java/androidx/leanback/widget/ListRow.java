...
/**
 * A {@link Row} composed of a optional {@link HeaderItem}, and an {@link ObjectAdapter} describing
...
public class ListRow extends Row {
  ...
  /**
   * Returns content description for the ListRow. By default it returns {@link
   * HeaderItem#getContentDescription()} or {@link HeaderItem#getName()}, unless {@link
   * #setContentDescription(CharSequence)} was explicitly called.
   *
