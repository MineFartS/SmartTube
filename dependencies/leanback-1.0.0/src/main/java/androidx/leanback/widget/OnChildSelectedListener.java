...
public interface OnChildSelectedListener {
   ...
   * @param view The view within the ViewGroup that is selected, or null if no view is selected.
   * @param position The position of the view in the adapter, or NO_POSITION if no view is selected.
   * @param id The id of the child that is selected, or NO_ID if no view is selected.
   */
