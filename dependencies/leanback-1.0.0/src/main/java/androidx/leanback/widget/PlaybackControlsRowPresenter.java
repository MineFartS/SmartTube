...
/**
 * A PlaybackControlsRowPresenter renders a {@link PlaybackControlsRow} to display a series of
 * playback control buttons. Typically this row will be the first row in a fragment such as the
 * {@link androidx.leanback.app.PlaybackFragment}.
 *
 * <p>The detailed description is rendered using a {@link Presenter} passed in {@link
 * #PlaybackControlsRowPresenter(Presenter)}. Typically this will be an instance of {@link
 * AbstractDetailsDescriptionPresenter}. The application can access the detailed description
 * ViewHolder from {@link ViewHolder#mDescriptionViewHolder}.
 */
public class PlaybackControlsRowPresenter extends PlaybackRowPresenter {
  ...
  /**
   * Sets the secondary actions to be hidden behind a "more actions" button. When "more actions" is
   * selected, the primary actions are replaced with the secondary actions.
   */
  ...
  /**
   * Shows or hides space at the bottom of the playback controls row. This allows the row to hug the
   * bottom of the display when no other rows are present.
   */
  ...
  /**
   * Displays the primary actions. This will override the user having selected "more actions" to
   * display the secondary actions; see {@link #setSecondaryActionsHidden(boolean)}.
   */
  ...
  private void initRow(final ViewHolder vh) {
    ...
    vh.mControlsVh =
        (PlaybackControlsPresenter.ViewHolder)
            mPlaybackControlsPresenter.onCreateViewHolder(vh.mControlsDock);
    mPlaybackControlsPresenter.setProgressColor(
        vh.mControlsVh,
        mProgressColorSet
            ? mProgressColor
            : getDefaultProgressColor(vh.mControlsDock.getContext()));
    mPlaybackControlsPresenter.setBackgroundColor(
        vh.mControlsVh,
        mBackgroundColorSet ? mBackgroundColor : getDefaultBackgroundColor(vh.view.getContext()));
    ...
    ((PlaybackControlsRowView) vh.view)
