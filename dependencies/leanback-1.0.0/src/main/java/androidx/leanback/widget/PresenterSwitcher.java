...
/**
 * An abstract helper class that switches a view in its parent view using a {@link
 * PresenterSelector}. A subclass should implement {@link #insertView(View)} to define how to add
 * the view in parent, and may optionally override {@link #onViewSelected(View)}.
 */
public abstract class PresenterSwitcher {
  ...
  /**
   * Initializes the switcher with a parent view to insert view into and a {@link PresenterSelector}
   * for choosing a {@link Presenter} for a given object. This will destroy any existing views.
   */
