...
/**
 * A {@link android.widget.TextView} that adjusts text size automatically in response to certain
 * trigger conditions, such as text that wraps over multiple lines.
 */
class ResizingTextView extends TextView {
  ...
  public ResizingTextView(Context ctx, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray a =
        ctx.obtainStyledAttributes(
            attrs, R.styleable.lbResizingTextView, defStyleAttr, defStyleRes);

    try {
      mTriggerConditions =
          a.getInt(R.styleable.lbResizingTextView_resizeTrigger, TRIGGER_MAX_LINES);
      mResizedTextSize =
          a.getDimensionPixelSize(R.styleable.lbResizingTextView_resizedTextSize, -1);
      mMaintainLineSpacing =
          a.getBoolean(R.styleable.lbResizingTextView_maintainLineSpacing, false);
      mResizedPaddingAdjustmentTop =
          a.getDimensionPixelOffset(R.styleable.lbResizingTextView_resizedPaddingAdjustmentTop, 0);
  ...
  /**
   * Set the trigger conditions used to determine whether resize occurs. Pass a union of trigger
   * condition constants, such as {@link ResizingTextView#TRIGGER_MAX_LINES}.
   *
  ...
  /**
   * @return whether or not to maintain line spacing when resizing text. The default is true.
   */
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (resizeText) {
      ...
      final float targetLineSpacingExtra =
          mDefaultLineSpacingExtra + mDefaultTextSize - mResizedTextSize;
  ...
  /**
   * See {@link TextViewCompat#setCustomSelectionActionModeCallback(TextView, ActionMode.Callback)}
   */
  @Override
