 ...
 * labels. A PickerColumn has a minValue and maxValue to choose between. The Picker column has a
 * current value. The labels can be dynamically generated from value by {@link
 * #setLabelFormat(String)} or a list of static labels set by {@link
...
public class PickerColumn {
  ...
  /**
   * Set string format (see {@link String#format}) to display label for an integer value. {@link
   * #setStaticLabels(CharSequence[])} overrides the format.
   *
  ...
  /**
   * Return string format (see {@link String#format}) to display label for value.
   *
  ...
  /**
   * Get a label for value. The label can be static {@link #setStaticLabels(CharSequence[])} or
   * dynamically generated {@link #setLabelFormat(String)} when static labels is null.
   *
