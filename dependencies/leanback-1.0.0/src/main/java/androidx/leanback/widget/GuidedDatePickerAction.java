...
public class GuidedDatePickerAction extends GuidedAction {
  ...
  /**
   * Base Builder class to build GuidedDatePickerAction. Subclass this BuilderBase when app needs to
   * subclass GuidedDatePickerAction, implement your build() which should call {@link
   * #applyDatePickerValues(GuidedDatePickerAction)}. When using GuidedDatePickerAction directly,
   * use {@link Builder}.
   */
  public abstract static class BuilderBase<B extends BuilderBase>
     ...
     * containing the day ('d'), month ('m'), and year ('y'). When the format is not specified, a
     * default format of current locale will be used.
     *
    ...
    /**
     * Sets a Date for date picker in milliseconds since January 1, 1970 00:00:00 in {@link
    ...
    /**
     * Sets minimal Date for date picker in milliseconds since January 1, 1970 00:00:00 in {@link
     * TimeZone#getDefault()} time zone.
     *
     * @return This Builder Object.
     */
    ...
    /**
     * Sets maximum Date for date picker in milliseconds since January 1, 1970 00:00:00 in {@link
     * TimeZone#getDefault()} time zone.
     *
     * @return This Builder Object.
     */
  ...
  /**
   * Returns format of date Picker or null if not specified. The format is a case insensitive String
   * containing the * day ('d'), month ('m'), and year ('y'). When the format is not specified, a
   * default format of current locale will be used.
   *
  ...
  /**
   * Get current value of DatePicker in milliseconds since January 1, 1970 00:00:00 in {@link
   * TimeZone#getDefault()} time zone.
   *
  ...
  /**
   * Sets current value of DatePicker in milliseconds since January 1, 1970 00:00:00 in {@link
   * TimeZone#getDefault()} time zone.
   *
  ...
  /**
   * Get minimal value of DatePicker in milliseconds since January 1, 1970 00:00:00 in {@link
   * TimeZone#getDefault()} time zone. -1 if not set.
   *
  ...
  /**
   * Get maximum value of DatePicker in milliseconds since January 1, 1970 00:00:00 in {@link
   * TimeZone#getDefault()} time zone.
   *
