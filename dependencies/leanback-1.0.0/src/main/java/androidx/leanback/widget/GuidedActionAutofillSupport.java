...
/**
 * Interface for a custom EditText subclass to support autofill in {@link
 * androidx.leanback.app.GuidedStepSupportFragment}.
 *
 * <p>Apps who needs to supply custom layouts for {@link GuidedActionsStylist} with their own
 * EditText classes should implement this interface in order to support autofill in {@link
 * androidx.leanback.app.GuidedStepSupportFragment}. This ensures autofill event happened within
 * custom EditText is propagated to GuidedStepSupportFragment. e.g.
 *
 * <pre><code>
