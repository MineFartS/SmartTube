...
public class GuidedActionEditText extends EditText
    implements ImeKeyMonitor, GuidedActionAutofillSupport {

  /**
   * Workaround for b/26990627 forcing recompute the padding for the View when we turn on/off the
   * default background of EditText
   */
