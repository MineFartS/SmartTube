...
/**
 * Helper for managing {@link androidx.leanback.widget.TitleView}, including transitions and focus
 * movement. Assumes the TitleView is overlayed on the topmost portion of the scene root view.
 */
public class TitleHelper {
  ...
  private final BrowseFrameLayout.OnFocusSearchListener mOnFocusSearchListener =
      new BrowseFrameLayout.OnFocusSearchListener() {
        ...
        public View onFocusSearch(View focused, int direction) {
          ...
          final boolean isRtl =
              ViewCompat.getLayoutDirection(focused) == ViewCompat.LAYOUT_DIRECTION_RTL;
  ...
  private void createTransitions() {
    mTitleUpTransition = LeanbackTransitionHelper.loadTitleOutTransition(mSceneRoot.getContext());
    mTitleDownTransition = LeanbackTransitionHelper.loadTitleInTransition(mSceneRoot.getContext());
    mSceneWithTitle =
  ...
  /**
   * Returns a {@link androidx.leanback.widget.BrowseFrameLayout.OnFocusSearchListener} which may be
   * used to manage focus switching between the title view and scene root.
   */
