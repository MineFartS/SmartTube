...
/**
 * The base class for all rows. A commonly used subclass is the {@link ListRow}. Custom subclasses
 * may define other types of rows.
 */
public class Row {
   ...
   * @param headerItem The {@link HeaderItem} for this Row, or null if there is no header.
   */
   ...
   *
   * @param headerItem The HeaderItem for this Row, or null if there is no header.
   */
   ...
   *
   * <ul>
   *   <li>If {@link #setId(long)} is ever called on this row, it will return this id.
   *   <li>If {@link #setId(long)} has not been called but the header item is not null, the result
   *       of {@link HeaderItem#getId()} is returned.
   ...
   * {@link ListRow} is rendered by {@link ListRowPresenter}. {@link PageRow}, {@link SectionRow},
   * {@link DividerRow} are rendered as invisible row views.
   *
