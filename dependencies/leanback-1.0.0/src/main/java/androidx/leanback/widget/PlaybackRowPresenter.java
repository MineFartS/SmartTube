...
/**
 * Subclass of {@link RowPresenter} that can define the desired behavior when the view reappears.
 * This is presently used by {@link PlaybackControlsRowPresenter} to update the UI after we
 * show/hide the controls view.
 */
