 ...
 * #DetailsOverviewRowPresenter(Presenter)}. Typically this will be an instance of {@link
 ...
 *
 * <p>To participate in activity transition, call {@link #setSharedElementEnterTransition(Activity,
 * String)} during Activity's onCreate().
 *
 * <p>Because transition support and layout are fully controlled by DetailsOverviewRowPresenter,
...
public class DetailsOverviewRowPresenter extends RowPresenter {
  ...
  /**
   * Sets the layout style to be large or small. This affects the height of the overview, including
   * the text description. The default is large.
   */
  ...
  /**
   * Sets the enter transition of target activity to be transiting into overview row created by this
   * presenter. The transition will be cancelled if the overview image is not loaded in the timeout
   * period.
   *
   * <p>It assumes shared element passed from calling activity is an ImageView; the shared element
   ...
   *
   * <p>The method must be invoked in target Activity's onCreate().
   */
  public final void setSharedElementEnterTransition(
      Activity activity, String sharedElementName, long timeoutMs) {
  ...
  /**
   * Sets the enter transition of target activity to be transiting into overview row created by this
   * presenter. The transition will be cancelled if overview image is not loaded in a default
   * timeout period.
   *
   * <p>It assumes shared element passed from calling activity is an ImageView; the shared element
   * transits to overview image on the starting edge of the detail overview row, while bounds of
  ...
  private int getCardHeight(Context context) {
    int resId =
        mIsStyleLarge
            ? R.dimen.lb_details_overview_height_large
  ...
  protected void onRowViewAttachedToWindow(RowPresenter.ViewHolder vh) {
    ...
    if (mDetailsPresenter != null) {
      mDetailsPresenter.onViewAttachedToWindow(((ViewHolder) vh).mDetailsDescriptionViewHolder);
    }
  }
  ...
  protected void onRowViewDetachedFromWindow(RowPresenter.ViewHolder vh) {
    ...
    if (mDetailsPresenter != null) {
      mDetailsPresenter.onViewDetachedFromWindow(((ViewHolder) vh).mDetailsDescriptionViewHolder);
    }
  }
}
