  ...
  public MediaNowPlayingView(Context context, AttributeSet attrs) {
    ...
    mObjectAnimator1 =
        ObjectAnimator.ofFloat(
            mImage1, "scaleY", 5f / 12f, 3f / 12f, 5f / 12f, 7f / 12f, 9f / 12f, 10f / 12f,
            11f / 12f, 12f / 12f, 11f / 12f, 12f / 12f, 10f / 12f, 8f / 12f, 6f / 12f, 4f / 12f,
            2f / 12f, 4f / 12f, 6f / 12f, 7f / 12f, 9f / 12f, 11f / 12f, 9f / 12f, 7f / 12f,
            5f / 12f, 3f / 12f, 5f / 12f, 8f / 12f, 5f / 12f, 3f / 12f, 4f / 12f, 5f / 12f);
    ...
    mObjectAnimator2 =
        ObjectAnimator.ofFloat(
            mImage2, "scaleY", 12f / 12f, 11f / 12f, 10f / 12f, 11f / 12f, 12f / 12f, 11f / 12f,
            9f / 12f, 7f / 12f, 9f / 12f, 11f / 12f, 12f / 12f, 10f / 12f, 8f / 12f, 10f / 12f,
            12f / 12f, 11f / 12f, 9f / 12f, 5f / 12f, 3f / 12f, 5f / 12f, 8f / 12f, 10f / 12f,
            12f / 12f, 10f / 12f, 9f / 12f, 8f / 12f, 12f / 12f);
    ...
    mObjectAnimator3 =
        ObjectAnimator.ofFloat(
            mImage3, "scaleY", 8f / 12f, 9f / 12f, 10f / 12f, 12f / 12f, 11f / 12f, 9f / 12f,
            7f / 12f, 5f / 12f, 7f / 12f, 8f / 12f, 9f / 12f, 12f / 12f, 11f / 12f, 12f / 12f,
            9f / 12f, 7f / 12f, 9f / 12f, 11f / 12f, 12f / 12f, 10f / 12f, 8f / 12f, 9f / 12f,
            7f / 12f, 5f / 12f, 3f / 12f, 8f / 12f);
