...
/**
 * An abstract {@link Presenter} for rendering a detailed description of an item. Typically this
 * Presenter will be used in a {@link DetailsOverviewRowPresenter} or {@link
 * PlaybackControlsRowPresenter}.
 *
 * <p>Subclasses must override {@link #onBindDescription} to implement the data binding for this
 * Presenter.
 */
public abstract class AbstractDetailsDescriptionPresenter extends Presenter {
  ...
  public static class ViewHolder extends Presenter.ViewHolder {
    ...
    public ViewHolder(final View view) {
      ...
      final int titleAscent =
          view.getResources().getDimensionPixelSize(R.dimen.lb_details_description_title_baseline);
      // Ascent is negative
      mTitleMargin = titleAscent + titleFontMetricsInt.ascent;

      mUnderTitleBaselineMargin =
          view.getResources()
              .getDimensionPixelSize(R.dimen.lb_details_description_under_title_baseline_margin);
      mUnderSubtitleBaselineMargin =
          view.getResources()
              .getDimensionPixelSize(R.dimen.lb_details_description_under_subtitle_baseline_margin);

      mTitleLineSpacing =
          view.getResources()
              .getDimensionPixelSize(R.dimen.lb_details_description_title_line_spacing);
      mBodyLineSpacing =
          view.getResources()
              .getDimensionPixelSize(R.dimen.lb_details_description_body_line_spacing);
      ...
      mTitle.addOnLayoutChangeListener(
  ...
  public final void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
    ...
    if (TextUtils.isEmpty(vh.mTitle.getText())) {
      ...
      vh.mTitle.setLineSpacing(
          vh.mTitleLineSpacing - vh.mTitle.getLineHeight() + vh.mTitle.getLineSpacingExtra(),
  ...
  /**
   * Binds the data from the item to the ViewHolder. The item is typically associated with a {@link
   * DetailsOverviewRow} or {@link PlaybackControlsRow}.
   *
