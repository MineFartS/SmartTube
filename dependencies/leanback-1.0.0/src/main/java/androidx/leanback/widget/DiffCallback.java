...
/**
 * Callback that informs {@link ArrayObjectAdapter} how to compute list updates when using {@link
 * DiffUtil} in {@link ArrayObjectAdapter#setItems(List, DiffCallback)} method.
 *
 * <p>The {@link ArrayObjectAdapter#setItems(List, DiffCallback)} method will pass items from
 * different lists to this callback in order to implement the {@link DiffUtil.Callback} it uses to
