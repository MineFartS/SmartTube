 ...
 * Presentation (view creation and state animation) is delegated to a {@link GuidedActionsStylist},
 * while clients are notified of interactions via {@link GuidedActionAdapter.ClickListener} and
 * {@link GuidedActionAdapter.FocusListener}.
 *
 * @hide
 */
...
public class GuidedActionAdapter extends RecyclerView.Adapter {
        ...
        public void onClick(View v) {
          if (v != null && v.getWindowToken() != null && getRecyclerView() != null) {
            GuidedActionsStylist.ViewHolder avh =
                (GuidedActionsStylist.ViewHolder) getRecyclerView().getChildViewHolder(v);
  ...
  public GuidedActionAdapter(
    ...
    super();
    mActions =
        actions == null ? new ArrayList<GuidedAction>() : new ArrayList<GuidedAction>(actions);
  ...
  /**
   * Change DiffCallback used in {@link #setActions(List)}. Set to null for firing a general {@link
  ...
  /**
   * Sets the list of actions managed by this adapter. Use {@link #setDiffCallback(DiffCallback)} to
   * change DiffCallback.
   *
              ...
              new DiffUtil.Callback() {
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                  return mDiffCallback.areItemsTheSame(
                      oldActions.get(oldItemPosition), mActions.get(newItemPosition));
                }
                ...
                public Object getChangePayload(int oldItemPosition, int newItemPosition) {
                  return mDiffCallback.getChangePayload(
                      oldActions.get(oldItemPosition), mActions.get(newItemPosition));
                }
              });
        ...
        for (int i = 0, size = mActions.size(); i < size; i++) {
          ...
          if (a != action && a.getCheckSetId() == actionCheckSetId && a.isChecked()) {
            ...
            GuidedActionsStylist.ViewHolder vh =
                (GuidedActionsStylist.ViewHolder) getRecyclerView().findViewHolderForPosition(i);
            if (vh != null) {
  ...
  private class ActionEditListener implements OnEditorActionListener, ImeKeyMonitor.ImeKeyListener {
