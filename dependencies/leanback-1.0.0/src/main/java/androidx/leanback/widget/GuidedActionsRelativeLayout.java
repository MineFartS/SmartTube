...
/**
 * Relative layout implementation that assign subactions list topMargin based on a percentage given
 * by "guidedStepKeyline" theme attribute when the topMargin is set to a negative value.
 */
