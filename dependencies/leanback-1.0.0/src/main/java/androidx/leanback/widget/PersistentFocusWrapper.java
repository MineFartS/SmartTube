...
/**
 * Saves the focused grandchild position. Helps add persistent focus feature to various ViewGroups.
 */
class PersistentFocusWrapper extends FrameLayout {
  ...
  /** By default, focus is persisted when searching vertically but not horizontally. */
  ...
  public void requestChildFocus(View child, View focused) {
    ...
    if (DEBUG) {
      Log.v(
          TAG, "requestChildFocus focused " + focused + " mSelectedPosition " + mSelectedPosition);
    }
  }
