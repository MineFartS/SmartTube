 ...
 *
 * <p>This class serves purpose of nested "listview" e.g. a vertical list of horizontal list.
 * Vertical list maintains id->bundle mapping of all its children (even the children is offscreen
 * and being pruned).
 *
 * <p>The class is currently used within {@link GridLayoutManager}, but it might be used by other
 * ViewGroup.
 */
class ViewsStateBundle {
  ...
  /**
   * @return the savePolicy, see {@link #SAVE_NO_CHILD} {@link #SAVE_ON_SCREEN_CHILD} {@link
  ...
  /**
   * @return the limitNumber, only works when {@link #getSavePolicy()} is {@link
   *     #SAVE_LIMITED_CHILD}
   */
