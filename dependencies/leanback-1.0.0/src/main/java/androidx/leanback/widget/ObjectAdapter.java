...
public abstract class ObjectAdapter {
  ...
  /**
   * A DataObserver can be notified when an ObjectAdapter's underlying data changes. Separate
   * methods provide notifications about different types of changes.
   */
  public abstract static class DataObserver {
    /**
     * Called whenever the ObjectAdapter's data has changed in some manner outside of the set of
     * changes covered by the other range-based change notification methods.
     */
    public void onChanged() {}

    /**
     * Called when a range of items in the ObjectAdapter has changed. The basic ordering and
     * structure of the ObjectAdapter has not changed.
     *
  ...
  /**
   * Called when {@link #setPresenterSelector(PresenterSelector)} is called and the
   * PresenterSelector differs from the previous one.
   */
  ...
  /**
   * Returns true if the item ids are stable across changes to the underlying data. When this is
   * true, clients of the ObjectAdapter can use {@link #getId(int)} to correlate Objects across
   * changes.
   */
  ...
  /**
   * Called when {@link #setHasStableIds(boolean)} is called and the status of stable ids has
   * changed.
   */
  ...
  /**
   * Returns true if the adapter pairs each underlying data change with a call to notify and false
   * otherwise.
   */
