...
/**
 * Bridge from {@link Presenter} to {@link RecyclerView.Adapter}. Public to allow use by third party
 * Presenters.
 */
public class ItemBridgeAdapter extends RecyclerView.Adapter implements FacetProviderAdapter {
  ...
  /**
   * Interface for wrapping a view created by a Presenter into another view. The wrapper must be the
   * immediate parent of the wrapped view.
   */
  ...
  final class OnFocusChangeListener implements View.OnFocusChangeListener {
    ...
    public void onFocusChange(View view, boolean hasFocus) {
      if (DEBUG) {
        Log.v(TAG, "onFocusChange " + hasFocus + " " + view + " mFocusHighlight" + mFocusHighlight);
      }
      if (mWrapper != null) {
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements FacetProvider {
    ...
    /**
     * Get extra object associated with the view. Developer can attach any customized UI object in
     * addition to {@link Presenter.ViewHolder}. A typical use case is attaching an animator object.
     */
    ...
    /**
     * Set extra object associated with the view. Developer can attach any customized UI object in
     * addition to {@link Presenter.ViewHolder}. A typical use case is attaching an animator object.
     */
  ...
  public int getItemViewType(int position) {
    PresenterSelector presenterSelector =
        mPresenterSelector != null ? mPresenterSelector : mAdapter.getPresenterSelector();
  ...
  /**
   * {@link View.OnFocusChangeListener} that assigned in {@link
   * Presenter#onCreateViewHolder(ViewGroup)} may be chained, user should never change {@link
