...
/**
 * A header item describes the metadata of a {@link Row}, such as a category of media items. May be
 * subclassed to add more information.
 */
public class HeaderItem {
  ...
  /**
   * Sets the description for the current header item. This will be visible when the row receives
   * focus.
   */
