...
public class VerticalGridPresenter extends Presenter {
              ...
              public void onClick(View view) {
                if (getOnItemViewClickedListener() != null) {
                  ...
                  getOnItemViewClickedListener()
                      .onItemClicked(itemViewHolder.mHolder, itemViewHolder.mItem, null, null);
                }
              }
            });
      }
  ...
  /**
   * Constructs a VerticalGridPresenter with defaults. Uses {@link
   * FocusHighlight#ZOOM_FACTOR_MEDIUM} for focus zooming and enabled dimming on focus.
   */
   ...
   *     FocusHighlight#ZOOM_FACTOR_LARGE} enabled dimming on focus.
   */
  ...
  /**
   * Enable or disable child shadow. This is not only for enable/disable default shadow
   ...
   * based) will be applied to each individual child of {@link VerticalGridView}. Subclass may
   ...
   * vertical grid. If subclass returns false in isUsingDefaultShadow() and does not use Z-shadow on
   * SDK >= L, it should override isUsingZOrder() return false.
   */
  ...
  protected ViewHolder createGridViewHolder(ViewGroup parent) {
    View root =
        LayoutInflater.from(parent.getContext()).inflate(R.layout.lb_vertical_grid, parent, false);
    return new ViewHolder((VerticalGridView) root.findViewById(R.id.browse_grid));
  }

  /**
   * Called after a {@link VerticalGridPresenter.ViewHolder} is created. Subclasses may override
   * this method and start by calling super.initializeGridViewHolder(ViewHolder).
   *
  ...
  protected void initializeGridViewHolder(ViewHolder vh) {
    ...
    FocusHighlightHelper.setupBrowseItemFocusHighlight(
        vh.mItemBridgeAdapter, mFocusZoomFactor, mUseFocusDimmer);
  ...
  /**
   * Set if keeps foreground of child of this grid, the foreground will not be used for overlay
  ...
  /**
   * Returns true if keeps foreground of child of this grid, the foreground will not be used for
   * overlay color. Default value is true.
   *
  ...
  /**
   * Sets the item clicked listener. OnItemViewClickedListener will override {@link
   ...
   * change visibilities. This method is called by the fragment, it should not be called directly by
   * the application.
   *
  ...
  public void setEntranceTransitionState(
      VerticalGridPresenter.ViewHolder holder, boolean afterEntrance) {
