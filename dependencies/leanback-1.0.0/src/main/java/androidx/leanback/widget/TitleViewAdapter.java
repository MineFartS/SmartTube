...
/**
 * This class allows a customized widget class to implement {@link TitleViewAdapter.Provider} and
 * expose {@link TitleViewAdapter} methods to containing fragment (e.g. BrowseFragment or
 * DetailsFragment). The title view must have a search orb view ({@link #getSearchAffordanceView()}
 * aligned to start and can typically have a branding Drawable and or title text aligned to end. The
 * branding part is fully open to customization: not necessary to be a drawable or text.
 */
public abstract class TitleViewAdapter {

  /**
   * Interface to be implemented by a customized widget class to implement {@link TitleViewAdapter}.
   */
  ...
  /**
   * Based on the flag, it updates the visibility of the individual components - Branding views
   * (badge drawable and/or title) and search affordance view.
   *
