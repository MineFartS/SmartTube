...
/**
 * Abstract presenter class for rendering the header for a list of media items in a playlist. The
 * presenter creates a {@link ViewHolder} for the TextView holding the header text.
 *
 * <p>Subclasses of this class must override {@link #onBindMediaListHeaderViewHolder(ViewHolder,
 * Object)} in order to bind their header text to the media list header view.
 *
 * <p>{@link AbstractMediaItemPresenter} can be used in conjunction with this presenter in order to
...
public abstract class AbstractMediaListHeaderPresenter extends RowPresenter {
  ...
  /**
   * Constructor used for creating an abstract media-list header presenter. The styling for this
   * presenter is extracted from Context of parent in {@link #createRowViewHolder(ViewGroup)}.
   */
  ...
  protected RowPresenter.ViewHolder createRowViewHolder(ViewGroup parent) {
    ...
    View view = LayoutInflater.from(context).inflate(R.layout.lb_media_list_header, parent, false);
  ...
  /**
   * Binds the playlist header data model provided by the user to the {@link ViewHolder} provided by
   * the {@link AbstractMediaListHeaderPresenter}. The subclasses of this presenter can access and
   * bind the text view corresponding to the header by calling {@link ViewHolder#getHeaderView()},
   * on the {@link ViewHolder} provided as the argument {@code vh} by this presenter.
   *
