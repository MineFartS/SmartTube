...
/**
 * An {@link ObjectAdapter} implemented with a {@link android.util.SparseArray}. This class
 * maintains an array of objects where each object is associated with an integer key which
 * determines its order relative to other objects.
 */
