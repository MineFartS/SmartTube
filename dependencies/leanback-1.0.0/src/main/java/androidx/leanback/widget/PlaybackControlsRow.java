 ...
 *
 * <p>This row consists of some optional item detail, a series of primary actions, and an optional
 * series of secondary actions.
 *
 * <p>Controls are specified via an {@link ObjectAdapter} containing one or more {@link Action}s.
 *
 * <p>Adapters should have their {@link PresenterSelector} set to an instance of {@link
...
public class PlaybackControlsRow extends Row {
  ...
  public abstract static class MultiAction extends Action {
    ...
    /**
     * Sets the array of drawables. The size of the array defines the range of valid indices for
     * this action.
     */
    ...
    /**
     * Sets the array of strings used as labels. The size of the array defines the range of valid
     * indices for this action. The labels are used to define the accessibility content description
     * unless secondary labels are provided.
     */
    ...
    /**
     * Sets the array of strings used as secondary labels. These labels are used in place of the
     * primary labels for accessibility content description only.
     */
  ...
  public static class PlayPauseAction extends MultiAction {
     ...
     */
    @Deprecated public static final int PLAY = 0;
     ...
     */
    @Deprecated public static final int PAUSE = 1;
    ...
    public PlayPauseAction(Context context) {
      ...
      drawables[INDEX_PLAY] =
          getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_play);
      drawables[INDEX_PAUSE] =
          getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_pause);
  ...
  public static class FastForwardAction extends MultiAction {
    ...
    public FastForwardAction(Context context, int numSpeeds) {
      ...
      drawables[0] =
          getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_fast_forward);
      setDrawables(drawables);
      ...
      for (int i = 1; i <= numSpeeds; i++) {
        ...
        labels[i] =
            context
                .getResources()
                .getString(R.string.lb_control_display_fast_forward_multiplier, multiplier);
        labels2[i] =
            context
                .getResources()
                .getString(R.string.lb_playback_controls_fast_forward_multiplier, multiplier);
      }
      setLabels(labels);
  ...
  public static class RewindAction extends MultiAction {
    ...
    public RewindAction(Context context, int numSpeeds) {
      ...
      Drawable[] drawables = new Drawable[numSpeeds + 1];
      drawables[0] = getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_rewind);
      setDrawables(drawables);
      ...
      for (int i = 1; i <= numSpeeds; i++) {
        ...
        labels[i] =
            labels[i] =
                context
                    .getResources()
                    .getString(R.string.lb_control_display_rewind_multiplier, multiplier);
        labels2[i] =
            context
                .getResources()
                .getString(R.string.lb_playback_controls_rewind_multiplier, multiplier);
      }
      setLabels(labels);
      setSecondaryLabels(labels2);
  ...
  public static class SkipNextAction extends Action {
    ...
    public SkipNextAction(Context context) {
      ...
      setIcon(getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_skip_next));
  ...
  public static class SkipPreviousAction extends Action {
    ...
    public SkipPreviousAction(Context context) {
      ...
      setIcon(getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_skip_previous));
  ...
  public static class PictureInPictureAction extends Action {
    ...
    public PictureInPictureAction(Context context) {
      ...
      setIcon(
          getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_picture_in_picture));
  ...
  public abstract static class ThumbsAction extends MultiAction {
    /**
     * Action index for the solid thumb icon.
     *
     * @deprecated Use {@link #INDEX_SOLID}
     */
    @Deprecated public static final int SOLID = 0;
     ...
     */
    @Deprecated public static final int OUTLINE = 1;
  ...
  public static class ThumbsUpAction extends ThumbsAction {
    public ThumbsUpAction(Context context) {
      ...
      labels[INDEX_OUTLINE] = context.getString(R.string.lb_playback_controls_thumb_up_outline);
      setLabels(labels);
    }
  }
  ...
  public static class ThumbsDownAction extends ThumbsAction {
    public ThumbsDownAction(Context context) {
      ...
      labels[INDEX_OUTLINE] = context.getString(R.string.lb_playback_controls_thumb_down_outline);
      setLabels(labels);
    }
  }
  ...
  public static class RepeatAction extends MultiAction {
     ...
     */
    @Deprecated public static final int ONE = 2;
    ...
    public RepeatAction(Context context, int repeatAllColor, int repeatOneColor) {
      ...
      BitmapDrawable repeatDrawable =
          (BitmapDrawable)
              getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_repeat);
      BitmapDrawable repeatOneDrawable =
          (BitmapDrawable)
              getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_repeat_one);
      drawables[INDEX_NONE] = repeatDrawable;
      drawables[INDEX_ALL] =
          repeatDrawable == null
              ? null
              : new BitmapDrawable(
                  context.getResources(), createBitmap(repeatDrawable.getBitmap(), repeatAllColor));
      drawables[INDEX_ONE] =
          repeatOneDrawable == null
              ? null
              : new BitmapDrawable(
  ...
  public static class ShuffleAction extends MultiAction {
     ...
     */
    @Deprecated public static final int OFF = 0;
     ...
     */
    @Deprecated public static final int ON = 1;
    ...
    public ShuffleAction(Context context, int highlightColor) {
      ...
      BitmapDrawable uncoloredDrawable =
          (BitmapDrawable)
              getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_shuffle);
      Drawable[] drawables = new Drawable[2];
      drawables[INDEX_OFF] = uncoloredDrawable;
      drawables[INDEX_ON] =
          new BitmapDrawable(
              context.getResources(), createBitmap(uncoloredDrawable.getBitmap(), highlightColor));
      setDrawables(drawables);
  ...
  public static class HighQualityAction extends MultiAction {
    ...
    public HighQualityAction(Context context, int highlightColor) {
      ...
      BitmapDrawable uncoloredDrawable =
          (BitmapDrawable)
              getStyledDrawable(context, R.styleable.lbPlaybackControlsActionIcons_high_quality);
      Drawable[] drawables = new Drawable[2];
      drawables[INDEX_OFF] = uncoloredDrawable;
      drawables[INDEX_ON] =
          new BitmapDrawable(
      ...
      String[] labels = new String[drawables.length];
      labels[INDEX_OFF] = context.getString(R.string.lb_playback_controls_high_quality_enable);
      labels[INDEX_ON] = context.getString(R.string.lb_playback_controls_high_quality_disable);
      setLabels(labels);
    }
  }
  ...
  public static class ClosedCaptioningAction extends MultiAction {
    ...
    public ClosedCaptioningAction(Context context, int highlightColor) {
      ...
      BitmapDrawable uncoloredDrawable =
          (BitmapDrawable)
              getStyledDrawable(
                  context, R.styleable.lbPlaybackControlsActionIcons_closed_captioning);
      Drawable[] drawables = new Drawable[2];
      drawables[INDEX_OFF] = uncoloredDrawable;
      drawables[INDEX_ON] =
          new BitmapDrawable(
  ...
  static int getIconHighlightColor(Context context) {
    ...
    if (context
        .getTheme()
        .resolveAttribute(R.attr.playbackControlsIconHighlightColor, outValue, true)) {
  ...
  static Drawable getStyledDrawable(Context context, int index) {
    ...
    TypedArray array =
        context
            .getTheme()
            .obtainStyledAttributes(outValue.data, R.styleable.lbPlaybackControlsActionIcons);
   ...
   *
   * <p>If set after the row has been bound to a view, the adapter must be notified that this row
   * has changed.
   *
   ...
   *
   * @return The overview's image drawable, or null if no drawable has been assigned.
   */
  ...
  /**
   * Sets the total time in milliseconds (long type) for the playback controls row. If this row is
   * bound to a view, the view will automatically be updated to reflect the new value.
   *
   * @param ms Total time in milliseconds of long type.
   */
  ...
  /**
   * Sets the current time in milliseconds for the playback controls row. If this row is bound to a
   * view, the view will automatically be updated to reflect the new value.
   *
  ...
  /**
   * Sets the buffered progress for the playback controls row. If this row is bound to a view, the
   * view will automatically be updated to reflect the new value.
   *
