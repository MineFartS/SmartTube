...
public class TitleView extends FrameLayout implements TitleViewAdapter.Provider {
  ...
  /**
   * Based on the flag, it updates the visibility of the individual components - BadgeView, TextView
   * and SearchView.
   *
  ...
  private void updateSearchOrbViewVisiblity() {
    int visibility =
        mHasSearchListener && (flags & SEARCH_VIEW_VISIBLE) == SEARCH_VIEW_VISIBLE
            ? View.VISIBLE
            : View.INVISIBLE;
