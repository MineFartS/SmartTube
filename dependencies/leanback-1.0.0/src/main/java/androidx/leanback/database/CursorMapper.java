...
public abstract class CursorMapper {
  ...
  /**
   * Called once when the associated {@link Cursor} is changed. A subclass should bind column
   * indexes to column names in this method. This method is not intended to be called outside of
   * CursorMapper.
   */
   ...
   * This method is not intended to be called outside of CursorMapper.
   */
