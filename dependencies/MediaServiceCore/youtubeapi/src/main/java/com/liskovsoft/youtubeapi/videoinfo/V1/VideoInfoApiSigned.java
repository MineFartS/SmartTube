 ...
 * Unlock Gemini Man 4K:
 * https://www.youtube.com/get_video_info?ps=leanback&el=leanback&eurl=https%3A%2F%2Fwww.youtube.com%2Ftv
 * <br>
 * Unlock age restricted videos:
 * https://www.youtube.com/get_video_info?ps=default&eurl=https%3A%2F%2Fwww.youtube.com%2Ftv
 */
@WithQueryString
public interface VideoInfoApiSigned {
  ...
  Call<VideoInfo> getVideoInfo(
      ...
      @Query("cver") String clientVersion);
  ...
  @GET(AppConstants.GET_VIDEO_INFO_OLD)
  Call<VideoInfo> getVideoInfoHls(
      @Query("video_id") String videoId,
      @Query("access_token") String token,
      @Query("hl") String lang,
      @Query("cver") String clientVersion);
  ...
  Call<VideoInfo> getVideoInfoRestricted(
      @Query("video_id") String videoId,
      @Query("access_token") String token,
      @Query("hl") String lang,
      @Query("cver") String clientVersion);
  ...
  @GET(AppConstants.GET_VIDEO_INFO_OLD)
  Call<VideoInfo> getVideoInfoRegular(
      @Query("video_id") String videoId,
      @Query("access_token") String token,
      @Query("hl") String lang,
      @Query("cver") String clientVersion);
