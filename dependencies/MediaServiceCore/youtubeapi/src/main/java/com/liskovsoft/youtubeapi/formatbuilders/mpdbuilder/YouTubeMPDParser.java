...
public class YouTubeMPDParser implements MPDParser {
   ...
   */
  private List<MediaFormat> readMediaGroup(XmlPullParser parser)
   ...
   * @return item
   */
  private MediaFormat readSpecialMediaItem(XmlPullParser parser, String mimeType)
      throws IOException, XmlPullParserException {
  ...
  private void readSegmentsTimeline(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
  ...
  private void readSTag(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
    ...
    if (dAttr != null) segments.add(dAttr);

    parser.next();
    parser.require(XmlPullParser.END_TAG, ns, TAG_S);
  }

  private MediaFormat readMediaItem(XmlPullParser parser, String mimeType)
      throws IOException, XmlPullParserException {
    ...
    item.setMimeType(
        String.format("%s;+codecs=\"%s\"", mimeType, parser.getAttributeValue(ns, "codecs")));
  ...
  private void readSegmentList(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
    parser.require(XmlPullParser.START_TAG, ns, TAG_SEGMENT_LIST);
    while (parser.next() != XmlPullParser.END_TAG) {
      if (parser.getEventType() != XmlPullParser.START_TAG) {
  ...
  private void readSegmentURL(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
    ...
    if (media != null) urls.add(media);

    parser.next();
    parser.require(XmlPullParser.END_TAG, ns, TAG_SEGMENT_URL);
  }

  private void readSegmentBase(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
  ...
  private void readInitialization(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
  ...
  private void readUrl(XmlPullParser parser, YouTubeMediaFormat item)
      throws IOException, XmlPullParserException {
