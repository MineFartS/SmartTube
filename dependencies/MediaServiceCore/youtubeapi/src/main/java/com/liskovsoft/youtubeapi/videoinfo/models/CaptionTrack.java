...
public class CaptionTrack {
  ...
  /**
   * Example:
   * "https://www.youtube.com/api/timedtext?caps=&key=yt…&sparams=caps%2Cv%2Cxorp%2Cexpire&lang=en&name=en"
   */
  @JsonPath("$.baseUrl")
  ...
  public String getName() {
    ...
    return isAutogenerated() && name != null
        ? name + TranslatedCaptionTrack.TRANSLATE_MARKER
        : name;
  }
