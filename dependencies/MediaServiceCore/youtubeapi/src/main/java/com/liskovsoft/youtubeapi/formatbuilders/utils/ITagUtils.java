...
public final class ITagUtils {
  ...
  private static final List<String> sOrderedITagsAVC =
      Arrays.asList(
          ...
          VIDEO_480P_AVC,
          VIDEO_720P_AVC,
          VIDEO_720P_AVC_60FPS,
          VIDEO_1080P_AVC,
          VIDEO_1080P_AVC_60FPS,
          VIDEO_1440P_AVC,
          VIDEO_2160P_AVC,
          VIDEO_2160P_AVC_HQ);
  ...
  private static final List<String> sOrderedITagsWEBM =
      Arrays.asList(
          ...
          VIDEO_480P_WEBM,
          VIDEO_720P_WEBM,
          VIDEO_720P_WEBM_60FPS_HDR,
          VIDEO_1080P_WEBM,
          VIDEO_1080P_WEBM_60FPS_HDR,
          VIDEO_1440P_WEBM,
          VIDEO_1440P_WEBM_60FPS_HDR,
          VIDEO_1440P_WEBM_60FPS,
          VIDEO_2160P_WEBM,
          VIDEO_2160P_WEBM_60FPS_HDR,
          VIDEO_2160P_WEBM_60FPS);

  private static final List<List<String>> sITagsContainer =
      Arrays.asList(sOrderedITagsAVC, sOrderedITagsWEBM);
