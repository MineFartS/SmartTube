...
public class ItemWrapper {
  ...
  public boolean isLive() {
    return mVideoItem != null
        ? mVideoItem.isLive()
        : mTileItem != null ? mTileItem.isLive() : false;
  }

  public boolean isUpcoming() {
    return mVideoItem != null
        ? mVideoItem.isUpcoming()
        : mTileItem != null ? mTileItem.isUpcoming() : false;
  }

  public boolean isMovie() {
    return mVideoItem != null
        ? mVideoItem.isMovie()
        : mTileItem != null ? mTileItem.isMovie() : false;
  }
}
