...
public class VideoInfoApiHelper {
  public static String getVideoInfoQuery(
  ...
  // */
  // private static String getVideoInfoQueryGeo(AppClient client, String videoId, String
  // clickTrackingParams) {
  ...
  private static String createCheckedQuery(
      AppClient client, String videoId, String clickTrackingParams, boolean enableGeoFix) {
