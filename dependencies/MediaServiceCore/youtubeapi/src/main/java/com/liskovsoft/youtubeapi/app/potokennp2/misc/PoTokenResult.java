...
/**
 * The result of a supported/successful {@code poToken} extraction request by a {@link
 * PoTokenProvider}.
 */
public final class PoTokenResult {
  ...
  @Nonnull public final String visitorData;

  /** The {@code poToken} of a player request, a Protobuf object encoded as a base 64 string. */
  @Nonnull public final String playerRequestPoToken;

  /**
   * The {@code poToken} to be appended to streaming URLs, a Protobuf object encoded as a base 64
   * string.
   *
   * <p>It may be required on some clients such as HTML5 ones and may also differ from the player
   * request {@code poToken}.
   */
  @Nullable public final String streamingDataPoToken;
