...
public class AuthService {
  ...
  public UserCode getUserCode() {
    Call<UserCode> wrapper =
        mAuthApi.getUserCode(mAppService.getClientId(), AuthApiHelper.getAppScope());
  ...
  public AccessToken getAccessTokenRaw(String rawAuthData) {
    Call<AccessToken> wrapper =
        mAuthApi.updateAccessToken(RequestBody.create(null, rawAuthData.getBytes()));
    return RetrofitHelper.get(wrapper);
  }
  ...
  public List<AccountInt> getAccounts(String authorization) {
    Call<AccountsList> wrapper =
        mAuthApi.getAccountsList(AuthApiHelper.getAccountsListQuery(), authorization);
