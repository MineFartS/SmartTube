...
public final class RandomStringFromAlphabetGenerator {
   ...
   * @param random {@link Random} (or better {@link java.security.SecureRandom}) used for generating
   *     the random string
   * @return a random string of the requested length made of only characters from the provided
   *     alphabet
   */
  @Nonnull
  public static String generate(final String alphabet, final int length, final Random random) {
