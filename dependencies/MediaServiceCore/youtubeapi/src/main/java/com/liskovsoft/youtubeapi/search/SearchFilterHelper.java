...
final class SearchFilterHelper {
  ...
  private static void init() {
    ...
    sParams[UPLOAD_DATE_LAST_HOUR][DURATION_ANY][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQIARAB";
    sParams[UPLOAD_DATE_TODAY][DURATION_ANY][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] = "EgQIAhAB";
    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_ANY][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQIAxAB";
    sParams[UPLOAD_DATE_THIS_MONTH][DURATION_ANY][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQIBBAB";
    sParams[UPLOAD_DATE_THIS_YEAR][DURATION_ANY][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQIBRAB";

    sParams[UPLOAD_DATE_ALL][DURATION_UNDER_4][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQQARgB";
    sParams[UPLOAD_DATE_ALL][DURATION_BETWEEN_4_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQQARgD";
    sParams[UPLOAD_DATE_ALL][DURATION_OVER_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgQQARgC";

    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_VIDEO][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgIQAQ%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_CHANNEL][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgIQAg%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_PLAYLIST][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgIQAw%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_MOVIE][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgIQBA%3D%3D";

    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_LIVE][SORT_BY_RELEVANCE] =
        "EgJAAQ%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_4K][SORT_BY_RELEVANCE] =
        "EgJwAQ%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_HDR][SORT_BY_RELEVANCE] = "EgPIAQE%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_LIVE_4K][SORT_BY_RELEVANCE] =
        "EgRAAXAB";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_4K_HDR][SORT_BY_RELEVANCE] =
        "EgVwAcgBAQ%3D%3D";
    sParams[UPLOAD_DATE_ALL][DURATION_ANY][TYPE_ANY][FEATURE_LIVE_4K_HDR][SORT_BY_RELEVANCE] =
        "EgdAAXAByAEB";
    ...
    sParams[UPLOAD_DATE_TODAY][DURATION_UNDER_4][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIAhABGAE%3D";
    sParams[UPLOAD_DATE_TODAY][DURATION_BETWEEN_4_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIAhABGAM%3D";
    sParams[UPLOAD_DATE_TODAY][DURATION_OVER_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIAhABGAI%3D";

    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_UNDER_4][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIAxABGAE%3D";
    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_BETWEEN_4_20][TYPE_ANY][FEATURE_ANY][
            SORT_BY_RELEVANCE] =
        "EgYIAxABGAM%3D";
    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_OVER_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIAxABGAI%3D";

    sParams[UPLOAD_DATE_THIS_MONTH][DURATION_UNDER_4][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIBBABGAE%3D";
    sParams[UPLOAD_DATE_THIS_MONTH][DURATION_BETWEEN_4_20][TYPE_ANY][FEATURE_ANY][
            SORT_BY_RELEVANCE] =
        "EgYIBBABGAM%3D";
    sParams[UPLOAD_DATE_THIS_MONTH][DURATION_OVER_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RELEVANCE] =
        "EgYIBBABGAI%3D";

    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_UNDER_4][TYPE_ANY][FEATURE_ANY][SORT_BY_UPLOAD_DATE] =
        "CAISBBABGAI%3D";
    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_BETWEEN_4_20][TYPE_ANY][FEATURE_ANY][
            SORT_BY_VIEW_COUNT] =
        "CAMSBBABGAI%3D";
    sParams[UPLOAD_DATE_THIS_WEEK][DURATION_OVER_20][TYPE_ANY][FEATURE_ANY][SORT_BY_RATING] =
        "CAESBBABGAI%3D";
  }
  ...
  public static String toParams(int options) {
    ...
    return sParams[getUploadDateIndex(options)][getDurationIndex(options)][getTypeIndex(options)][
        getFeaturesIndex(options)][getSortByIndex(options)];
  }
  ...
  private static int getFeaturesIndex(int options) {
    ...
    if (Helpers.check(
        options,
        SearchOptions.FEATURE_LIVE | SearchOptions.FEATURE_4K | SearchOptions.FEATURE_HDR)) {
