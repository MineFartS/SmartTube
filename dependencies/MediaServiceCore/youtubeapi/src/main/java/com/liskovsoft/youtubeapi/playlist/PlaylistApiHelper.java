...
public class PlaylistApiHelper {
  ...
  private static final String ADD_TO_PLAYLISTS_QUERY =
      "\"playlistId\":\"%s\","
          + "\"actions\":[{\"addedVideoId\":\"%s\",\"action\":\"ACTION_ADD_VIDEO\"}]";
  private static final String PLAYLIST_ORDER_QUERY =
      "\"playlistId\":\"%s\","
          + "\"actions\":[{\"playlistVideoOrder\":\"%s\",\"action\":\"ACTION_SET_PLAYLIST_VIDEO_ORDER\"}]";
  private static final String REMOVE_FROM_PLAYLISTS_QUERY =
      "\"playlistId\":\"%s\","
          + "\"actions\":[{\"removedVideoId\":\"%s\",\"action\":\"ACTION_REMOVE_VIDEO_BY_VIDEO_ID\"}]";
  private static final String RENAME_PLAYLISTS_QUERY =
      "\"playlistId\":\"%s\","
  ...
  private static final String CREATE_PLAYLIST_AND_ADD_QUERY =
      "\"title\":\"%s\",\"videoIds\":[\"%s\"]";
  ...
  public static String getCreatePlaylistQuery(String playlistName, String videoId) {
    String queryTemplate =
        videoId == null
            ? String.format(CREATE_PLAYLIST_QUERY, playlistName)
            : String.format(CREATE_PLAYLIST_AND_ADD_QUERY, playlistName, videoId);
