...
public class AuthService {
  ...
  public UserCode getUserCode() {
    Call<UserCode> wrapper =
        mAuthApi.getUserCode(AuthApiHelper.getUserCodeQuery(mAppService.getClientId()));
  ...
  public AccessToken updateAccessToken(String refreshToken) {
    Call<AccessToken> wrapper =
        mAuthApi.updateAccessToken(
            AuthApiHelper.getAccessTokenQuery(
                refreshToken, mAppService.getClientId(), mAppService.getClientSecret()));
