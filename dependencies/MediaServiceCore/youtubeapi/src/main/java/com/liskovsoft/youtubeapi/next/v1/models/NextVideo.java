...
public class NextVideo {
  ...
  @JsonPath({
    "$.item.previewButtonRenderer.title.simpleText",
    "$.item.previewButtonRenderer.title.runs[0].text"
  })
  ...
  @JsonPath({
    "$.item.previewButtonRenderer.byline.simpleText",
    "$.item.previewButtonRenderer.byline.runs[0].text"
  })
