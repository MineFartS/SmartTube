...
public class YouTubeServiceManager implements ServiceManager {
  ...
  public void invalidateCache() {
    ...
    getYouTubeSignInService()
        .invalidateCache(); // sections infinite loading fix (request timed out fix)
  ...
  private void refreshCacheIfNeededInt() {
    ...
    mRefreshCoreDataAction =
        RxHelper.execute(RxHelper.fromRunnable(getAppService()::refreshCacheIfNeeded));
  }
