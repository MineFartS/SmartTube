...
public class BindParams {
  // public static final String DEVICE_ID = "2a026ce9-4429-4c5e-8ef5-0101eddf5671"; // Should be
  // random UUID
  ...
  private static final String BASE_BIND_URL =
  ...
  public static String createBindRpcUrl(
      String screenName, String deviceId, String loungeToken, String sessionId, String gSessionId) {
    return String.format(
        "%s&name=%s&id=%s&loungeIdToken=%s&SID=%s&gsessionid=%s",
        BIND_RPC_URL, screenName, deviceId, loungeToken, sessionId, gSessionId);
  }
}
