...
public class OAuth2AccountManager extends OAuth2AccountManagerBase {
  ...
  //        try {
  //            AccessToken token =
  // mOAuth2Service.getAccessTokenWait(userCodeResult.getDeviceCode());
  //
  ...
  private void persistRefreshToken(String refreshToken) {
    ...
    //
    // List<AccountInt> accountsInt = mOAuth2Service.getAccounts(); // runs under auth header from
    // above
    //
    // if (accountsInt != null) {
