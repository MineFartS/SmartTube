...
public class VideoOwner {
  ...
  @JsonPath({
    ...
    "$.subscribed",
    "$.subscribeButton.subscribeButtonRenderer.subscribed"
  })
  ...
  @JsonPath({
    ...
    "$.subscribeButton.subscribeButtonRenderer.subscriberCountText.runs[0].text"
  })
  private String mSubscriberCount;

  @JsonPath({
    "$.longSubscriberCountText.runs[0].text",
    "$.subscribeButton.subscribeButtonRenderer.longSubscriberCountText.runs[0].text"
  })
  private String mSubscriberCountLong;

  @JsonPath({
    "$.shortSubscriberCountText.runs[0].text",
    "$.subscribeButton.subscribeButtonRenderer.shortSubscriberCountText.runs[0].text"
  })
