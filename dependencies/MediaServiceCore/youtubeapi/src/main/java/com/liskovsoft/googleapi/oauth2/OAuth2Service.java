...
public class OAuth2Service {
  ...
  public UserCode getUserCode() {
    Call<UserCode> wrapper =
        mOAuth2Api.getUserCode(OAuth2ApiHelper.CLIENT_ID, OAuth2ApiHelper.DRIVE_SCOPE);
  ...
  private AccessToken getAccessToken(String deviceCode) {
    Call<AccessToken> wrapper =
        mOAuth2Api.getAccessToken(
            OAuth2ApiHelper.CLIENT_ID,
            OAuth2ApiHelper.CLIENT_SECRET,
            deviceCode,
            OAuth2ApiHelper.GRANT_TYPE);
    return RetrofitHelper.get(wrapper);
  }
  ...
  public AccessToken updateAccessToken(String refreshToken) {
    Call<AccessToken> wrapper =
        mOAuth2Api.updateAccessToken(
            OAuth2ApiHelper.CLIENT_ID,
            OAuth2ApiHelper.CLIENT_SECRET,
            OAuth2ApiHelper.GRANT_TYPE_REFRESH,
            refreshToken);
  ...
  //    Call<AccountsList> wrapper =
  // mOAuth2Api.getAccountsList(OAuth2ApiHelper.getAccountsListQuery());
  //
