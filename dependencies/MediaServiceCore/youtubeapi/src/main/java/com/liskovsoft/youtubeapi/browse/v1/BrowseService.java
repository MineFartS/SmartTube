...
public class BrowseService {
  ...
  public List<GridTab> getSubscribedChannelsUpdate() {
    ...
    Collections.sort(
        subscribedChannelsByName,
        (o1, o2) ->
            o1.hasNewContent() && !o2.hasNewContent()
                ? -1
                : !o1.hasNewContent() && o2.hasNewContent() ? 1 : 0);
  ...
  private synchronized List<GridTab> getGridTabs(String query) {
  ...
  public SectionContinuation continueSection(String nextKey) {
    ...
    Call<SectionContinuation> wrapper =
        mBrowseManagerSigned.continueSection(query, mAppService.getVisitorData());
  ...
  public SectionTabContinuation continueSectionTab(String nextKey) {
    ...
    Call<SectionTabContinuation> wrapper =
        mBrowseManagerSigned.continueSectionTab(query, mAppService.getVisitorData());
  ...
  private SectionTabList getSectionTabList(String query) {
    ...
    Call<SectionTabList> wrapper =
        mBrowseManagerSigned.getSectionTabList(query, mAppService.getVisitorData());
  ...
  private SectionList getSectionList(String query) {
    Call<SectionList> wrapper =
        mBrowseManagerSigned.getSectionList(query, mAppService.getVisitorData());
