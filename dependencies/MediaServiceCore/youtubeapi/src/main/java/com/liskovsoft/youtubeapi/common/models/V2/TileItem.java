...
public class TileItem {
  ...
  @JsonPath({
    "$.menu.menuRenderer.items[*].menuServiceItemRenderer.serviceEndpoint.feedbackEndpoint.feedbackToken",
  ...
  public String getDescBadgeText() {
    return mMetadata != null && mMetadata.getBadgeLabels() != null
        ? mMetadata.getBadgeLabels().get(0)
        : null;
  }
  ...
  public boolean isShorts() {
    return Helpers.equalsAny(BADGE_STYLE_SHORTS, getBadgeStyles())
        || TILE_STYLE_SHORTS.equals(mStyle);
  }
