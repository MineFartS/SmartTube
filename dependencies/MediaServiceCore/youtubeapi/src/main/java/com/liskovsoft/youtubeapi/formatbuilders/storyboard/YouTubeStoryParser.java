...
public class YouTubeStoryParser {
  ...
  /**
   * Extracts storyboard (timeline thumbnails) from the <em>get_video_info</em> file <br>
   *
   * @param spec specification e.g. <code>
   *     https:\/\/i.ytimg.com\/sb\/Pk2oW4SDDxY\/storyboard3_L$L\/$N.jpg|48#27#100#10#10#0#default#vpw4l5h3xmm2AkCT6nMZbvFIyJw|80#45#90#10#10#2000#M$M#hCWDvBSbgeV52mPYmOHjgdLFI1o|160#90#90#5#5#2000#M$M#ys1MKEnwYXA1QAcFiugAA_cZ81Q
   *     </code>
   */
  ...
  private Storyboard parseStoryboardSpec(String spec) {
    ...
    // https:\/\/i.ytimg.com\/sb\/Pk2oW4SDDxY\/storyboard3_L$L\/$N.jpg|48#27#100#10#10#0#default#vpw4l5h3xmm2AkCT6nMZbvFIyJw|80#45#90#10#10#2000#M$M#hCWDvBSbgeV52mPYmOHjgdLFI1o|160#90#90#5#5#2000#M$M#ys1MKEnwYXA1QAcFiugAA_cZ81Q
    // Live EX:
    // https://i.ytimg.com/sb/CFsd4UxzpLo/storyboard_live_90_3x3_b1/M$M.jpg?rs=AOn4CLAa9egpicnNt15TtgKW270vNRy5Bw#159#90#3#3
  ...
  public class Storyboard {
    ...
    public String getGroupUrl(int imgNum) {
      ...
      // EX:
      // https://i.ytimg.com/sb/k4YRWT_Aldo/storyboard3_L2/M0.jpg?sigh=RVdv4fMsE-eDcsCUzIy-iCQNteI
    ...
    private int chooseBestSizeIdx() {
      ...
      for (Size size : mSizes) {
        if (widest < size.mWidth
            || (widest == size.mWidth && mSizes.get(widestIdx).mColsCount < size.mColsCount)) {
