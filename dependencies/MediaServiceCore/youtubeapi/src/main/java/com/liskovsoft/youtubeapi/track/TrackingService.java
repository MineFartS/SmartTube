...
public class TrackingService {
  ...
  private void updateWatchTimeFull(
      String videoId,
      float lengthSec,
      float oldPositionSec,
      float positionSec,
    ...
    //    createWatchRecordShort(videoId, clientPlaybackNonce, eventId, visitorMonitoringData,
    // ofParam);
    //    updateWatchTimeShort(videoId, lengthSec, lengthSec, lengthSec, clientPlaybackNonce,
    // eventId, visitorMonitoringData, ofParam);
    //    return;
    // }
  ...
  private void createWatchRecordLong(
      String videoId,
      float lengthSec,
      float watchStartSec,
      String clientPlaybackNonce,
    ...
    Log.d(
        TAG,
        "Creating watch record long... Video Id: %s, length: %s, start position: %s",
        videoId,
        lengthSec,
        watchStartSec);

    Call<WatchTimeEmptyResult> wrapper =
        mTrackingApi.createWatchRecord(
            videoId,
            lengthSec,
            watchStartSec,
            clientPlaybackNonce,
  ...
  private void updateWatchTimeLong(
      String videoId,
      float lengthSec,
      float oldPositionSec,
      float positionSec,
    ...
    Log.d(
        TAG,
        "Updating watch time long... Video Id: %s, length: %s, position: %s",
        videoId,
        lengthSec,
        positionSec);

    Call<WatchTimeEmptyResult> wrapper =
        mTrackingApi.updateWatchTime(
            videoId,
            lengthSec,
            oldPositionSec,
            positionSec,
  ...
  private void createWatchRecordShort(
      String videoId,
      String clientPlaybackNonce,
      String eventId,
      String visitorMonitoringData,
    ...
    Call<WatchTimeEmptyResult> wrapper =
        mTrackingApi.createWatchRecordShort(
            videoId, clientPlaybackNonce, eventId, visitorMonitoringData, ofParam);

    RetrofitHelper.get(wrapper); // execute
  }

  private void updateWatchTimeShort(
      String videoId,
      float lengthSec,
      float oldPositionSec,
      float positionSec,
    ...
    Log.d(
        TAG,
        "Updating watch time short... Video Id: %s, length: %s, position: %s",
        videoId,
        lengthSec,
        positionSec);

    Call<WatchTimeEmptyResult> wrapper =
        mTrackingApi.updateWatchTimeShort(
            videoId,
            oldPositionSec,
            positionSec,
            clientPlaybackNonce,
