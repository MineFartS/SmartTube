...
public class GridTab {
  ...
  @JsonPath({
    "$.content.tvSurfaceContentRenderer.content.gridRenderer.items[*]",
    "$.contents[0].itemSectionRenderer.contents[*]" // web history section format (with ability to
                                                    // remove any item)
  })
  ...
  @JsonPath({
    ...
    "$.continuations[0].nextContinuationData.continuation" // web history section format (with
    // ability to remove any item)
  })
