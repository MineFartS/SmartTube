...
public class GoogleAccount implements Account {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof GoogleAccount) {
      ...
      boolean emailEquals =
          email == null || getEmail() == null || Helpers.equals(email, getEmail());
      boolean channelEquals =
          channel == null || getChannelName() == null || Helpers.equals(channel, getChannelName());
  ...
  public void merge(Account account) {
    ...
    if (Helpers.equals(getPageIdToken(), youTubeAccount.getPageIdToken())
        && Helpers.equals(getRefreshToken2(), youTubeAccount.getRefreshToken2())) {
      return;
    }

    if (getPageIdToken() != null) {
      mRefreshToken2 =
          Helpers.firstNonNull(youTubeAccount.getRefreshToken2(), youTubeAccount.getRefreshToken());
