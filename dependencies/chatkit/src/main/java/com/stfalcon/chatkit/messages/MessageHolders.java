...
public class MessageHolders {
  ...
  public MessageHolders() {
    ...
    this.incomingTextConfig =
        new HolderConfig<>(
            DefaultIncomingTextMessageViewHolder.class, R.layout.item_incoming_text_message);
    this.outcomingTextConfig =
        new HolderConfig<>(
            DefaultOutcomingTextMessageViewHolder.class, R.layout.item_outcoming_text_message);
    this.incomingImageConfig =
        new HolderConfig<>(
            DefaultIncomingImageMessageViewHolder.class, R.layout.item_incoming_image_message);
    this.outcomingImageConfig =
        new HolderConfig<>(
            DefaultOutcomingImageMessageViewHolder.class, R.layout.item_outcoming_image_message);
  }
   ...
   */
  public MessageHolders setIncomingTextHolder(
      @NonNull Class<? extends BaseMessageViewHolder<? extends IMessage>> holder, Object payload) {
    this.incomingTextConfig.holder = holder;
    this.incomingTextConfig.payload = payload;
    return this;
  }
  ...
  public MessageHolders setDateHeaderConfig(
      @NonNull Class<? extends ViewHolder<Date>> holder, @LayoutRes int layout) {
   ...
   * @return {@link MessageHolders} for subsequent configuration.
   */
  public <TYPE extends MessageContentType> MessageHolders registerContentType(
      byte type,
    ...
    return registerContentType(
        type, holder, incomingLayout, holder, outcomingLayout, contentChecker);
  }
  ...
  public <TYPE extends MessageContentType> MessageHolders registerContentType(
      byte type,
      @NonNull Class<? extends MessageHolders.BaseMessageViewHolder<TYPE>> incomingHolder,
      Object incomingPayload,
      @LayoutRes int incomingLayout,
      @NonNull Class<? extends MessageHolders.BaseMessageViewHolder<TYPE>> outcomingHolder,
    ...
    customContentTypes.add(
        new MessageHolders.ContentTypeConfig<>(
            type,
  ...
  protected ViewHolder getHolder(
      ViewGroup parent, int viewType, MessagesListStyle messagesListStyle) {
    switch (viewType) {
      ...
      default:
        for (ContentTypeConfig typeConfig : customContentTypes) {
          if (Math.abs(typeConfig.type) == Math.abs(viewType)) {
            ...
            else return getHolder(parent, typeConfig.outcomingConfig, messagesListStyle);
          }
        }
    }
    throw new IllegalStateException(
        "Wrong message view type. Please, report this issue on GitHub with full stacktrace in"
            + " description.");
  }
      ...
      for (int i = 0; i < clickListenersArray.size(); i++) {
        ...
        if (view != null) {
          view.setOnClickListener(
              v -> clickListenersArray.get(key).onMessageViewClick(view, (IMessage) item));
        }
      }
  ...
  private ViewHolder getHolder(
      ViewGroup parent, HolderConfig holderConfig, MessagesListStyle style) {
    return getHolder(parent, holderConfig.layout, holderConfig.holder, style, holderConfig.payload);
  }

  private <HOLDER extends ViewHolder> ViewHolder getHolder(
      ViewGroup parent,
      @LayoutRes int layout,
    ...
    try {
      ...
      throw new UnsupportedOperationException(
          "Somehow we couldn't create the ViewHolder for message. Please, report this issue on"
              + " GitHub with full stacktrace in description.",
          e);
    }
  }
  ...
  /**
   * The base class for view holders for incoming and outcoming message. You can extend it to create
   * your own holder in conjuction with custom layout or even using default layout.
   */
  ...
  public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
    ...
    public void applyStyle(MessagesListStyle style) {
      ...
      if (bubble != null) {
        bubble.setPadding(
            style.getIncomingDefaultBubblePaddingLeft(),
  ...
  public static class OutcomingTextMessageViewHolder<MESSAGE extends IMessage>
    ...
    public final void applyStyle(MessagesListStyle style) {
      ...
      if (bubble != null) {
        bubble.setPadding(
            style.getOutcomingDefaultBubblePaddingLeft(),
  ...
  public static class IncomingImageMessageViewHolder<MESSAGE extends MessageContentType.Image>
    ...
    /**
     * Override this method to have ability to pass custom data in ImageLoader for loading image(not
     * avatar).
     *
  ...
  private static class HolderConfig<T extends IMessage> {
    ...
    HolderConfig(
        Class<? extends BaseMessageViewHolder<? extends T>> holder, int layout, Object payload) {
      this.holder = holder;
      this.layout = layout;
      this.payload = payload;
    }
