...
public class MessagesListAdapter<MESSAGE extends IMessage>
   ...
   *
   * @param senderId identifier of sender.
   * @param holders custom layouts and view holders. See {@link MessageHolders} documentation for
   *     details
   * @param imageLoader image loading method.
   */
  ...
  public void addToStart(MESSAGE message, boolean scroll) {
    ...
    boolean isNewMessageToday =
        isDateHeaderEnabled && !isPreviousSameDate(0, message.getCreatedAt());
   ...
   *
   * @param selectionListener listener for selected items count. To get selected messages use {@link
   *     #getSelectedMessages()}.
   */
  public void enableSelectionMode(SelectionListener selectionListener) {
    if (selectionListener == null) {
      throw new IllegalArgumentException(
          "SelectionListener must not be null. Use `disableSelectionMode()` if you want tp disable"
              + " selection mode");
    } else {
   ...
   * @return formatted text by {@link Formatter}. If it's {@code null} - {@code MESSAGE#toString()}
   *     will be used.
   */
  ...
  /**
   * Copies text to device clipboard and returns selected messages text. Also it does {@link
   ...
   *     will be used.
   */
  public String copySelectedMessagesText(
      Context context, Formatter<MESSAGE> formatter, boolean reverse) {
    String copiedText = getSelectedText(formatter, reverse);
  ...
  /**
   * Deletes all of the selected messages and disables selection mode. Call {@link
   * #getSelectedMessages()} before calling this method to delete messages from your data source.
   */
   ...
   */
  public void setOnMessageViewClickListener(
      OnMessageViewClickListener<MESSAGE> onMessageViewClickListener) {
   ...
   * @param onMessageViewClickListener click listener.
   */
  public void registerViewClickListener(
      int viewId, OnMessageViewClickListener<MESSAGE> onMessageViewClickListener) {
   ...
   */
  public void setOnMessageViewLongClickListener(
      OnMessageViewLongClickListener<MESSAGE> onMessageViewLongClickListener) {
    this.onMessageViewLongClickListener = onMessageViewLongClickListener;
  }

  public void setOnMessageViewFocusListener(
      OnMessageViewFocusListener<MESSAGE> onMessageViewFocusListener) {
  ...
  private View.OnFocusChangeListener getMessageFocusChangeListener(final Wrapper<MESSAGE> wrapper) {
    return (v, hasFocus) -> {
      ...
      // bubble.setBackgroundResource(hasFocus ? R.drawable.shape_incoming_message_focused :
      ...
      if (hasFocus) {
        ...
        bubble.setBackground(
            new LayerDrawable(new Drawable[] {originalBackground, shapeBackground}));
      } else {
        // Revert to original
        Drawable originalBackground = messagesListStyle.getIncomingBubbleDrawable();
  ...
  public static class HoldersConfig extends MessageHolders {
    ...
    /**
     * This method is deprecated. Use {@link MessageHolders#setIncomingTextConfig(Class, int)}
     * instead.
     *
    ...
    public void setIncoming(
        Class<? extends BaseMessageViewHolder<? extends IMessage>> holder, @LayoutRes int layout) {
    ...
    /**
     * This method is deprecated. Use {@link MessageHolders#setOutcomingTextConfig(Class, int)}
     * instead.
     *
     * @param holder holder class.
     * @param layout layout resource.
    ...
    /**
     * This method is deprecated. Use {@link MessageHolders#setDateHeaderConfig(Class, int)}
     * instead.
     *
     * @param holder holder class.
     * @param layout layout resource.
