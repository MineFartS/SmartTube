...
public class MessagesList extends RecyclerView {
  ...
  /**
   * Don't use this method for setting your adapter, otherwise exception will by thrown. Call {@link
   * #setAdapter(MessagesListAdapter)} instead.
   */
  @Override
   ...
   * @param <MESSAGE> Message model class
   */
  public <MESSAGE extends IMessage> void setAdapter(
      MessagesListAdapter<MESSAGE> adapter, boolean reverseLayout) {
    SimpleItemAnimator itemAnimator = new DefaultItemAnimator();
    itemAnimator.setSupportsChangeAnimations(false);

    LinearLayoutManager layoutManager =
        new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, reverseLayout);
