...
/**
 * Thanks to Joonho Kim (https://github.com/pungrue26) for his lightweight
 * SelectableRoundedImageView, that was used as default image message representation
 */
public class RoundedImageView extends AppCompatImageView {
  ...
  public void setCorners(
      @DimenRes int leftTop,
      @DimenRes int rightTop,
      @DimenRes int rightBottom,
      @DimenRes int leftBottom) {
    setCorners(
