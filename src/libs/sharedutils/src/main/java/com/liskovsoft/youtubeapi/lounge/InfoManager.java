...
import com.liskovsoft.sharedutils.lounge.models.info.PlaylistInfo;
...
public interface InfoManager {
    ...
    Call<TokenInfoList> getTokenInfo(
        @Field("screen_ids") String... screenIds
    );
    ...
    Call<PairingCodeV2> getPairingCodeV2(
