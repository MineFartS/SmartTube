...
import static minefarts.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_NONE;
import static minefarts.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
import static minefarts.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_SURFACELESS_CONTEXT;
...
import minefarts.exoplayer2.util.EGLSurfaceTexture;
import minefarts.exoplayer2.util.EGLSurfaceTexture.SecureMode;
