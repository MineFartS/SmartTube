...
/**
 * Defines and provides media to be played by an {@link minefarts.exoplayer2.ExoPlayer}. A
 ...
 * minefarts.exoplayer2.ExoPlayer} Javadoc. They should not be called directly from
 * application code. Instances can be re-used, but only for one {@link
 * minefarts.exoplayer2.ExoPlayer} instance simultaneously.
 */
