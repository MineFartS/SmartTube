...
import minefarts.exoplayer2.source.ConcatenatingMediaSource.MediaSourceHolder;
import minefarts.exoplayer2.source.ShuffleOrder.DefaultShuffleOrder;
        ...
        switch (msg.what) {
            ...
            case MSG_REMOVE:
                MessageData<Integer> removeMessage =
                        (MessageData<Integer>) Util.castNonNull(msg.obj);
            ...
            case MSG_ON_COMPLETION:
                Set<HandlerAndRunnable> actions =
                        (Set<HandlerAndRunnable>) Util.castNonNull(msg.obj);
