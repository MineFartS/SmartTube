...
import minefarts.exoplayer2.audio.AudioCapabilities;
import minefarts.exoplayer2.audio.AudioProcessor;
import minefarts.exoplayer2.audio.AudioRendererEventListener;
import minefarts.exoplayer2.audio.DefaultAudioSink;
import minefarts.exoplayer2.audio.MediaCodecAudioRenderer;
...
import minefarts.exoplayer2.metadata.MetadataRenderer;
import minefarts.exoplayer2.text.TextOutput;
import minefarts.exoplayer2.text.TextRenderer;
import minefarts.exoplayer2.trackselection.TrackSelector;
import minefarts.exoplayer2.util.Log;
import minefarts.exoplayer2.video.MediaCodecVideoRenderer;
import minefarts.exoplayer2.video.VideoRendererEventListener;
import minefarts.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("minefarts.exoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              minefarts.exoplayer2.video.VideoRendererEventListener.class,
              int.class);
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("minefarts.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              minefarts.exoplayer2.audio.AudioRendererEventListener.class,
              minefarts.exoplayer2.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("minefarts.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              minefarts.exoplayer2.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("minefarts.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              minefarts.exoplayer2.audio.AudioRendererEventListener.class,
