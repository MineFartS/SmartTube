...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link minefarts.exoplayer2.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link minefarts.exoplayer2.util.TraceUtil}
   * trace enabled.
   */
