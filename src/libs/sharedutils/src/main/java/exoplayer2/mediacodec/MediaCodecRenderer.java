package minefarts.exoplayer2.mediacodec;
...
import minefarts.exoplayer2.BaseRenderer;
...
import minefarts.exoplayer2.decoder.DecoderCounters;
import minefarts.exoplayer2.decoder.DecoderInputBuffer;
import minefarts.exoplayer2.drm.DrmSession;
import minefarts.exoplayer2.drm.DrmSession.DrmSessionException;
...
import minefarts.exoplayer2.util.TraceUtil;
import minefarts.exoplayer2.util.Util;
import minefarts.exoplayer2.util.AmazonQuirks;
...
import minefarts.exoplayer2.util.Logger;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    private void initCodec(MediaCodecInfo codecInfo, MediaCrypto crypto) throws Exception {
        ...
        float codecOperatingRate = Util.SDK_INT < 23 ? CODEC_OPERATING_RATE_UNSET
    ...
    protected void onInputFormatChanged(Format newFormat) throws ExoPlaybackException {
        ...
        boolean drmInitDataChanged = !Util.areEqual(newFormat.drmInitData,
    ...
    private static boolean codecNeedsFlushWorkaround(String name) {
        return Util.SDK_INT < 18 || (Util.SDK_INT == 18
    ...
    private static boolean codecNeedsReconfigureWorkaround(String name) {
        return Util.MODEL.startsWith("SM-T230")
    ...
    private static boolean codecNeedsEosPropagationWorkaround(MediaCodecInfo codecInfo) {
        ...
        return (Util.SDK_INT <= 25 && "OMX.rk.video_decoder.avc".equals(name))
                ...
                || ("Amazon".equals(Util.MANUFACTURER) && "AFTS".equals(Util.MODEL)
                        && codecInfo.secure);
    }
