...
import minefarts.exoplayer2.RenderersFactory;
...
import minefarts.exoplayer2.trackselection.BaseTrackSelection;
import minefarts.exoplayer2.trackselection.DefaultTrackSelector;
import minefarts.exoplayer2.trackselection.DefaultTrackSelector.Parameters;
...
import minefarts.exoplayer2.trackselection.TrackSelectorResult;
...
import minefarts.exoplayer2.upstream.DefaultAllocator;
...
public final class DownloadHelper {
  ...
  private static final MediaSourceFactory DASH_FACTORY =
      getMediaSourceFactory("minefarts.exoplayer2.source.dash.DashMediaSource$Factory");
  private static final MediaSourceFactory SS_FACTORY =
      getMediaSourceFactory(
          "minefarts.exoplayer2.source.smoothstreaming.SsMediaSource$Factory");
  private static final MediaSourceFactory HLS_FACTORY =
      getMediaSourceFactory("minefarts.exoplayer2.source.hls.HlsMediaSource$Factory");
