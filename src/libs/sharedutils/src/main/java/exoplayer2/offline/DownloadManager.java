...
import static minefarts.exoplayer2.offline.Download.FAILURE_REASON_NONE;
import static minefarts.exoplayer2.offline.Download.FAILURE_REASON_UNKNOWN;
import static minefarts.exoplayer2.offline.Download.STATE_COMPLETED;
import static minefarts.exoplayer2.offline.Download.STATE_DOWNLOADING;
import static minefarts.exoplayer2.offline.Download.STATE_FAILED;
import static minefarts.exoplayer2.offline.Download.STATE_QUEUED;
import static minefarts.exoplayer2.offline.Download.STATE_REMOVING;
import static minefarts.exoplayer2.offline.Download.STATE_RESTARTING;
import static minefarts.exoplayer2.offline.Download.STATE_STOPPED;
...
import minefarts.exoplayer2.database.DatabaseProvider;
import minefarts.exoplayer2.scheduler.Requirements;
import minefarts.exoplayer2.scheduler.RequirementsWatcher;
import minefarts.exoplayer2.upstream.DataSource;
import minefarts.exoplayer2.upstream.DataSource.Factory;
import minefarts.exoplayer2.upstream.cache.Cache;
import minefarts.exoplayer2.upstream.cache.CacheEvictor;
import minefarts.exoplayer2.upstream.cache.NoOpCacheEvictor;
