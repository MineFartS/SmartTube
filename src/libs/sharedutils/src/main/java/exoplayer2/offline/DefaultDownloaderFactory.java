  ...
  static {
    ...
    try {
      ...
      dashDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("minefarts.exoplayer2.source.dash.offline.DashDownloader"));
    ...
    try {
      ...
      hlsDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("minefarts.exoplayer2.source.hls.offline.HlsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
    ...
    try {
      ...
      ssDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName(
                  "minefarts.exoplayer2.source.smoothstreaming.offline.SsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
