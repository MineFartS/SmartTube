package minefarts.exoplayer2.text.subrip;
...
import minefarts.exoplayer2.text.SimpleSubtitleDecoder;
...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static final Pattern SUBRIP_TIMING_LINE = Pattern
            .compile("\\s*(" + SUBRIP_TIMECODE + ")\\s*-->\\s*(" + SUBRIP_TIMECODE + ")?\\s*");
    ...
    private Cue buildCue(Spanned text, @Nullable String alignmentTag) {
        ...
        return new Cue(text, /* textAlignment= */ null,
                getFractionalPositionForAnchorType(lineAnchor), Cue.LINE_TYPE_FRACTION, lineAnchor,
                getFractionalPositionForAnchorType(positionAnchor), positionAnchor,
                Cue.DIMEN_UNSET);
    }
