...
import minefarts.exoplayer2.extractor.amr.AmrExtractor;
import minefarts.exoplayer2.extractor.flv.FlvExtractor;
...
import minefarts.exoplayer2.extractor.mp4.Mp4Extractor;
import minefarts.exoplayer2.extractor.ogg.OggExtractor;
import minefarts.exoplayer2.extractor.ts.Ac3Extractor;
import minefarts.exoplayer2.extractor.ts.Ac4Extractor;
import minefarts.exoplayer2.extractor.ts.AdtsExtractor;
import minefarts.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import minefarts.exoplayer2.extractor.ts.PsExtractor;
import minefarts.exoplayer2.extractor.ts.TsExtractor;
import minefarts.exoplayer2.extractor.ts.TsPayloadReader;
import minefarts.exoplayer2.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      ...
      flacExtractorConstructor =
          Class.forName("minefarts.exoplayer2.ext.flac.FlacExtractor")
