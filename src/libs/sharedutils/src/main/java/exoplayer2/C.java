...
import minefarts.exoplayer2.PlayerMessage.Target;
import minefarts.exoplayer2.audio.AuxEffectInfo;
...
public final class C {
    ...
    /**
     * Crypto modes for a codec. One of {@link #CRYPTO_MODE_UNENCRYPTED},
     * {@link #CRYPTO_MODE_AES_CTR} or {@link #CRYPTO_MODE_AES_CBC}.
     */
    @Documented
     ...
     * {@link #ENCODING_INVALID}, {@link #ENCODING_PCM_8BIT}, {@link #ENCODING_PCM_16BIT},
     * {@link #ENCODING_PCM_24BIT}, {@link #ENCODING_PCM_32BIT}, {@link #ENCODING_PCM_FLOAT},
     * {@link #ENCODING_PCM_MU_LAW}, {@link #ENCODING_PCM_A_LAW}, {@link #ENCODING_AC3},
     * {@link #ENCODING_E_AC3}, {@link #ENCODING_E_AC3_JOC}, {@link #ENCODING_AC4},
     * {@link #ENCODING_DTS}, {@link #ENCODING_DTS_HD} or {@link #ENCODING_DOLBY_TRUEHD}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({Format.NO_VALUE, ENCODING_INVALID, ENCODING_PCM_8BIT, ENCODING_PCM_16BIT,
            ENCODING_PCM_24BIT, ENCODING_PCM_32BIT, ENCODING_PCM_FLOAT, ENCODING_PCM_MU_LAW,
            ENCODING_PCM_A_LAW, ENCODING_AC3, ENCODING_E_AC3, ENCODING_E_AC3_JOC, ENCODING_AC4,
            ENCODING_DTS, ENCODING_DTS_HD, ENCODING_DOLBY_TRUEHD,})
    public @interface Encoding {
    }

    /**
     * Represents a PCM audio encoding, or an invalid or unset value. One of
     * {@link Format#NO_VALUE}, {@link #ENCODING_INVALID}, {@link #ENCODING_PCM_8BIT},
     * {@link #ENCODING_PCM_16BIT}, {@link #ENCODING_PCM_24BIT}, {@link #ENCODING_PCM_32BIT},
    ...
    /**
     * Stream types for an {@link android.media.AudioTrack}. One of {@link #STREAM_TYPE_ALARM},
     * {@link #STREAM_TYPE_DTMF}, {@link #STREAM_TYPE_MUSIC}, {@link #STREAM_TYPE_NOTIFICATION},
     * {@link #STREAM_TYPE_RING}, {@link #STREAM_TYPE_SYSTEM}, {@link #STREAM_TYPE_VOICE_CALL} or
     * {@link #STREAM_TYPE_USE_DEFAULT}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Content types for {@link minefarts.exoplayer2.audio.AudioAttributes}. One of
    ...
    /**
     * Flags for {@link minefarts.exoplayer2.audio.AudioAttributes}. Possible flag value is
    ...
    /**
     * Usage types for {@link minefarts.exoplayer2.audio.AudioAttributes}. One of
     * {@link #USAGE_ALARM}, {@link #USAGE_ASSISTANCE_ACCESSIBILITY},
     * {@link #USAGE_ASSISTANCE_NAVIGATION_GUIDANCE}, {@link #USAGE_ASSISTANCE_SONIFICATION},
     * {@link #USAGE_ASSISTANT}, {@link #USAGE_GAME}, {@link #USAGE_MEDIA},
     * {@link #USAGE_NOTIFICATION}, {@link #USAGE_NOTIFICATION_COMMUNICATION_DELAYED},
     * {@link #USAGE_NOTIFICATION_COMMUNICATION_INSTANT},
     * {@link #USAGE_NOTIFICATION_COMMUNICATION_REQUEST}, {@link #USAGE_NOTIFICATION_EVENT},
     * {@link #USAGE_NOTIFICATION_RINGTONE}, {@link #USAGE_UNKNOWN},
     * {@link #USAGE_VOICE_COMMUNICATION} or {@link #USAGE_VOICE_COMMUNICATION_SIGNALLING}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({USAGE_ALARM, USAGE_ASSISTANCE_ACCESSIBILITY, USAGE_ASSISTANCE_NAVIGATION_GUIDANCE,
            USAGE_ASSISTANCE_SONIFICATION, USAGE_ASSISTANT, USAGE_GAME, USAGE_MEDIA,
            USAGE_NOTIFICATION, USAGE_NOTIFICATION_COMMUNICATION_DELAYED,
            USAGE_NOTIFICATION_COMMUNICATION_INSTANT, USAGE_NOTIFICATION_COMMUNICATION_REQUEST,
            USAGE_NOTIFICATION_EVENT, USAGE_NOTIFICATION_RINGTONE, USAGE_UNKNOWN,
    ...
    /**
     * Audio focus types. One of {@link #AUDIOFOCUS_NONE}, {@link #AUDIOFOCUS_GAIN},
     * {@link #AUDIOFOCUS_GAIN_TRANSIENT}, {@link #AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK} or
     * {@link #AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({AUDIOFOCUS_NONE, AUDIOFOCUS_GAIN, AUDIOFOCUS_GAIN_TRANSIENT,
    ...
    /**
     * Flags which can apply to a buffer containing a media sample. Possible flag values are
     * {@link #BUFFER_FLAG_KEY_FRAME}, {@link #BUFFER_FLAG_END_OF_STREAM},
     * {@link #BUFFER_FLAG_LAST_SAMPLE}, {@link #BUFFER_FLAG_ENCRYPTED} and
     * {@link #BUFFER_FLAG_DECODE_ONLY}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true, value = {BUFFER_FLAG_KEY_FRAME, BUFFER_FLAG_END_OF_STREAM,
            BUFFER_FLAG_LAST_SAMPLE, BUFFER_FLAG_ENCRYPTED, BUFFER_FLAG_DECODE_ONLY})
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(value = {VIDEO_SCALING_MODE_SCALE_TO_FIT,
     ...
     * {@link #SELECTION_FLAG_FORCED} and {@link #SELECTION_FLAG_AUTOSELECT}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true,
    ...
    /**
     * Represents a streaming or other media type. One of {@link #TYPE_DASH}, {@link #TYPE_SS},
     * {@link #TYPE_HLS} or {@link #TYPE_OTHER}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * A return value for methods where the length of parsed data exceeds the maximum length
     * allowed.
     */
    ...
    /**
     * UUID for the W3C
     * <a href="https://w3c.github.io/encrypted-media/format-registry/initdata/cenc.html">Common
     * PSSH box</a>.
     */
     ...
     * {@link minefarts.exoplayer2.audio.AudioAttributes} instance that will configure the
     ...
     * {@link Util#getAudioUsageForStreamType(int)} and use the returned {@link C.AudioUsage} to
     * build an audio attributes instance.
     */
     ...
     * A type of a message that can be passed to an audio {@link Renderer} via
     * {@link ExoPlayer#createMessage(Target)}. The message payload should be an
     * {@link AuxEffectInfo} instance representing an auxiliary audio effect for the underlying
     * audio track.
     */
    ...
    /**
     * The stereo mode for 360/3D/VR videos. One of {@link Format#NO_VALUE},
     * {@link #STEREO_MODE_MONO}, {@link #STEREO_MODE_TOP_BOTTOM}, {@link #STEREO_MODE_LEFT_RIGHT}
     * or {@link #STEREO_MODE_STEREO_MESH}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Video colorspaces. One of {@link Format#NO_VALUE}, {@link #COLOR_SPACE_BT709},
     * {@link #COLOR_SPACE_BT601} or {@link #COLOR_SPACE_BT2020}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Video color transfer characteristics. One of {@link Format#NO_VALUE},
     * {@link #COLOR_TRANSFER_SDR}, {@link #COLOR_TRANSFER_ST2084} or {@link #COLOR_TRANSFER_HLG}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Video color range. One of {@link Format#NO_VALUE}, {@link #COLOR_RANGE_LIMITED} or
     * {@link #COLOR_RANGE_FULL}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({Format.NO_VALUE, PROJECTION_RECTANGULAR, PROJECTION_EQUIRECTANGULAR,
            PROJECTION_CUBEMAP, PROJECTION_MESH})
     ...
     * {@link #NETWORK_TYPE_WIFI}, {@link #NETWORK_TYPE_2G}, {@link #NETWORK_TYPE_3G},
     * {@link #NETWORK_TYPE_4G}, {@link #NETWORK_TYPE_CELLULAR_UNKNOWN},
     * {@link #NETWORK_TYPE_ETHERNET} or {@link #NETWORK_TYPE_OTHER}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({NETWORK_TYPE_UNKNOWN, NETWORK_TYPE_OFFLINE, NETWORK_TYPE_WIFI, NETWORK_TYPE_2G,
            NETWORK_TYPE_3G, NETWORK_TYPE_4G, NETWORK_TYPE_CELLULAR_UNKNOWN, NETWORK_TYPE_ETHERNET,
            NETWORK_TYPE_OTHER})
    ...
    /**
     * Track role flags. Possible flag values are {@link #ROLE_FLAG_MAIN},
     * {@link #ROLE_FLAG_ALTERNATE}, {@link #ROLE_FLAG_SUPPLEMENTARY},
     * {@link #ROLE_FLAG_COMMENTARY}, {@link #ROLE_FLAG_DUB}, {@link #ROLE_FLAG_EMERGENCY},
     * {@link #ROLE_FLAG_CAPTION}, {@link #ROLE_FLAG_SUBTITLE}, {@link #ROLE_FLAG_SIGN},
     * {@link #ROLE_FLAG_DESCRIBES_VIDEO}, {@link #ROLE_FLAG_DESCRIBES_MUSIC_AND_SOUND},
     * {@link #ROLE_FLAG_ENHANCED_DIALOG_INTELLIGIBILITY}, {@link #ROLE_FLAG_TRANSCRIBES_DIALOG} and
     * {@link #ROLE_FLAG_EASY_TO_READ}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true,
            value = {ROLE_FLAG_MAIN, ROLE_FLAG_ALTERNATE, ROLE_FLAG_SUPPLEMENTARY,
                    ROLE_FLAG_COMMENTARY, ROLE_FLAG_DUB, ROLE_FLAG_EMERGENCY, ROLE_FLAG_CAPTION,
                    ROLE_FLAG_SUBTITLE, ROLE_FLAG_SIGN, ROLE_FLAG_DESCRIBES_VIDEO,
                    ROLE_FLAG_DESCRIBES_MUSIC_AND_SOUND, ROLE_FLAG_ENHANCED_DIALOG_INTELLIGIBILITY,
                    ROLE_FLAG_TRANSCRIBES_DIALOG, ROLE_FLAG_EASY_TO_READ})
    ...
    /**
     * Indicates a supplementary track, meaning the track has lower importance than the main
     * track(s). For example a video track that provides a visual accompaniment to a main audio
     * track.
     */
