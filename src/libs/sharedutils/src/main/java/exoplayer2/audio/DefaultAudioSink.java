...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(@C.Encoding int inputEncoding, int inputChannelCount, int inputSampleRate,
        ...
        int inputPcmFrameSize = isInputPcm ? Util.getPcmFrameSize(inputEncoding, inputChannelCount)
                : C.LENGTH_UNSET;
    ...
    private long applySpeedup(long positionUs) {
        ...
        // speed.
        return playbackParametersOffsetUs + Util.getMediaDurationForPlayoutDuration(
    ...
    private static final class Configuration {
        ...
        private int getDefaultBufferSize() {
            if (isInputPcm) {
                ...
                return Util.constrainValue(multipliedBufferSize, minAppBufferSize,
                        maxAppBufferSize);
            } else {
