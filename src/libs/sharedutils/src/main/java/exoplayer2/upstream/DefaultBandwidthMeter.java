...
import minefarts.exoplayer2.util.Clock;
import minefarts.exoplayer2.util.EventDispatcher;
import minefarts.exoplayer2.util.SlidingPercentile;
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            initialBitrateEstimates =
                    getInitialBitrateEstimatesForCountry(Util.getCountryCode(context));
