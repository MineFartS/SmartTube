...
public final class HlsTrackMetadataEntry implements Metadata.Entry {
    ...
    public static final class VariantInfo implements Parcelable {
        ...
        /**
         * The VIDEO value as defined in the EXT-X-STREAM-INF tag, or null if the VIDEO attribute is
         * not present.
         */
        @Nullable
        ...
        /**
         * The AUDIO value as defined in the EXT-X-STREAM-INF tag, or null if the AUDIO attribute is
         * not present.
         */
        @Nullable
         ...
         */
        public VariantInfo(long bitrate, @Nullable String videoGroupId,
                @Nullable String audioGroupId, @Nullable String subtitleGroupId,
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return bitrate == that.bitrate && TextUtils.equals(videoGroupId, that.videoGroupId)
    ...
    /**
     * The GROUP-ID value of this track, if the track is derived from an EXT-X-MEDIA tag. Null if
     * the track is not derived from an EXT-X-MEDIA TAG.
     */
    @Nullable
    ...
    public HlsTrackMetadataEntry(@Nullable String groupId, @Nullable String name,
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return TextUtils.equals(groupId, that.groupId) && TextUtils.equals(name, that.name)
