...
import minefarts.exoplayer2.extractor.DummyTrackOutput;
...
import minefarts.exoplayer2.metadata.id3.PrivFrame;
import minefarts.exoplayer2.source.MediaSourceEventListener.EventDispatcher;
import minefarts.exoplayer2.source.SampleQueue;
import minefarts.exoplayer2.source.SampleQueue.UpstreamFormatChangedListener;
...
import minefarts.exoplayer2.source.chunk.MediaChunkIterator;
...
/* package */ final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>,
    ...
    private static class EmsgUnwrappingTrackOutput implements TrackOutput {
        ...
        private boolean emsgContainsExpectedWrappedFormat(EventMessage emsg) {
            ...
            return wrappedMetadataFormat != null && Util.areEqual(delegateFormat.sampleMimeType,
