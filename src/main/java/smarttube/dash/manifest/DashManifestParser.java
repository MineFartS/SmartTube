...
import minefarts.smarttube.dash.manifest.SegmentBase.SegmentList;
...
public class DashManifestParser extends DefaultHandler
  ...
  protected Pair<String, SchemeData> parseContentProtection(XmlPullParser xpp)
    ...
    String schemeIdUri = xpp.getAttributeValue(null, "schemeIdUri");
    if (schemeIdUri != null) {
      switch (Utils.toLowerInvariant(schemeIdUri)) {
  ...
  protected Pair<Long, EventMessage> parseEvent(
    ...
    long durationMs = Utils.scaleLargeTimestamp(duration, C.MILLIS_PER_SECOND, timescale);
    long presentationTimesUs = Utils.scaleLargeTimestamp(presentationTime, C.MICROS_PER_SECOND,
        timescale);
    ...
    return Pair.create(
        ...
        buildEvent(
            ...
            id,
            durationMs,
            messageData == null ? eventObject : Utils.getUtf8Bytes(messageData)));
  }
  ...
  protected static long parseDuration(XmlPullParser xpp, String name, long defaultValue) {
    ...
    if (value == null) {
      ...
      return Utils.parseXsDuration(value);
    }
  }
  ...
  protected static long parseDateTime(XmlPullParser xpp, String name, long defaultValue)
    ...
    if (value == null) {
      ...
      return Utils.parseXsDateTime(value);
    }
  }
  ...
  protected static int parseDolbyChannelConfiguration(XmlPullParser xpp) {
    String value = Utils.toLowerInvariant(xpp.getAttributeValue(null, "value"));
    if (value == null) {
      return Format.NO_VALUE;
    }
    switch (value) {
