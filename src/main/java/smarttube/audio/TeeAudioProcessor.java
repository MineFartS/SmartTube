 ...
 * custom {@link minefarts.smarttube.audio.DefaultAudioSink.AudioProcessorChain} when
...
public final class TeeAudioProcessor extends BaseAudioProcessor {
  ...
  public static final class WavFileAudioBufferSink implements AudioBufferSink {
    ...
    private void writeFileHeader(RandomAccessFile randomAccessFile) throws IOException {
      ...
      int bytesPerSample = Utils.getPcmFrameSize(encoding, channelCount);
    ...
    private String getNextOutputFileName() {
      return Utils.formatInvariant("%s-%04d.wav", outputFileNamePrefix, counter++);
    }
  }
}
