...
import minefarts.smarttube.RendererConfiguration;
 ...
 * to configurable {@link Parameters}, which can be set by calling
 ...
 * Parameters newParameters = currentParameters.buildUpon().setMaxVideoSizeSd()
 *         .setPreferredAudioLanguage("deu").build();
 ...
 *         mappedTrackInfo == null ? null : mappedTrackInfo.getTrackGroups(rendererIndex);
 * }</pre>
 *
 ...
 *
 * <ul>
 * <li>You can specify constraints before knowing what tracks the media provides. This can simplify
 * track selection code (e.g. you don't have to listen for changes in the available tracks before
 * configuring the selector).
 * <li>Constraints can be applied consistently across all periods in a complex piece of media, even
 * if those periods contain different tracks. In contrast, a specific track override is only applied
 * to periods whose tracks match those for which the override was set.
 * </ul>
 *
 ...
 * support it. Tunneled playback is enabled by passing an audio session ID to
 * {@link ParametersBuilder#setTunnelingAudioSessionId(int)}.
 */
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        private ParametersBuilder(Parameters initialValues) {
            ...
            allowAudioMixedSampleRateAdaptiveness =
                    initialValues.allowAudioMixedSampleRateAdaptiveness;
            ...
            exceedRendererCapabilitiesIfNecessary =
                    initialValues.exceedRendererCapabilitiesIfNecessary;
        ...
        /**
         * Equivalent to {@link #setMaxVideoSize setMaxVideoSize(Integer.MAX_VALUE,
         * Integer.MAX_VALUE)}.
         *
         * @return This builder.
         */
        ...
        /**
         * Sets whether to exceed the {@link #setMaxVideoSize(int, int)} and
         * {@link #setMaxAudioBitrate(int)} constraints when no selection can be made otherwise.
         *
        ...
        /**
         * Equivalent to {@link #setViewportSize setViewportSize(Integer.MAX_VALUE,
        ...
        /**
         * Sets the viewport size to constrain adaptive video selections so that only tracks
         * suitable for the viewport are selected.
         *
        ...
        @Override
        public ParametersBuilder setPreferredAudioLanguage(
        ...
        /**
         * Sets whether to exceed the {@link #setMaxAudioChannelCount(int)} and
         * {@link #setMaxAudioBitrate(int)} constraints when no selection can be made otherwise.
         *
        ...
        @Override
        public ParametersBuilder setPreferredTextRoleFlags(
         ...
         *
         * @param forceLowestBitrate Whether to force selection of the single lowest bitrate audio
         *        and video tracks.
         * @return This builder.
         */
         ...
         *
         * @param forceHighestSupportedBitrate Whether to force selection of the highest bitrate
         *        audio and video tracks.
         * @return This builder.
         */
        public ParametersBuilder setForceHighestSupportedBitrate(
        ...
        /**
         * @deprecated Use {@link #setAllowVideoMixedMimeTypeAdaptiveness(boolean)} and
         *             {@link #setAllowAudioMixedMimeTypeAdaptiveness(boolean)}.
         */
        @Deprecated
        ...
        @Deprecated
        public ParametersBuilder setAllowNonSeamlessAdaptiveness(
         ...
         * renderer's reported capabilities. If the parameter is {@code true} then the lowest
         * quality track will still be selected. Playback may succeed if the renderer has
         * under-reported its true capabilities. If {@code false} then no track will be selected.
         *
         ...
         * in tunneling mode. Session ids can be generated using
         * {@link C#generateAudioSessionIdV21(Context)}. To disable tunneling pass
         * {@link C#AUDIO_SESSION_ID_UNSET}. Tunneling will only be activated if it's both enabled
         * and supported by the audio and video renderers for the selected tracks.
         *
        ...
        /**
         * Sets whether the renderer at the specified index is disabled. Disabling a renderer
         * prevents the selector from selecting any tracks for it.
         *
         ...
         *
         * <p>
         * When the {@link TrackGroupArray} mapped to the renderer matches the one provided, the
         * override is applied. When the {@link TrackGroupArray} does not match, the override has no
         * effect. The override replaces any previous override for the specified
         * {@link TrackGroupArray} for the specified {@link Renderer}.
         *
         * <p>
         * Passing a {@code null} override will cause the renderer to be disabled when the
         * {@link TrackGroupArray} mapped to it matches the one provided. When the
         * {@link TrackGroupArray} does not match a {@code null} override has no effect. Hence a
         * {@code null} override differs from disabling the renderer using
         * {@link #setRendererDisabled(int, boolean)} because the renderer is disabled conditionally
         * on the {@link TrackGroupArray} mapped to it, where-as
         ...
         * @return This builder.
         */
        public final ParametersBuilder setSelectionOverride(int rendererIndex,
                TrackGroupArray groups, SelectionOverride override) {
            Map<TrackGroupArray, SelectionOverride> overrides =
                    selectionOverrides.get(rendererIndex);
            if (overrides == null) {
                overrides = new HashMap<>();
                selectionOverrides.put(rendererIndex, overrides);
            }
            if (overrides.containsKey(groups) && Utils.areEqual(overrides.get(groups), override)) {
         ...
         * @return This builder.
         */
        public final ParametersBuilder clearSelectionOverride(int rendererIndex,
        ...
        public Parameters build() {
            return new Parameters(
                    // Video
                    maxVideoWidth, maxVideoHeight, maxVideoFrameRate, maxVideoBitrate,
                    exceedVideoConstraintsIfNecessary, allowVideoMixedMimeTypeAdaptiveness,
                    allowVideoNonSeamlessAdaptiveness, viewportWidth, viewportHeight,
                    viewportOrientationMayChange,
                    // Audio
                    preferredAudioLanguage, maxAudioChannelCount, maxAudioBitrate,
                    exceedAudioConstraintsIfNecessary, allowAudioMixedMimeTypeAdaptiveness,
                    allowAudioMixedSampleRateAdaptiveness, allowAudioMixedChannelCountAdaptiveness,
                    // Text
                    preferredTextLanguage, preferredTextRoleFlags, selectUndeterminedTextLanguage,
                    disabledTextTrackSelectionFlags,
                    // General
                    forceLowestBitrate, forceHighestSupportedBitrate,
                    exceedRendererCapabilitiesIfNecessary, tunnelingAudioSessionId,
                    selectionOverrides, rendererDisabledFlags);
        }
        ...
        private static SparseArray<Map<TrackGroupArray, SelectionOverride>> cloneSelectionOverrides(
            ...
            for (int i = 0; i < selectionOverrides.size(); i++) {
                clone.put(selectionOverrides.keyAt(i),
                        new HashMap<>(selectionOverrides.valueAt(i)));
            }
            return clone;
        }
    }
    ...
    /**
     * Extends {@link TrackSelectionParameters} by adding fields that are specific to
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        // Video
        /**
         * Maximum allowed video width in pixels. The default value is {@link Integer#MAX_VALUE}
         * (i.e. no constraint).
         *
         * <p>
         * To constrain adaptive video track selections to be suitable for a given viewport (the
         * region of the display within which video will be played), use ({@link #viewportWidth},
         * {@link #viewportHeight} and {@link #viewportOrientationMayChange}) instead.
         */
        public final int maxVideoWidth;
        /**
         * Maximum allowed video height in pixels. The default value is {@link Integer#MAX_VALUE}
         * (i.e. no constraint).
         *
         * <p>
         * To constrain adaptive video track selections to be suitable for a given viewport (the
        ...
        /**
         * Maximum allowed video bitrate in bits per second. The default value is
         * {@link Integer#MAX_VALUE} (i.e. no constraint).
         */
        public final int maxVideoBitrate;
        /**
         * Whether to exceed the {@link #maxVideoWidth}, {@link #maxVideoHeight} and
         * {@link #maxVideoBitrate} constraints when no selection can be made otherwise. The default
         * value is {@code true}.
         */
        public final boolean exceedVideoConstraintsIfNecessary;
        /**
         * Whether to allow adaptive video selections containing mixed MIME types. Adaptations
         * between different MIME types may not be completely seamless, in which case
         * {@link #allowVideoNonSeamlessAdaptiveness} also needs to be {@code true} for mixed MIME
         * type selections to be made. The default value is {@code false}.
         */
        public final boolean allowVideoMixedMimeTypeAdaptiveness;
        /**
         * Whether to allow adaptive video selections where adaptation may not be completely
         * seamless. The default value is {@code true}.
         */
        public final boolean allowVideoNonSeamlessAdaptiveness;
        /**
         * Viewport width in pixels. Constrains video track selections for adaptive content so that
         ...
         * selections for adaptive content so that only tracks suitable for the viewport are
         * selected. The default value is {@code true}.
         */
        public final boolean viewportOrientationMayChange;
        // Audio
        /**
         * Maximum allowed audio channel count. The default value is {@link Integer#MAX_VALUE} (i.e.
         * no constraint).
         */
        public final int maxAudioChannelCount;
        /**
         * Maximum allowed audio bitrate in bits per second. The default value is
         * {@link Integer#MAX_VALUE} (i.e. no constraint).
         */
        public final int maxAudioBitrate;
        /**
         * Whether to exceed the {@link #maxAudioChannelCount} and {@link #maxAudioBitrate}
         * constraints when no selection can be made otherwise. The default value is {@code true}.
         */
        public final boolean exceedAudioConstraintsIfNecessary;
        /**
         * Whether to allow adaptive audio selections containing mixed MIME types. Adaptations
         * between different MIME types may not be completely seamless. The default value is
         * {@code false}.
         */
        public final boolean allowAudioMixedMimeTypeAdaptiveness;
        /**
         * Whether to allow adaptive audio selections containing mixed sample rates. Adaptations
         * between different sample rates may not be completely seamless. The default value is
         * {@code false}.
         */
        public final boolean allowAudioMixedSampleRateAdaptiveness;
        /**
         * Whether to allow adaptive audio selections containing mixed channel counts. Adaptations
         * between different channel counts may not be completely seamless. The default value is
         * {@code
         * false}.
         */
        ...
        // General
        /**
         * Whether to force selection of the single lowest bitrate audio and video tracks that
         * comply with all other constraints. The default value is {@code false}.
         */
        public final boolean forceLowestBitrate;
        /**
         * Whether to force selection of the highest bitrate audio and video tracks that comply with
         * all other constraints. The default value is {@code false}.
         */
        public final boolean forceHighestSupportedBitrate;
        /**
         * @deprecated Use {@link #allowVideoMixedMimeTypeAdaptiveness} and
         *             {@link #allowAudioMixedMimeTypeAdaptiveness}.
         */
        @Deprecated
        ...
        /**
         * The audio session id to use when tunneling, or {@link C#AUDIO_SESSION_ID_UNSET} if
         * tunneling is disabled. The default value is {@link C#AUDIO_SESSION_ID_UNSET} (i.e.
        ...
        private Parameters() {
            this(
                    // Video
                    /* maxVideoWidth= */ Integer.MAX_VALUE, /* maxVideoHeight= */ Integer.MAX_VALUE,
                    ...
                    /* viewportWidth= */ Integer.MAX_VALUE, /* viewportHeight= */ Integer.MAX_VALUE,
                    ...
                    // General
                    /* forceLowestBitrate= */ false, /* forceHighestSupportedBitrate= */ false,
                    /* exceedRendererCapabilitiesIfNecessary= */ true,
                    /* tunnelingAudioSessionId= */ C.AUDIO_SESSION_ID_UNSET, new SparseArray<>(),
                    new SparseBooleanArray());
        }

        /* package */ Parameters(
                // Video
                int maxVideoWidth, int maxVideoHeight, int maxVideoFrameRate, int maxVideoBitrate,
                boolean exceedVideoConstraintsIfNecessary,
                boolean allowVideoMixedMimeTypeAdaptiveness,
                boolean allowVideoNonSeamlessAdaptiveness, int viewportWidth, int viewportHeight,
                boolean viewportOrientationMayChange,
                // Audio
                @Nullable String preferredAudioLanguage, int maxAudioChannelCount,
                int maxAudioBitrate, boolean exceedAudioConstraintsIfNecessary,
                boolean allowAudioMixedMimeTypeAdaptiveness,
                boolean allowAudioMixedSampleRateAdaptiveness,
                boolean allowAudioMixedChannelCountAdaptiveness,
                // Text
                ...
                @C.SelectionFlags int disabledTextTrackSelectionFlags,
                // General
                boolean forceLowestBitrate, boolean forceHighestSupportedBitrate,
                boolean exceedRendererCapabilitiesIfNecessary, int tunnelingAudioSessionId,
                // Overrides
                SparseArray<Map<TrackGroupArray, SelectionOverride>> selectionOverrides,
                SparseBooleanArray rendererDisabledFlags) {
            super(preferredAudioLanguage, preferredTextLanguage, preferredTextRoleFlags,
                    selectUndeterminedTextLanguage, disabledTextTrackSelectionFlags);
            // Video
            this.maxVideoWidth = maxVideoWidth;
            this.maxVideoHeight = maxVideoHeight;
            this.maxVideoFrameRate = maxVideoFrameRate;
        ...
        Parameters(Parcel in) {
            ...
            this.exceedVideoConstraintsIfNecessary = Utils.readBoolean(in);
            this.allowVideoMixedMimeTypeAdaptiveness = Utils.readBoolean(in);
            this.allowVideoNonSeamlessAdaptiveness = Utils.readBoolean(in);
            this.viewportWidth = in.readInt();
            this.viewportHeight = in.readInt();
            this.viewportOrientationMayChange = Utils.readBoolean(in);
            // Audio
            this.maxAudioChannelCount = in.readInt();
            this.maxAudioBitrate = in.readInt();
            this.exceedAudioConstraintsIfNecessary = Utils.readBoolean(in);
            this.allowAudioMixedMimeTypeAdaptiveness = Utils.readBoolean(in);
            this.allowAudioMixedSampleRateAdaptiveness = Utils.readBoolean(in);
            this.allowAudioMixedChannelCountAdaptiveness = Utils.readBoolean(in);
            // General
            this.forceLowestBitrate = Utils.readBoolean(in);
            this.forceHighestSupportedBitrate = Utils.readBoolean(in);
            this.exceedRendererCapabilitiesIfNecessary = Utils.readBoolean(in);
            this.tunnelingAudioSessionId = in.readInt();
            // Overrides
            this.selectionOverrides = readSelectionOverrides(in);
            this.rendererDisabledFlags = Utils.castNonNull(in.readSparseBooleanArray());
            // Deprecated fields.
            this.allowMixedMimeAdaptiveness = allowVideoMixedMimeTypeAdaptiveness;
            this.allowNonSeamlessAdaptiveness = allowVideoNonSeamlessAdaptiveness;
        }
         ...
         */
        @Nullable
        public final SelectionOverride getSelectionOverride(int rendererIndex,
                TrackGroupArray groups) {
            Map<TrackGroupArray, SelectionOverride> overrides =
                    selectionOverrides.get(rendererIndex);
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            Utils.writeBoolean(dest, exceedVideoConstraintsIfNecessary);
            Utils.writeBoolean(dest, allowVideoMixedMimeTypeAdaptiveness);
            Utils.writeBoolean(dest, allowVideoNonSeamlessAdaptiveness);
            dest.writeInt(viewportWidth);
            dest.writeInt(viewportHeight);
            Utils.writeBoolean(dest, viewportOrientationMayChange);
            // Audio
            dest.writeInt(maxAudioChannelCount);
            dest.writeInt(maxAudioBitrate);
            Utils.writeBoolean(dest, exceedAudioConstraintsIfNecessary);
            Utils.writeBoolean(dest, allowAudioMixedMimeTypeAdaptiveness);
            Utils.writeBoolean(dest, allowAudioMixedSampleRateAdaptiveness);
            Utils.writeBoolean(dest, allowAudioMixedChannelCountAdaptiveness);
            // General
            Utils.writeBoolean(dest, forceLowestBitrate);
            Utils.writeBoolean(dest, forceHighestSupportedBitrate);
            Utils.writeBoolean(dest, exceedRendererCapabilitiesIfNecessary);
            ...
            for (int i = 0; i < renderersWithOverridesCount; i++) {
                ...
                for (int j = 0; j < overrideCount; j++) {
                    TrackGroupArray trackGroups =
                            in.readParcelable(TrackGroupArray.class.getClassLoader());
                    SelectionOverride override =
                            in.readParcelable(SelectionOverride.class.getClassLoader());
        ...
        private static void writeSelectionOverridesToParcel(Parcel dest,
                SparseArray<Map<TrackGroupArray, SelectionOverride>> selectionOverrides) {
            ...
            for (int i = 0; i < renderersWithOverridesCount; i++) {
                ...
                for (Map.Entry<TrackGroupArray, SelectionOverride> override : overrides
                        .entrySet()) {
        ...
        private static boolean areRendererDisabledFlagsEqual(SparseBooleanArray first,
                SparseBooleanArray second) {
            int firstSize = first.size();
            if (second.size() != firstSize) {
                return false;
            }
            // Only true values are put into rendererDisabledFlags, so we don't need to compare
            // values.
        ...
        private static boolean areSelectionOverridesEqual(
            ...
            for (int indexInFirst = 0; indexInFirst < firstSize; indexInFirst++) {
                ...
                if (indexInSecond < 0 || !areSelectionOverridesEqual(first.valueAt(indexInFirst),
                        second.valueAt(indexInSecond))) {
                    return false;
                }
            }
            return true;
        ...
        private static boolean areSelectionOverridesEqual(
            ...
            for (Map.Entry<TrackGroupArray, SelectionOverride> firstEntry : first.entrySet()) {
                ...
                if (!second.containsKey(key)
                        || !Utils.areEqual(firstEntry.getValue(), second.get(key))) {
                    return false;
                }
            }
            return true;
    ...
    public static final class SelectionOverride implements Parcelable {
         ...
         * @param groupIndex The overriding track group index.
         * @param tracks The overriding track indices within the track group.
         * @param reason The reason for the override. One of the {@link C} SELECTION_REASON_
         *        constants.
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return groupIndex == other.groupIndex && Arrays.equals(tracks, other.tracks)
                    && reason == other.reason && data == other.data;
        }
     ...
     * corresponding viewport dimension, then the video is considered as filling the viewport (in
     * that dimension).
     */
    ...
    /**
     * @deprecated Use
     *             {@link ParametersBuilder#setSelectionOverride(int, TrackGroupArray, SelectionOverride)}.
     */
    @Deprecated
    ...
    @Override
    protected final Pair<@NullableType RendererConfiguration[], @NullableType TrackSelection[]> selectTracks(
            MappedTrackInfo mappedTrackInfo, int[][][] rendererFormatSupports,
            int[] rendererMixedMimeTypeAdaptationSupports) throws ExoPlaybackException {
        Parameters params = parametersReference.get();
        int rendererCount = mappedTrackInfo.getRendererCount();
        TrackSelection.@NullableType Definition[] definitions = selectAllTracks(mappedTrackInfo,
                rendererFormatSupports, rendererMixedMimeTypeAdaptationSupports, params);
        ...
        // Initialize the renderer configurations to the default configuration for all renderers
        // with
        ...
        maybeConfigureRenderersForTunneling(mappedTrackInfo, rendererFormatSupports,
                rendererConfigurations, rendererTrackSelections, params.tunnelingAudioSessionId);
    ...
    /**
     * Called from {@link #selectTracks(MappedTrackInfo, int[][][], int[])} to make a track
     ...
     * @param rendererMixedMimeTypeAdaptationSupports The result of
    ...
    protected TrackSelection.@NullableType Definition[] selectAllTracks(
        ...
        for (int i = 0; i < rendererCount; i++) {
            if (C.TRACK_TYPE_VIDEO == mappedTrackInfo.getRendererType(i)) {
                if (!selectedVideoTracks) {
                    definitions[i] = selectVideoTrack(mappedTrackInfo.getTrackGroups(i),
                            rendererFormatSupports[i], rendererMixedMimeTypeAdaptationSupports[i],
                            params, /* enableAdaptiveTrackSelection= */ true);
        ...
        for (int i = 0; i < rendererCount; i++) {
            if (C.TRACK_TYPE_AUDIO == mappedTrackInfo.getRendererType(i)) {
                ...
                Pair<TrackSelection.Definition, AudioTrackScore> audioSelection = selectAudioTrack(
                ...
                if (audioSelection != null && (selectedAudioTrackScore == null
                        || audioSelection.second.compareTo(selectedAudioTrackScore) > 0)) {
                    if (selectedAudioRendererIndex != C.INDEX_UNSET) {
                        // We've already made a selection for another audio renderer, but it had a
                        // lower
                    ...
                    selectedAudioLanguage =
                            definition.group.getFormat(definition.tracks[0]).language;
            ...
            switch (trackType) {
                ...
                case C.TRACK_TYPE_TEXT:
                    Pair<TrackSelection.Definition, TextTrackScore> textSelection =
                            selectTextTrack(mappedTrackInfo.getTrackGroups(i),
                                    rendererFormatSupports[i], params, selectedAudioLanguage);
                    if (textSelection != null && (selectedTextTrackScore == null
                            || textSelection.second.compareTo(selectedTextTrackScore) > 0)) {
                        if (selectedTextRendererIndex != C.INDEX_UNSET) {
                            // We've already made a selection for another text renderer, but it had
                            // a lower score.
                    ...
                    break;
                default:
                    definitions[i] = selectOtherTrack(trackType, mappedTrackInfo.getTrackGroups(i),
     ...
     * @param formatSupports The result of {@link RendererCapabilities#supportsFormat} for each
     *        mapped track, indexed by track group index and track index (in that order).
     * @param mixedMimeTypeAdaptationSupports The result of
     *        {@link RendererCapabilities#supportsMixedMimeTypeAdaptation()} for the renderer.
     ...
     */
    @Nullable
    protected TrackSelection.Definition selectVideoTrack(TrackGroupArray groups,
            int[][] formatSupports, int mixedMimeTypeAdaptationSupports, Parameters params,
            boolean enableAdaptiveTrackSelection) throws ExoPlaybackException {
        TrackSelection.Definition definition = null;
        if (!params.forceHighestSupportedBitrate && !params.forceLowestBitrate
                && enableAdaptiveTrackSelection) {
            definition = selectAdaptiveVideoTrack(groups, formatSupports,
    ...
    @Nullable
    private static TrackSelection.Definition selectAdaptiveVideoTrack(TrackGroupArray groups,
            int[][] formatSupport, int mixedMimeTypeAdaptationSupports, Parameters params) {
        int requiredAdaptiveSupport = params.allowVideoNonSeamlessAdaptiveness
                ? (RendererCapabilities.ADAPTIVE_NOT_SEAMLESS
                        | RendererCapabilities.ADAPTIVE_SEAMLESS)
                : RendererCapabilities.ADAPTIVE_SEAMLESS;
        boolean allowMixedMimeTypes = params.allowVideoMixedMimeTypeAdaptiveness
                && (mixedMimeTypeAdaptationSupports & requiredAdaptiveSupport) != 0;
        for (int i = 0; i < groups.length; i++) {
            TrackGroup group = groups.get(i);
            int[] adaptiveTracks =
                    getAdaptiveVideoTracksForGroup(group, formatSupport[i], allowMixedMimeTypes,
                            requiredAdaptiveSupport, params.maxVideoWidth, params.maxVideoHeight,
                            params.maxVideoFrameRate, params.maxVideoBitrate, params.viewportWidth,
                            params.viewportHeight, params.viewportOrientationMayChange);
    ...
    private static int[] getAdaptiveVideoTracksForGroup(TrackGroup group, int[] formatSupport,
            ...
            int maxVideoHeight, int maxVideoFrameRate, int maxVideoBitrate, int viewportWidth,
        ...
        if (!allowMixedMimeTypes) {
            ...
            for (int i = 0; i < selectedTrackIndices.size(); i++) {
                ...
                if (seenMimeTypes.add(sampleMimeType)) {
                    int countForMimeType = getAdaptiveVideoTrackCountForMimeType(group,
                            formatSupport, requiredAdaptiveSupport, sampleMimeType, maxVideoWidth,
                            maxVideoHeight, maxVideoFrameRate, maxVideoBitrate,
        ...
        filterAdaptiveVideoTrackCountForMimeType(group, formatSupport, requiredAdaptiveSupport,
                selectedMimeType, maxVideoWidth, maxVideoHeight, maxVideoFrameRate, maxVideoBitrate,
                selectedTrackIndices);

        return selectedTrackIndices.size() < 2 ? NO_TRACKS : Utils.toArray(selectedTrackIndices);
    }

    private static int getAdaptiveVideoTrackCountForMimeType(TrackGroup group, int[] formatSupport,
            int requiredAdaptiveSupport, @Nullable String mimeType, int maxVideoWidth,
            int maxVideoHeight, int maxVideoFrameRate, int maxVideoBitrate,
            List<Integer> selectedTrackIndices) {
        int adaptiveTrackCount = 0;
        for (int i = 0; i < selectedTrackIndices.size(); i++) {
            int trackIndex = selectedTrackIndices.get(i);
            if (isSupportedAdaptiveVideoTrack(group.getFormat(trackIndex), mimeType,
                    formatSupport[trackIndex], requiredAdaptiveSupport, maxVideoWidth,
                    maxVideoHeight, maxVideoFrameRate, maxVideoBitrate)) {
                adaptiveTrackCount++;
            }
        }
    ...
    private static void filterAdaptiveVideoTrackCountForMimeType(TrackGroup group,
            int[] formatSupport, int requiredAdaptiveSupport, @Nullable String mimeType,
            int maxVideoWidth, int maxVideoHeight, int maxVideoFrameRate, int maxVideoBitrate,
            List<Integer> selectedTrackIndices) {
    ...
    private static boolean isSupportedAdaptiveVideoTrack(Format format, @Nullable String mimeType,
            int formatSupport, int requiredAdaptiveSupport, int maxVideoWidth, int maxVideoHeight,
            int maxVideoFrameRate, int maxVideoBitrate) {
        return isSupported(formatSupport, false) && ((formatSupport & requiredAdaptiveSupport) != 0)
                && (mimeType == null || Utils.areEqual(format.sampleMimeType, mimeType))
    ...
    @Nullable
    private static TrackSelection.Definition selectFixedVideoTrack(TrackGroupArray groups,
            int[][] formatSupports, Parameters params) {
        ...
        for (int groupIndex = 0; groupIndex < groups.length; groupIndex++) {
            ...
            List<Integer> selectedTrackIndices =
                    getViewportFilteredTrackIndices(trackGroup, params.viewportWidth,
                            params.viewportHeight, params.viewportOrientationMayChange);
                ...
                if (isSupported(trackFormatSupport[trackIndex],
                    ...
                    boolean isWithinConstraints = selectedTrackIndices.contains(trackIndex)
                            && (format.width == Format.NO_VALUE
                                    || format.width <= params.maxVideoWidth)
                            && (format.height == Format.NO_VALUE
                                    || format.height <= params.maxVideoHeight)
                    ...
                    boolean isWithinCapabilities =
                            isSupported(trackFormatSupport[trackIndex], false);
                    ...
                    if (trackScore == selectedTrackScore) {
                        ...
                        if (params.forceLowestBitrate && bitrateComparison != 0) {
                            ...
                            // Use the pixel count as a tie breaker (or bitrate if pixel counts are
                            // tied). If
                            // we're within constraints prefer a higher pixel count (or bitrate),
                            // else prefer a
                            // lower count (or bitrate). If still tied then prefer the first track
                            // (i.e. the one
    ...
    protected Pair<TrackSelection.Definition, AudioTrackScore> selectAudioTrack(
            TrackGroupArray groups, int[][] formatSupports, int mixedMimeTypeAdaptationSupports,
            ...
            for (int trackIndex = 0; trackIndex < trackGroup.length; trackIndex++) {
                if (isSupported(trackFormatSupport[trackIndex],
                    ...
                    if (!trackScore.isWithinConstraints
                            && !params.exceedAudioConstraintsIfNecessary) {
                        // Track should not be selected.
                        continue;
                    }
        ...
        if (!params.forceHighestSupportedBitrate && !params.forceLowestBitrate
            ...
            int[] adaptiveTracks =
                    getAdaptiveAudioTracks(selectedGroup, formatSupports[selectedGroupIndex],
                            params.maxAudioBitrate, params.allowAudioMixedMimeTypeAdaptiveness,
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup group, int[] formatSupport,
            int maxAudioBitrate, boolean allowMixedMimeTypeAdaptiveness,
        ...
        for (int i = 0; i < group.length; i++) {
            ...
            AudioConfigurationTuple configuration = new AudioConfigurationTuple(format.channelCount,
                    format.sampleRate, format.sampleMimeType);
            if (seenConfigurationTuples.add(configuration)) {
                int configurationCount = getAdaptiveAudioTrackCount(group, formatSupport,
                        configuration, maxAudioBitrate, allowMixedMimeTypeAdaptiveness,
                        allowMixedSampleRateAdaptiveness, allowAudioMixedChannelCountAdaptiveness);
        ...
        if (selectedConfigurationTrackCount > 1) {
            ...
            for (int i = 0; i < group.length; i++) {
                Format format = group.getFormat(i);
                if (isSupportedAdaptiveAudioTrack(format, formatSupport[i], selectedConfiguration,
                        maxAudioBitrate, allowMixedMimeTypeAdaptiveness,
    ...
    private static int getAdaptiveAudioTrackCount(TrackGroup group, int[] formatSupport,
            AudioConfigurationTuple configuration, int maxAudioBitrate,
            boolean allowMixedMimeTypeAdaptiveness, boolean allowMixedSampleRateAdaptiveness,
            boolean allowAudioMixedChannelCountAdaptiveness) {
        int count = 0;
        for (int i = 0; i < group.length; i++) {
    ...
    private static boolean isSupportedAdaptiveAudioTrack(Format format, int formatSupport,
        ...
        return isSupported(formatSupport, false)
                ...
                && (allowMixedMimeTypeAdaptiveness || (format.sampleMimeType != null
                        && TextUtils.equals(format.sampleMimeType, configuration.mimeType)))
                && (allowMixedSampleRateAdaptiveness || (format.sampleRate != Format.NO_VALUE
     ...
     * @return The {@link TrackSelection.Definition} and corresponding {@link TextTrackScore}, or
     *         null if no selection was made.
     * @throws ExoPlaybackException If an error occurs while selecting the tracks.
     */
    @Nullable
        ...
        for (int groupIndex = 0; groupIndex < groups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < trackGroup.length; trackIndex++) {
                if (isSupported(trackFormatSupport[trackIndex],
                    ...
                    if (trackScore.isWithinConstraints && (selectedTrackScore == null
                            || trackScore.compareTo(selectedTrackScore) > 0)) {
                        selectedGroup = trackGroup;
                        selectedTrackIndex = trackIndex;
                        selectedTrackScore = trackScore;
     ...
     */
    @Nullable
    protected TrackSelection.Definition selectOtherTrack(int trackType, TrackGroupArray groups,
     ...
     *
     * @param mappedTrackInfo Mapped track information.
     * @param rendererConfigurations The renderer configurations. Configurations may be replaced
     *        with ones that enable tunneling as a result of this call.
     * @param trackSelections The renderer track selections.
     * @param tunnelingAudioSessionId The audio session id to use when tunneling, or
     *        {@link C#AUDIO_SESSION_ID_UNSET} if tunneling should not be enabled.
     */
    private static void maybeConfigureRenderersForTunneling(MappedTrackInfo mappedTrackInfo,
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
            ...
            if ((rendererType == C.TRACK_TYPE_AUDIO || rendererType == C.TRACK_TYPE_VIDEO)
                    && trackSelection != null) {
                if (rendererSupportsTunneling(renderererFormatSupports[i],
                        mappedTrackInfo.getTrackGroups(i), trackSelection)) {
     ...
     */
    private static boolean rendererSupportsTunneling(int[][] formatSupports,
        ...
        for (int i = 0; i < selection.length(); i++) {
            int trackFormatSupport =
                    formatSupports[trackGroupIndex][selection.getIndexInTrackGroup(i)];
            if ((trackFormatSupport
                    & RendererCapabilities.TUNNELING_SUPPORT_MASK) != RendererCapabilities.TUNNELING_SUPPORTED) {
                return false;
            }
        }
        return true;
     ...
     * @return A negative integer if the first value is less than the second. Zero if they are
     *         equal. A positive integer if the first value is greater than the second.
     */
     ...
     * {@link RendererCapabilities#FORMAT_HANDLED} or if {@code allowExceedsCapabilities} is set and
     * the result is {@link RendererCapabilities#FORMAT_EXCEEDS_CAPABILITIES}.
     *
     * @param formatSupport A value obtained from
     *        {@link RendererCapabilities#supportsFormat(Format)}.
     ...
     * @return True if the format support component is {@link RendererCapabilities#FORMAT_HANDLED},
     *         or if {@code allowExceedsCapabilities} is set and the format support component is
    ...
    /**
     * Normalizes the input string to null if it does not define a language, or returns it
     * otherwise.
     *
     ...
     * @return A score of 4 if the languages match fully, a score of 3 if the languages match
     *         partly, a score of 2 if the languages don't match but belong to the same main
     *         language, a score of 1 if the format language is undetermined and such a match is
     *         allowed, and a score of 0 if the languages don't match at all.
     */
    protected static int getFormatLanguageScore(Format format, @Nullable String language,
        ...
        if (!TextUtils.isEmpty(language) && language.equals(format.language)) {
            // Full literal match of non-empty languages, including matches of an explicit "und"
            // query.
            return 4;
        }
        ...
        if (formatLanguage.startsWith(language) || language.startsWith(formatLanguage)) {
            // Partial match where one language is a subset of the other (e.g. "zh-hans" and
            // "zh-hans-hk")
            return 3;
        }
        String formatMainLanguage = Utils.splitAtFirst(formatLanguage, "-")[0];
        String queryMainLanguage = Utils.splitAtFirst(language, "-")[0];
    ...
    private static List<Integer> getViewportFilteredTrackIndices(TrackGroup group,
        ...
        for (int i = 0; i < group.length; i++) {
            ...
            if (format.width > 0 && format.height > 0) {
                ...
                if (format.width >= (int) (maxVideoSizeInViewport.x
                        * FRACTION_TO_CONSIDER_FULLSCREEN)
                        && format.height >= (int) (maxVideoSizeInViewport.y
                                * FRACTION_TO_CONSIDER_FULLSCREEN)
        ...
        // Filter out formats that exceed maxVideoPixelsToRetain. These formats have an
        // unnecessarily
        // high resolution given the size at which the video will be displayed within the viewport.
        // Also
        // filter out formats with unknown dimensions, since we have some whose dimensions are
        // known.
    ...
    private static Point getMaxVideoSizeInViewport(boolean orientationMayChange, int viewportWidth,
        ...
        if (orientationMayChange
                && (videoWidth > videoHeight) != (viewportWidth > viewportHeight)) {
        ...
        if (videoWidth * viewportHeight >= videoHeight * viewportWidth) {
            ...
            return new Point(viewportWidth,
                    Utils.ceilDivide(viewportWidth * videoHeight, videoWidth));
        } else {
            // Vertical letter-boxing along edges.
            return new Point(Utils.ceilDivide(viewportHeight * videoWidth, videoHeight),
                    viewportHeight);
        }
    }
    ...
    protected static final class AudioTrackScore implements Comparable<AudioTrackScore> {
        ...
        /**
         * Whether the provided format is within the parameter constraints. If {@code false}, the
         * format should not be selected.
         */
        ...
        public AudioTrackScore(Format format, Parameters parameters, int formatSupport) {
            ...
            preferredLanguageScore =
                    getFormatLanguageScore(format, parameters.preferredAudioLanguage,
                            /* allowUndeterminedFormatLanguage= */ false);
            isDefaultSelectionFlag = (format.selectionFlags & C.SELECTION_FLAG_DEFAULT) != 0;
            channelCount = format.channelCount;
            sampleRate = format.sampleRate;
            bitrate = format.bitrate;
            isWithinConstraints = (format.bitrate == Format.NO_VALUE
                    || format.bitrate <= parameters.maxAudioBitrate)
                    && (format.channelCount == Format.NO_VALUE
                            || format.channelCount <= parameters.maxAudioChannelCount);
            String[] localeLanguages = Utils.getSystemLanguageCodes();
        ...
        public int compareTo(AudioTrackScore other) {
            ...
            // If the formats are within constraints and renderer capabilities then prefer higher
            // values
            // of channel count, sample rate and bit rate in that order. Otherwise, prefer lower
            // values.
            ...
            if (Utils.areEqual(this.language, other.language)) {
    ...
    private static final class AudioConfigurationTuple {
        ...
        public AudioConfigurationTuple(int channelCount, int sampleRate,
    ...
    protected static final class TextTrackScore implements Comparable<TextTrackScore> {
        ...
        public TextTrackScore(Format format, Parameters parameters, int trackFormatSupport,
            ...
            preferredLanguageScore = getFormatLanguageScore(format,
                    parameters.preferredTextLanguage, parameters.selectUndeterminedTextLanguage);
            preferredRoleFlagsScore =
                    Integer.bitCount(format.roleFlags & parameters.preferredTextRoleFlags);
            hasCaptionRoleFlags = (format.roleFlags
                    & (C.ROLE_FLAG_CAPTION | C.ROLE_FLAG_DESCRIBES_MUSIC_AND_SOUND)) != 0;
            // Prefer non-forced to forced if a preferred text language has been matched. Where both
            // are
            // provided the non-forced track will usually contain the forced subtitles as a subset.
            // Otherwise, prefer a forced track.
            hasPreferredIsForcedFlag = (preferredLanguageScore > 0 && !isForced)
                    || (preferredLanguageScore == 0 && isForced);
            ...
            isWithinConstraints = preferredLanguageScore > 0
                    || (parameters.preferredTextLanguage == null && preferredRoleFlagsScore > 0)
                    || isDefault || (isForced && selectedAudioLanguageScore > 0);
        }
        ...
        public int compareTo(TextTrackScore other) {
            ...
            if (this.selectedAudioLanguageScore != other.selectedAudioLanguageScore) {
                return compareInts(this.selectedAudioLanguageScore,
                        other.selectedAudioLanguageScore);
            }
            if (preferredRoleFlagsScore == 0
                    && this.hasCaptionRoleFlags != other.hasCaptionRoleFlags) {
