...
import minefarts.smarttube.leanback.app.BrowseFragment;
import minefarts.smarttube.leanback.app.VerticalGridFragment;
...
public final class ProgressBarManager {
    ...
    public static void setup(minefarts.smarttube.leanback.app.ProgressBarManager manager, ViewGroup rootView) {
        if (rootView != null) {
