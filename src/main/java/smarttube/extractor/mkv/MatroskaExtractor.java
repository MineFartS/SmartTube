package minefarts.smarttube.extractor.mkv;
...
public class MatroskaExtractor implements Extractor {
   ...
   */
  private static final byte[] SSA_DIALOGUE_FORMAT = Utils.getUtf8Bytes("Format: Start, End, "
  ...
  private static void setSampleDuration(byte[] subripSampleData, long durationUs,
    ...
    if (durationUs == C.TIME_UNSET) {
      ...
      timeCodeData = Utils.getUtf8Bytes(String.format(Locale.US, timecodeFormat, hours, minutes,
          seconds, lastValue));
    }
  ...
  private long scaleTimecodeToUs(long unscaledTimecode) throws ParserException {
    ...
    return Utils.scaleLargeTimestamp(unscaledTimecode, timecodeScale, 1000);
  }
      ...
      switch (codecId) {
        ...
        case CODEC_ID_ACM:
          ...
          if (parseMsAcmCodecPrivate(new ParsableByteArray(codecPrivate))) {
            pcmEncoding = Utils.getPcmEncoding(audioBitDepth);
