...
import minefarts.smarttube.extractor.GaplessInfoHolder;
import minefarts.smarttube.metadata.Metadata;
import minefarts.smarttube.metadata.id3.ApicFrame;
import minefarts.smarttube.metadata.id3.CommentFrame;
...
/* package */ final class MetadataUtil {
  ...
  private static final int SHORT_TYPE_NAME_1 = Utils.getIntegerCodeForString("nam");
  private static final int SHORT_TYPE_NAME_2 = Utils.getIntegerCodeForString("trk");
  private static final int SHORT_TYPE_COMMENT = Utils.getIntegerCodeForString("cmt");
  private static final int SHORT_TYPE_YEAR = Utils.getIntegerCodeForString("day");
  private static final int SHORT_TYPE_ARTIST = Utils.getIntegerCodeForString("ART");
  private static final int SHORT_TYPE_ENCODER = Utils.getIntegerCodeForString("too");
  private static final int SHORT_TYPE_ALBUM = Utils.getIntegerCodeForString("alb");
  private static final int SHORT_TYPE_COMPOSER_1 = Utils.getIntegerCodeForString("com");
  private static final int SHORT_TYPE_COMPOSER_2 = Utils.getIntegerCodeForString("wrt");
  private static final int SHORT_TYPE_LYRICS = Utils.getIntegerCodeForString("lyr");
  private static final int SHORT_TYPE_GENRE = Utils.getIntegerCodeForString("gen");

  // Codes that have equivalent ID3 frames.
  private static final int TYPE_COVER_ART = Utils.getIntegerCodeForString("covr");
  private static final int TYPE_GENRE = Utils.getIntegerCodeForString("gnre");
  private static final int TYPE_GROUPING = Utils.getIntegerCodeForString("grp");
  private static final int TYPE_DISK_NUMBER = Utils.getIntegerCodeForString("disk");
  private static final int TYPE_TRACK_NUMBER = Utils.getIntegerCodeForString("trkn");
  private static final int TYPE_TEMPO = Utils.getIntegerCodeForString("tmpo");
  private static final int TYPE_COMPILATION = Utils.getIntegerCodeForString("cpil");
  private static final int TYPE_ALBUM_ARTIST = Utils.getIntegerCodeForString("aART");
  private static final int TYPE_SORT_TRACK_NAME = Utils.getIntegerCodeForString("sonm");
  private static final int TYPE_SORT_ALBUM = Utils.getIntegerCodeForString("soal");
  private static final int TYPE_SORT_ARTIST = Utils.getIntegerCodeForString("soar");
  private static final int TYPE_SORT_ALBUM_ARTIST = Utils.getIntegerCodeForString("soaa");
  private static final int TYPE_SORT_COMPOSER = Utils.getIntegerCodeForString("soco");

  // Types that do not have equivalent ID3 frames.
  private static final int TYPE_RATING = Utils.getIntegerCodeForString("rtng");
  private static final int TYPE_GAPLESS_ALBUM = Utils.getIntegerCodeForString("pgap");
