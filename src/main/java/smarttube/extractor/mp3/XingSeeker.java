...
/* package */ final class XingSeeker implements Seeker {
  ...
  public static @Nullable XingSeeker create(
    ...
    long durationUs = Utils.scaleLargeTimestamp(frameCount, samplesPerFrame * C.MICROS_PER_SECOND,
        sampleRate);
    if ((flags & 0x06) != 0x06) {
  ...
  public SeekPoints getSeekPoints(long timeUs) {
    ...
    timeUs = Utils.constrainValue(timeUs, 0, durationUs);
    ...
    positionOffset = Utils.constrainValue(positionOffset, xingFrameSize, dataSize - 1);
  ...
  public long getTimeUs(long position) {
    ...
    int prevTableIndex = Utils.binarySearchFloor(tableOfContents, (long) scaledPosition, true, true);
