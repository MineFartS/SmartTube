package minefarts.smarttube.extractor.mp3;
...
import minefarts.smarttube.extractor.Id3Peeker;
...
import minefarts.smarttube.extractor.mp3.Seeker.UnseekableSeeker;
import minefarts.smarttube.metadata.Metadata;
import minefarts.smarttube.metadata.id3.Id3Decoder;
import minefarts.smarttube.metadata.id3.Id3Decoder.FramePredicate;
import minefarts.smarttube.metadata.id3.MlltFrame;
...
public final class Mp3Extractor implements Extractor {
  ...
  private static final int SEEK_HEADER_XING = Utils.getIntegerCodeForString("Xing");
  private static final int SEEK_HEADER_INFO = Utils.getIntegerCodeForString("Info");
  private static final int SEEK_HEADER_VBRI = Utils.getIntegerCodeForString("VBRI");
