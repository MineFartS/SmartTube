...
import minefarts.smarttube.trackselection.BaseTrackSelection;
...
public final class DownloadHelper {
  ...
  public static DownloadHelper forDash(
    ...
    return new DownloadHelper(
        ...
        Utils.getRendererCapabilities(renderersFactory, drmSessionManager));
  }
  ...
  public DownloadHelper(
    ...
    callbackHandler = new Handler(Utils.getLooper());
  }
  ...
  private static final class MediaPreparer
    ...
    public MediaPreparer(MediaSource mediaSource, DownloadHelper downloadHelper) {
      ...
      Handler downloadThreadHandler = Utils.createHandler(this::handleDownloadHelperCallbackMessage);
      this.downloadHelperHandler = downloadThreadHandler;
      mediaSourceThread = new HandlerThread("DownloadHelper");
      mediaSourceThread.start();
      mediaSourceHandler = Utils.createHandler(mediaSourceThread.getLooper(), /* callback= */ this);
    ...
    private boolean handleDownloadHelperCallbackMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case DOWNLOAD_HELPER_CALLBACK_MESSAGE_FAILED:
          release();
          downloadHelper.onMediaPreparationFailed((IOException) Utils.castNonNull(msg.obj));
          return true;
        default:
          return false;
      }
