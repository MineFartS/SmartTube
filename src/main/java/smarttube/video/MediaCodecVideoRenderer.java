...
import minefarts.smarttube.mediacodec.MediaCodecUtil;
...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    private void setSurface(Surface surface) throws ExoPlaybackException {
        ...
        if (this.surface != surface) {
            ...
            MediaCodec codec = getCodec();
            if (codec != null) {
                if (Utils.SDK_INT >= 23 && surface != null) {
    ...
    private boolean shouldUseDummySurface(MediaCodecInfo codecInfo) {
        return Utils.SDK_INT >= 23 && !tunneling && (!codecInfo.secure || DummySurface.isSecureSupported(context));
    }
        ...
        for (int longEdgePx : STANDARD_LONG_EDGE_VIDEO_PX) {
            ...
            if (longEdgePx <= formatLongEdgePx || shortEdgePx <= formatShortEdgePx) {
                ...
                try {
                    ...
                    longEdgePx = Utils.ceilDivide(longEdgePx, 16) * 16;
                    shortEdgePx = Utils.ceilDivide(shortEdgePx, 16) * 16;
    ...
    private static int getCodecMaxInputSize(MediaCodecInfo codecInfo, String sampleMimeType,
        ...
        switch (sampleMimeType) {
            ...
            case MimeTypes.VIDEO_H264:
                if ("BRAVIA 4K 2015".equals(Utils.MODEL) // Sony Bravia 4K
                        || ("Amazon".equals(Utils.MANUFACTURER) && ("KFSOWI".equals(Utils.MODEL) // Kindle
                                                                                               // Soho
                                || ("AFTS".equals(Utils.MODEL) && codecInfo.secure)))) { // Fire TV
                                                                                        // Gen 2
                ...
                maxPixels = Utils.ceilDivide(width, 16) * Utils.ceilDivide(height, 16) * 16 * 16;
                minCompressionRatio = 2;
                break;
    ...
    private static boolean deviceNeedsNoPostProcessWorkaround() {
        ...
        return "NVIDIA".equals(Utils.MANUFACTURER);
    }
