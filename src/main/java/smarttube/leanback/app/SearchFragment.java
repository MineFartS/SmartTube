...
import minefarts.smarttube.leanback.widget.ObjectAdapter.DataObserver;
...
import minefarts.smarttube.leanback.widget.Presenter.ViewHolder;
...
public class SearchFragment extends Fragment {
        ...
        public void run() {
            ...
            if (DEBUG) {
                Log.v(TAG, "mAutoStartRecognition " + mAutoStartRecognition + " mResultAdapter "
                        + mResultAdapter + " adapter " + mRowsFragment.getAdapter());
            }
    ...
    public void onResume() {
        ...
        if (mSpeechRecognitionCallback == null && null == mSpeechRecognizer) {
            mSpeechRecognizer = SpeechRecognizer
                    .createSpeechRecognizer(FragmentUtil.getContext(SearchFragment.this));
    ...
    void updateFocus() {
        if (mResultAdapter != null && mResultAdapter.size() > 0 && mRowsFragment != null
