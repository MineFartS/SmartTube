package minefarts.smarttube.text.dvb;
...
/* package */ final class DvbParser {
  ...
  private static ClutDefinition parseClutDefinition(ParsableBitArray data, int length) {
    ...
    while (remainingLength > 0) {
      ...
      clutEntries[entryId] = getColor(a, Utils.constrainValue(r, 0, 255),
          Utils.constrainValue(g, 0, 255), Utils.constrainValue(b, 0, 255));
    }
