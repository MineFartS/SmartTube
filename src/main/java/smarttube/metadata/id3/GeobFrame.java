...
public final class GeobFrame extends Id3Frame {
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    return Utils.areEqual(mimeType, other.mimeType) && Utils.areEqual(filename, other.filename)
        && Utils.areEqual(description, other.description) && Arrays.equals(data, other.data);
  }
