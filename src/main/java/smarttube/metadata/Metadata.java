...
public final class Metadata implements Parcelable {
    ...
    public interface Entry extends Parcelable {
        ...
        /**
         * Returns the {@link Format} that can be used to decode the wrapped metadata in
         * {@link #getWrappedMetadataBytes()}, or null if this Entry doesn't contain wrapped
         * metadata.
         */
        @Nullable
     ...
     *
     * @param other The metadata that holds the entries to append. If null, this methods returns
     *        this instance.
    ...
    public Metadata copyWithAppendedEntries(Entry... entriesToAppend) {
        @NullableType
        Entry[] merged = Arrays.copyOf(entries, entries.length + entriesToAppend.length);
        System.arraycopy(entriesToAppend, 0, merged, entries.length, entriesToAppend.length);
        return new Metadata(Utils.castNonNullTypeArray(merged));
    }
