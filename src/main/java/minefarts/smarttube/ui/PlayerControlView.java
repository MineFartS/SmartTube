...
public class PlayerControlView extends FrameLayout {
  ...
  private minefarts.smarttube.ControlDispatcher controlDispatcher;
  ...
  public PlayerControlView(
    ...
    controlDispatcher = new minefarts.smarttube.DefaultControlDispatcher();
  ...
  /**
   * Sets the {@link minefarts.smarttube.ControlDispatcher}.
   *
   * @param controlDispatcher The {@link minefarts.smarttube.ControlDispatcher}, or null
   *     to use {@link minefarts.smarttube.DefaultControlDispatcher}.
   */
  public void setControlDispatcher(
      @Nullable minefarts.smarttube.ControlDispatcher controlDispatcher) {
    this.controlDispatcher =
        controlDispatcher == null
            ? new minefarts.smarttube.DefaultControlDispatcher()
            : controlDispatcher;
  }
  ...
  public void setTimeBarMinUpdateInterval(int minUpdateIntervalMs) {
    ...
    timeBarMinUpdateIntervalMs =
        Utils.constrainValue(minUpdateIntervalMs, 16, MAX_UPDATE_INTERVAL_MS);
  }
  ...
  private void updateTimeline() {
    ...
    if (durationView != null) {
      durationView.setText(Utils.getStringForTime(formatBuilder, formatter, durationMs));
    }
    if (timeBar != null) {
  ...
  private void updateProgress() {
    ...
    if (positionView != null && !scrubbing) {
      positionView.setText(Utils.getStringForTime(formatBuilder, formatter, position));
    }
    if (timeBar != null) {
    ...
    if (player != null && player.isPlaying()) {
      ...
      delayMs = Utils.constrainValue(delayMs, timeBarMinUpdateIntervalMs, MAX_UPDATE_INTERVAL_MS);
