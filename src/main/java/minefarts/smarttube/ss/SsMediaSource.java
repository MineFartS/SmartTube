package minefarts.smarttube.ss;
...
public final class SsMediaSource extends BaseMediaSource
    ...
    public static final class Factory {
         ...
         *        {@link #createMediaSource(SsManifest, Handler, MediaSourceEventListener)}.
         */
        ...
        /**
         * Sets a tag for the media source which will be published in the {@link Timeline} of the
         * source as {@link Timeline.Window#tag}.
         *
         ...
         * end of the live window for live playbacks. The default value is
        ...
        /**
         * Returns a new {@link SsMediaSource} using the current parameters and the specified
         * sideloaded manifest.
         *
        ...
        public SsMediaSource createMediaSource(SsManifest manifest) {
            ...
            return new SsMediaSource(manifest, /* manifestUri= */ null,
                    ...
                    livePresentationDelayMs, tag);
        }

        /**
         * @deprecated Use {@link #createMediaSource(SsManifest)} and
         *             {@link #addEventListener(Handler, MediaSourceEventListener)} instead.
         */
        @Deprecated
        public SsMediaSource createMediaSource(SsManifest manifest, @Nullable Handler eventHandler,
        ...
        public SsMediaSource createMediaSource(Uri manifestUri) {
            ...
            return new SsMediaSource(/* manifest= */ null, Assertions.checkNotNull(manifestUri),
         ...
         */
        @Deprecated
        public SsMediaSource createMediaSource(Uri manifestUri, @Nullable Handler eventHandler,
                @Nullable MediaSourceEventListener eventListener) {
    ...
    public SsMediaSource(SsManifest manifest, SsChunkSource.Factory chunkSourceFactory,
        ...
        this(manifest, /* manifestUri= */ null, /* manifestDataSourceFactory= */ null,
                ...
                new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount),
                DEFAULT_LIVE_PRESENTATION_DELAY_MS, /* tag= */ null);
        if (eventHandler != null && eventListener != null) {
    ...
    public SsMediaSource(Uri manifestUri, DataSource.Factory manifestDataSourceFactory,
        ...
        this(/* manifest= */ null, manifestUri, manifestDataSourceFactory, manifestParser,
                ...
                new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount), livePresentationDelayMs,
                /* tag= */ null);
        if (eventHandler != null && eventListener != null) {
            addEventListener(eventHandler, eventListener);
        }
    ...
    public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
        ...
        SsMediaPeriod period = new SsMediaPeriod(manifest, chunkSourceFactory,
                mediaTransferListener, compositeSequenceableLoaderFactory, loadErrorHandlingPolicy,
    ...
    @Override
    public LoadErrorAction onLoadError(ParsingLoadable<SsManifest> loadable, long elapsedRealtimeMs,
    ...
    private void processManifest() {
        ...
        if (startTimeUs == Long.MAX_VALUE) {
            ...
            timeline = new SinglePeriodTimeline(periodDurationUs, /* windowDurationUs= */ 0,
                    /* windowPositionInPeriodUs= */ 0, /* windowDefaultStartPositionUs= */ 0,
                    /* isSeekable= */ true, manifest.isLive, tag);
            ...
            if (defaultStartPositionUs < MIN_LIVE_DEFAULT_START_POSITION_US) {
                ...
                defaultStartPositionUs =
                        Math.min(MIN_LIVE_DEFAULT_START_POSITION_US, durationUs / 2);
            }
            timeline = new SinglePeriodTimeline(/* periodDurationUs= */ C.TIME_UNSET, durationUs,
                    startTimeUs, defaultStartPositionUs, /* isSeekable= */ true,
                    /* isDynamic= */ true, tag);
        } else {
            long durationUs = manifest.durationUs != C.TIME_UNSET ? manifest.durationUs
                    : endTimeUs - startTimeUs;
            timeline = new SinglePeriodTimeline(startTimeUs + durationUs, durationUs, startTimeUs,
                    /* windowDefaultStartPositionUs= */ 0, /* isSeekable= */ true,
                    /* isDynamic= */ false, tag);
        }
