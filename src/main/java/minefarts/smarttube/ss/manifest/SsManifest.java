...
public class SsManifest implements FilterableManifest<SsManifest> {
  ...
  public static class StreamElement {
    ...
    public StreamElement(String baseUri, String chunkTemplate, int type, String subType,
      ...
      this(
          ...
          formats,
          chunkStartTimes,
          Utils.scaleLargeTimestamps(chunkStartTimes, C.MICROS_PER_SECOND, timescale),
          Utils.scaleLargeTimestamp(lastChunkDuration, C.MICROS_PER_SECOND, timescale));
    }
    ...
    public int getChunkIndex(long timeUs) {
      return Utils.binarySearchFloor(chunkStartTimesUs, timeUs, true, true);
    }
  ...
  public SsManifest(
    ...
    this(
        ...
        duration == 0
            ? C.TIME_UNSET
            : Utils.scaleLargeTimestamp(duration, C.MICROS_PER_SECOND, timescale),
        dvrWindowLength == 0
            ? C.TIME_UNSET
            : Utils.scaleLargeTimestamp(dvrWindowLength, C.MICROS_PER_SECOND, timescale),
        lookAheadCount,
        isLive,
        protectionElement,
        streamElements);
