...
public final class VideoFrameReleaseTimeHelper {
    ...
    public VideoFrameReleaseTimeHelper(@Nullable Context context) {
        ...
        if (windowManager != null) {
            displayListener =
                    Utils.SDK_INT >= 17 ? maybeBuildDefaultDisplayListenerV17(context) : null;
    ...
    public long adjustReleaseTime(long framePresentationTimeUs, long unadjustedReleaseTimeNs) {
        ...
        if (haveSync) {
            ...
            if (frameCount >= MIN_FRAMES_FOR_ADJUSTMENT) {
                ...
                // adjustment.
                // Calculate the average frame time across all the frames we've seen since the last
                // sync.
                // This will typically give us a frame rate at a finer granularity than the frame
                // times
                ...
                // We're synced but haven't waited the required number of frames to apply an
                // adjustment.
                // Check drift anyway.
        ...
        long snappedTimeNs =
                closestVsync(adjustedReleaseTimeNs, sampledVsyncTimeNs, vsyncDurationNs);
    ...
    private static final class VSyncSampler implements FrameCallback, Handler.Callback {
        ...
        private VSyncSampler() {
            ...
            handler =
                    Utils.createHandler(choreographerOwnerThread.getLooper(), /* callback= */ this);
