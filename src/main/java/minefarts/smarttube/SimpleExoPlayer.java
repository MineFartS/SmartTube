...
import minefarts.smarttube.drm.DefaultDrmSessionManager;
...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, Player.AudioComponent,
    ...
    public void setAudioAttributes(AudioAttributes audioAttributes, boolean handleAudioFocus) {
        verifyApplicationThread();
        if (!Utils.areEqual(this.audioAttributes, audioAttributes)) {
    ...
    public void setAudioStreamType(@C.StreamType int streamType) {
        @C.AudioUsage
        int usage = Utils.getAudioUsageForStreamType(streamType);
        @C.AudioContentType
        int contentType = Utils.getAudioContentTypeForStreamType(streamType);
