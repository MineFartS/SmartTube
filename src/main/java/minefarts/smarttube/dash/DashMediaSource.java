...
import minefarts.smarttube.source.BaseMediaSource;
import minefarts.smarttube.source.CompositeSequenceableLoaderFactory;
import minefarts.smarttube.source.DefaultCompositeSequenceableLoaderFactory;
...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory {
         ...
         *
         * @param dataSourceFactory A factory for {@link DataSource} instances that will be used to
         *        load manifest and media data.
         */
         ...
         * @param manifestDataSourceFactory A factory for {@link DataSource} instances that will be
         *        used to load (and refresh) the manifest. May be {@code null} if the factory will
         *        only ever be used to create create media sources with sideloaded manifests via
         *        {@link #createMediaSource(DashManifest, Handler, MediaSourceEventListener)}.
         */
        public Factory(DashChunkSource.Factory chunkSourceFactory,
         ...
         * {@link minefarts.smarttube.Timeline} of the source as
         * {@link minefarts.smarttube.Timeline.Window#tag}.
         *
         * @param tag A tag for the media source.
         * @return This factory, for convenience.
         * @throws IllegalStateException If one of the {@code create} methods has already been
         *         called.
         */
        ...
        /**
         * Sets the minimum number of times to retry if a loading error occurs. See
         * {@link #setLoadErrorHandlingPolicy} for the default value.
         *
         * <p>
         ...
         *
         * @param minLoadableRetryCount The minimum number of times to retry if a loading error
         *        occurs.
         * @return This factory, for convenience.
         * @throws IllegalStateException If one of the {@code create} methods has already been
         *         called.
        ...
        public Factory setMinLoadableRetryCount(int minLoadableRetryCount) {
            return setLoadErrorHandlingPolicy(
                    new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount));
        }

        /**
         * Sets the {@link LoadErrorHandlingPolicy}. The default value is created by calling
         * {@link DefaultLoadErrorHandlingPolicy#DefaultLoadErrorHandlingPolicy()}.
         *
         * <p>
        ...
        /**
         * Sets the duration in milliseconds by which the default start position should precede the
         * end of the live window for live playbacks. The {@code overridesManifest} parameter
         * specifies whether the value is used in preference to one in the manifest, if present. The
         * default value is {@link #DEFAULT_LIVE_PRESENTATION_DELAY_MS}, and by default
         * {@code overridesManifest} is false.
         *
         * @param livePresentationDelayMs For live playbacks, the duration in milliseconds by which
         *        the default start position should precede the end of the live window.
         * @param overridesManifest Whether the value is used in preference to one in the manifest,
         *        if present.
         * @return This factory, for convenience.
         * @throws IllegalStateException If one of the {@code create} methods has already been
         *         called.
        ...
        /**
         * Sets the factory to create composite {@link SequenceableLoader}s for when this media
         * source loads data from multiple streams (video, audio etc...). The default is an instance
         * of {@link DefaultCompositeSequenceableLoaderFactory}.
         *
         * @param compositeSequenceableLoaderFactory A factory to create composite
         *        {@link SequenceableLoader}s for when this media source loads data from multiple
        ...
        public DashMediaSource createMediaSource(DashManifest manifest) {
            ...
            return new DashMediaSource(manifest, /* manifestUri= */ null,
                    /* manifestDataSourceFactory= */ null, /* manifestParser= */ null,
                    chunkSourceFactory, compositeSequenceableLoaderFactory, loadErrorHandlingPolicy,
                    livePresentationDelayMs, livePresentationDelayOverridesManifest, tag);
        }

        /**
         * @deprecated Use {@link #createMediaSource(DashManifest)} and
         *             {@link #addEventListener(Handler, MediaSourceEventListener)} instead.
         */
        @Deprecated
        public DashMediaSource createMediaSource(DashManifest manifest,
                @Nullable Handler eventHandler, @Nullable MediaSourceEventListener eventListener) {
        ...
        public DashMediaSource createMediaSource(Uri manifestUri) {
            ...
            return new DashMediaSource(/* manifest= */ null, Assertions.checkNotNull(manifestUri),
                    manifestDataSourceFactory, manifestParser, chunkSourceFactory,
                    compositeSequenceableLoaderFactory, loadErrorHandlingPolicy,
                    livePresentationDelayMs, livePresentationDelayOverridesManifest, tag);
        }

        /**
         * @deprecated Use {@link #createMediaSource(Uri)} and
         *             {@link #addEventListener(Handler, MediaSourceEventListener)} instead.
         */
        @Deprecated
        public DashMediaSource createMediaSource(Uri manifestUri, @Nullable Handler eventHandler,
     ...
     * {@link SourceInfoRefreshListener#onSourceInfoRefreshed(MediaSource, Timeline, Object)} when
     * the source's {@link Timeline} is changing dynamically (for example, for incomplete live
     * streams).
     */
    private static final int NOTIFY_MANIFEST_INTERVAL_MS = 5000;
    /**
     * The minimum default start position for live streams, relative to the start of the live
     * window.
     */
    ...
    public DashMediaSource(DashManifest manifest, DashChunkSource.Factory chunkSourceFactory,
        ...
        this(manifest, chunkSourceFactory,
                DefaultLoadErrorHandlingPolicy.DEFAULT_MIN_LOADABLE_RETRY_COUNT, eventHandler,
                eventListener);
    }
    ...
    public DashMediaSource(DashManifest manifest, DashChunkSource.Factory chunkSourceFactory,
        ...
        this(manifest, /* manifestUri= */ null, /* manifestDataSourceFactory= */ null,
                /* manifestParser= */ null, chunkSourceFactory,
                new DefaultCompositeSequenceableLoaderFactory(),
                new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount),
                DEFAULT_LIVE_PRESENTATION_DELAY_MS,
                /* livePresentationDelayOverridesManifest= */ false, /* tag= */ null);
        if (eventHandler != null && eventListener != null) {
     ...
     *        {@link #DEFAULT_LIVE_PRESENTATION_DELAY_PREFER_MANIFEST_MS} to use the value specified
     *        by the manifest, if present.
     * @param eventHandler A handler for events. May be null if delivery of events is not required.
     * @param eventListener A listener of events. May be null if delivery of events is not required.
     * @deprecated Use {@link Factory} instead.
     */
    ...
    public DashMediaSource(Uri manifestUri, DataSource.Factory manifestDataSourceFactory,
            ...
            long livePresentationDelayMs, Handler eventHandler,
            MediaSourceEventListener eventListener) {
        this(/* manifest= */ null, manifestUri, manifestDataSourceFactory, manifestParser,
                chunkSourceFactory, new DefaultCompositeSequenceableLoaderFactory(),
                new DefaultLoadErrorHandlingPolicy(minLoadableRetryCount),
    ...
    private DashMediaSource(DashManifest manifest, Uri manifestUri,
            ...
            CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory,
            LoadErrorHandlingPolicy loadErrorHandlingPolicy, long livePresentationDelayMs,
            boolean livePresentationDelayOverridesManifest, @Nullable Object tag) {
    ...
    public MediaPeriod createPeriod(MediaPeriodId periodId, Allocator allocator,
        ...
        DashMediaPeriod mediaPeriod = new DashMediaPeriod(firstPeriodId + periodIndex, manifest,
                periodIndex, chunkSourceFactory, mediaTransferListener, loadErrorHandlingPolicy,
                periodEventDispatcher, elapsedRealtimeOffsetMs, manifestLoadErrorThrower, allocator,
                compositeSequenceableLoaderFactory, playerEmsgCallback);
    ...
    /* package */ void onManifestLoadCompleted(ParsingLoadable<DashManifest> loadable,
        ...
        manifestEventDispatcher.loadCompleted(loadable.dataSpec, loadable.getUri(),
                loadable.getResponseHeaders(), loadable.type, elapsedRealtimeMs, loadDurationMs,
        ...
        if (newManifest.dynamic) {
            ...
            if (oldPeriodCount - removedPeriodCount > newManifest.getPeriodCount()) {
                // After discarding old periods, we should never have more periods than listed in
                // the new
                // manifest. That would mean that a previously announced period is no longer
                // advertised. If
                // this condition occurs, assume that we are hitting a manifest server that is out
                // of sync
                // and
                // behind.
                ...
                // If we receive a dynamic manifest that's older than expected (i.e. its publish
                // time has
                // expired, or it's dynamic and we know the presentation has ended), then this
                // manifest is
                // stale.
                Log.w(TAG, "Loaded stale dynamic manifest: " + newManifest.publishTimeMs + ", "
                        + expiredManifestPublishTimeUs);
                isManifestStale = true;
            }

            if (isManifestStale) {
                if (staleManifestReloadAttempt++ < loadErrorHandlingPolicy
                        .getMinimumLoadableRetryCount(loadable.type)) {
        ...
        if (manifest.location != null) {
            synchronized (manifestUriLock) {
                // This condition checks that replaceManifestUri wasn't called between the start and
                // end of
                // this load. If it was, we ignore the manifest location and prefer the manual
                // replacement.
    ...
    /* package */ LoadErrorAction onManifestLoadError(ParsingLoadable<DashManifest> loadable,
            long elapsedRealtimeMs, long loadDurationMs, IOException error, int errorCount) {
        long retryDelayMs = loadErrorHandlingPolicy.getRetryDelayMsFor(C.DATA_TYPE_MANIFEST,
                loadDurationMs, error, errorCount);
        LoadErrorAction loadErrorAction = retryDelayMs == C.TIME_UNSET ? Loader.DONT_RETRY_FATAL
                : Loader.createRetryAction(/* resetErrorCount= */ false, retryDelayMs);
        manifestEventDispatcher.loadError(loadable.dataSpec, loadable.getUri(),
                loadable.getResponseHeaders(), loadable.type, elapsedRealtimeMs, loadDurationMs,
                loadable.bytesLoaded(), error, !loadErrorAction.isRetry());
    ...
    /* package */ LoadErrorAction onUtcTimestampLoadError(ParsingLoadable<Long> loadable,
    ...
    /* package */ void onLoadCanceled(ParsingLoadable<?> loadable, long elapsedRealtimeMs,
            long loadDurationMs) {
        manifestEventDispatcher.loadCanceled(loadable.dataSpec, loadable.getUri(),
                loadable.getResponseHeaders(), loadable.type, elapsedRealtimeMs, loadDurationMs,
                loadable.bytesLoaded());
    }
    ...
    private void resolveUtcTimingElement(UtcTimingElement timingElement) {
        ...
        if (Utils.areEqual(scheme, "urn:mpeg:dash:utc:direct:2014")
                || Utils.areEqual(scheme, "urn:mpeg:dash:utc:direct:2012")) {
            resolveUtcTimingElementDirect(timingElement);
        } else if (Utils.areEqual(scheme, "urn:mpeg:dash:utc:http-iso:2014")
                || Utils.areEqual(scheme, "urn:mpeg:dash:utc:http-iso:2012")) {
            resolveUtcTimingElementHttp(timingElement, new Iso8601Parser());
        } else if (Utils.areEqual(scheme, "urn:mpeg:dash:utc:http-xsdate:2014")
                || Utils.areEqual(scheme, "urn:mpeg:dash:utc:http-xsdate:2012")) {
    ...
    private void resolveUtcTimingElementDirect(UtcTimingElement timingElement) {
        try {
            long utcTimestampMs = Utils.parseXsDateTime(timingElement.value);
    ...
    private void processManifest(boolean scheduleRefresh) {
        ...
        PeriodSeekInfo firstPeriodSeekInfo = PeriodSeekInfo
                .createPeriodSeekInfo(manifest.getPeriod(0), manifest.getPeriodDurationUs(0));
        ...
        if (manifest.dynamic && !lastPeriodSeekInfo.isIndexExplicit) {
            // The manifest describes an incomplete live stream. Update the start/end times to
            // reflect the
            // live stream duration and the manifest's time shift buffer depth.
            long liveStreamDurationUs =
                    getNowUnixTimeUs() - C.msToUs(manifest.availabilityStartTimeMs);
        ...
        if (manifest.dynamic) {
            ...
            if (windowDefaultStartPositionUs < MIN_LIVE_DEFAULT_START_POSITION_US) {
                // The default start position is too close to the start of the live window. Set it
                // to the
                // minimum default start position provided the window is at least twice as big. Else
                // set
        ...
        long windowStartTimeMs = manifest.availabilityStartTimeMs + manifest.getPeriod(0).startMs
                + C.usToMs(currentStartTimeUs);
        DashTimeline timeline = new DashTimeline(manifest.availabilityStartTimeMs,
                windowStartTimeMs, firstPeriodId, currentStartTimeUs, windowDurationUs,
                windowDefaultStartPositionUs, manifest, tag);
        ...
        if (!sideloadedManifest) {
            ...
            if (manifestLoadPending) {
                ...
                if (minUpdatePeriodMs == 0) {
                    ...
                    // cases where
                    // minimumUpdatePeriod is set to 0. In such cases we shouldn't refresh unless
                    // there is
    ...
    private void startLoadingManifest() {
        ...
        manifestLoadPending = false;
        startLoading(
                new ParsingLoadable<>(dataSource, manifestUri, C.DATA_TYPE_MANIFEST,
                        manifestParser),
                manifestCallback,
    ...
    private static final class PeriodSeekInfo {
        ...
        public static PeriodSeekInfo createPeriodSeekInfo(
                minefarts.smarttube.dash.manifest.Period period, long durationUs) {
            ...
            for (int i = 0; i < adaptationSetCount; i++) {
                ...
                // Exclude text adaptation sets from duration calculations, if we have at least one
                // audio
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public DashTimeline(long presentationStartTimeMs, long windowStartTimeMs, int firstPeriodId,
                long offsetInFirstPeriodUs, long windowDurationUs,
        ...
        @Override
        public Window getWindow(int windowIndex, Window window, boolean setTag,
                long defaultPositionProjectionUs) {
            Assertions.checkIndex(windowIndex, 0, 1);
            long windowDefaultStartPositionUs =
                    getAdjustedWindowDefaultStartPositionUs(defaultPositionProjectionUs);
            Object tag = setTag ? windowTag : null;
            boolean isDynamic = manifest.dynamic && manifest.minUpdatePeriodMs != C.TIME_UNSET
                    && manifest.durationMs == C.TIME_UNSET;
            return window.set(tag, presentationStartTimeMs, windowStartTimeMs,
                    /* isSeekable= */ true, isDynamic, windowDefaultStartPositionUs,
                    windowDurationUs, /* firstPeriodIndex= */ 0,
                    /* lastPeriodIndex= */ getPeriodCount() - 1, offsetInFirstPeriodUs);
        }
        ...
        private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
            ...
            minefarts.smarttube.dash.manifest.Period period =
            ...
            // If there are multiple video adaptation sets with unaligned segments, the initial time
            // may
            // not correspond to the start of a segment in both, but this is an edge case.
            DashSegmentIndex snapIndex =
                    period.adaptationSets.get(videoAdaptationSetIndex).representations.get(0)
                            .getIndex();
    ...
    private final class ManifestCallback implements Loader.Callback<ParsingLoadable<DashManifest>> {
        ...
        @Override
        public void onLoadCompleted(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs,
                long loadDurationMs) {
            onManifestLoadCompleted(loadable, elapsedRealtimeMs, loadDurationMs);
        }

        @Override
        public void onLoadCanceled(ParsingLoadable<DashManifest> loadable, long elapsedRealtimeMs,
                long loadDurationMs, boolean released) {
            DashMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
        }

        @Override
        public LoadErrorAction onLoadError(ParsingLoadable<DashManifest> loadable,
                long elapsedRealtimeMs, long loadDurationMs, IOException error, int errorCount) {
    ...
    private final class UtcTimestampCallback implements Loader.Callback<ParsingLoadable<Long>> {
        ...
        @Override
        public LoadErrorAction onLoadError(ParsingLoadable<Long> loadable, long elapsedRealtimeMs,
                long loadDurationMs, IOException error, int errorCount) {
    ...
    private static final class XsDateTimeParser implements ParsingLoadable.Parser<Long> {
        ...
        public Long parse(Uri uri, InputStream inputStream) throws IOException {
            ...
            return Utils.parseXsDateTime(firstLine);
        }
    ...
    /* package */ static final class Iso8601Parser implements ParsingLoadable.Parser<Long> {
        ...
        public Long parse(Uri uri, InputStream inputStream) throws IOException {
            String firstLine = new BufferedReader(
                    new InputStreamReader(inputStream, Charset.forName(C.UTF8_NAME))).readLine();
            try {
                ...
                if ("Z".equals(timezone)) {
                    ...
                    long minutes =
                            TextUtils.isEmpty(minutesString) ? 0 : Long.parseLong(minutesString);
