...
import minefarts.smarttube.extractor.rawcc.RawCcExtractor;
import minefarts.smarttube.source.BehindLiveWindowException;
import minefarts.smarttube.source.chunk.BaseMediaChunkIterator;
import minefarts.smarttube.source.chunk.Chunk;
import minefarts.smarttube.source.chunk.ChunkExtractorWrapper;
import minefarts.smarttube.source.chunk.ChunkHolder;
import minefarts.smarttube.source.chunk.ContainerMediaChunk;
import minefarts.smarttube.source.chunk.InitializationChunk;
import minefarts.smarttube.source.chunk.MediaChunk;
import minefarts.smarttube.source.chunk.MediaChunkIterator;
import minefarts.smarttube.source.chunk.SingleSampleMediaChunk;
import minefarts.smarttube.dash.PlayerEmsgHandler.PlayerTrackEmsgHandler;
import minefarts.smarttube.dash.manifest.AdaptationSet;
import minefarts.smarttube.dash.manifest.DashManifest;
import minefarts.smarttube.dash.manifest.RangedUri;
import minefarts.smarttube.dash.manifest.Representation;
      ...
      if (representationHolder.segmentIndex != null) {
        ...
        long secondSyncUs =
            firstSyncUs < positionUs && segmentNum < representationHolder.getSegmentCount() - 1
                ...
                : firstSyncUs;
        return Utils.resolveSeekPositionUs(positionUs, seekParameters, firstSyncUs, secondSyncUs);
      }
    }
