...
import minefarts.smarttube.source.EmptySampleStream;
...
import minefarts.smarttube.source.chunk.ChunkSampleStream;
import minefarts.smarttube.source.chunk.ChunkSampleStream.EmbeddedSampleStream;
...
import minefarts.smarttube.dash.manifest.Descriptor;
import minefarts.smarttube.dash.manifest.EventStream;
  ...
  private static int[][] getGroupedAdaptationSetIndices(List<AdaptationSet> adaptationSets) {
    ...
    for (int i = 0; i < adaptationSetCount; i++) {
      ...
      if (adaptationSetSwitchingProperty == null) {
        ...
        String[] extraAdaptationSetIds = Utils.split(adaptationSetSwitchingProperty.value, ",");
    ...
    for (int i : adaptationSetIndices) {
      ...
      for (int j = 0; j < descriptors.size(); j++) {
        ...
        if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri)) {
          ...
          String[] services = Utils.split(value, ";");
