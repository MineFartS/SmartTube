...
public abstract class SegmentBase {
  ...
  public long getPresentationTimeOffsetUs() {
    return Utils.scaleLargeTimestamp(presentationTimeOffset, C.MICROS_PER_SECOND, timescale);
  }
  ...
  public abstract static class MultiSegmentBase extends SegmentBase {
    ...
    public final long getSegmentTimeUs(long sequenceNumber) {
      ...
      return Utils.scaleLargeTimestamp(unscaledSegmentTime, C.MICROS_PER_SECOND, timescale);
    }
  ...
  public static class SegmentTemplate extends MultiSegmentBase {
    ...
    public int getSegmentCount(long periodDurationUs) {
      if (segmentTimeline != null) {
        ...
        long durationUs = (duration * C.MICROS_PER_SECOND) / timescale;
        return (int) Utils.ceilDivide(periodDurationUs, durationUs);
      } else {
