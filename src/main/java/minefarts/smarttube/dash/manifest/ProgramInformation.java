...
public class ProgramInformation {
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    return Utils.areEqual(this.title, other.title)
        && Utils.areEqual(this.source, other.source)
        && Utils.areEqual(this.copyright, other.copyright)
        && Utils.areEqual(this.moreInformationURL, other.moreInformationURL)
        && Utils.areEqual(this.lang, other.lang);
  }
