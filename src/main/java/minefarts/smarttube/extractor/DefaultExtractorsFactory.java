...
import minefarts.smarttube.extractor.amr.AmrExtractor;
import minefarts.smarttube.extractor.flv.FlvExtractor;
import minefarts.smarttube.extractor.mkv.MatroskaExtractor;
import minefarts.smarttube.extractor.mp3.Mp3Extractor;
import minefarts.smarttube.extractor.mp4.FragmentedMp4Extractor;
import minefarts.smarttube.extractor.mp4.Mp4Extractor;
import minefarts.smarttube.extractor.ogg.OggExtractor;
import minefarts.smarttube.extractor.ts.Ac3Extractor;
import minefarts.smarttube.extractor.ts.Ac4Extractor;
import minefarts.smarttube.extractor.ts.AdtsExtractor;
import minefarts.smarttube.extractor.ts.DefaultTsPayloadReaderFactory;
import minefarts.smarttube.extractor.ts.PsExtractor;
import minefarts.smarttube.extractor.ts.TsExtractor;
import minefarts.smarttube.extractor.ts.TsPayloadReader;
import minefarts.smarttube.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      ...
      flacExtractorConstructor =
          Class.forName("minefarts.smarttube.ext.flac.FlacExtractor")
