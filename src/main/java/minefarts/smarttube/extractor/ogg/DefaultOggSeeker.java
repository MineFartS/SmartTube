...
/* package */ final class DefaultOggSeeker implements OggSeeker {
  ...
  public void startSeek(long targetGranule) {
    this.targetGranule = Utils.constrainValue(targetGranule, 0, totalGranules - 1);
    state = STATE_SEEK;
  ...
  private long getNextSeekPosition(ExtractorInput input) throws IOException, InterruptedException {
    ...
    return Utils.constrainValue(nextPosition, start, end - 1);
  }
    ...
    public SeekPoints getSeekPoints(long timeUs) {
      ...
      long estimatedPosition =
          payloadStartPosition
              ...
              - DEFAULT_OFFSET;
      estimatedPosition =
          Utils.constrainValue(estimatedPosition, payloadStartPosition, payloadEndPosition - 1);
