...
import minefarts.smarttube.utils.FlacStreamMetadata;
...
/* package */ final class FlacReader extends StreamReader {
  ...
  private class FlacOggSeeker implements OggSeeker, SeekMap {
    ...
    public void startSeek(long targetGranule) {
      int index = Utils.binarySearchFloor(seekPointGranules, targetGranule, true, true);
    ...
    public SeekPoints getSeekPoints(long timeUs) {
      ...
      int index = Utils.binarySearchFloor(seekPointGranules, granule, true, true);
