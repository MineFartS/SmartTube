...
/* package */ final class VbriSeeker implements Seeker {
  ...
  public static @Nullable VbriSeeker create(
    ...
    long durationUs = Utils.scaleLargeTimestamp(numFrames,
  ...
  public SeekPoints getSeekPoints(long timeUs) {
    int tableIndex = Utils.binarySearchFloor(timesUs, timeUs, true, true);
  ...
  public long getTimeUs(long position) {
    return timesUs[Utils.binarySearchFloor(positions, position, true, true)];
  }
