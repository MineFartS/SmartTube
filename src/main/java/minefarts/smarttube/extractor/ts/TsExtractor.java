...
import static minefarts.smarttube.extractor.ts.TsPayloadReader.FLAG_PAYLOAD_UNIT_START_INDICATOR;
...
import minefarts.smarttube.extractor.ts.DefaultTsPayloadReaderFactory.Flags;
import minefarts.smarttube.extractor.ts.TsPayloadReader.DvbSubtitleInfo;
import minefarts.smarttube.extractor.ts.TsPayloadReader.EsInfo;
...
public final class TsExtractor implements Extractor {
  ...
  private static final long AC3_FORMAT_IDENTIFIER = Utils.getIntegerCodeForString("AC-3");
  private static final long E_AC3_FORMAT_IDENTIFIER = Utils.getIntegerCodeForString("EAC3");
  private static final long AC4_FORMAT_IDENTIFIER = Utils.getIntegerCodeForString("AC-4");
  private static final long HEVC_FORMAT_IDENTIFIER = Utils.getIntegerCodeForString("HEVC");
  ...
  private class PmtReader implements SectionPayloadReader {
    ...
    public void consume(ParsableByteArray sectionData) {
      ...
      if (mode == MODE_HLS && id3Reader == null) {
        ...
        EsInfo dummyEsInfo = new EsInfo(TS_STREAM_TYPE_ID3, null, null, Utils.EMPTY_BYTE_ARRAY);
