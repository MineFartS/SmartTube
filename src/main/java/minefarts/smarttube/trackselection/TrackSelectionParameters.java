...
public class TrackSelectionParameters implements Parcelable {
  ...
  /* package */ TrackSelectionParameters(
      ...
      @C.SelectionFlags int disabledTextTrackSelectionFlags) {
    // Audio
    this.preferredAudioLanguage = Utils.normalizeLanguageCode(preferredAudioLanguage);
    // Text
    this.preferredTextLanguage = Utils.normalizeLanguageCode(preferredTextLanguage);
    this.preferredTextRoleFlags = preferredTextRoleFlags;
    this.selectUndeterminedTextLanguage = selectUndeterminedTextLanguage;
    this.disabledTextTrackSelectionFlags = disabledTextTrackSelectionFlags;
  }
  ...
  /* package */ TrackSelectionParameters(Parcel in) {
    ...
    this.selectUndeterminedTextLanguage = Utils.readBoolean(in);
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    Utils.writeBoolean(dest, selectUndeterminedTextLanguage);
