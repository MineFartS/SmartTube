...
public final class Mp4WebvttDecoder extends SimpleSubtitleDecoder {
  ...
  private static final int TYPE_payl = Utils.getIntegerCodeForString("payl");
  private static final int TYPE_sttg = Utils.getIntegerCodeForString("sttg");
  private static final int TYPE_vttc = Utils.getIntegerCodeForString("vttc");
  ...
  private static Cue parseVttCueBox(ParsableByteArray sampleData, WebvttCue.Builder builder,
    ...
    while (remainingCueBoxBytes > 0) {
      ...
      String boxPayload =
          Utils.fromUtf8Bytes(sampleData.data, sampleData.getPosition(), payloadLength);
