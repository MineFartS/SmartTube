...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
  ...
  DrmInitData(Parcel in) {
    ...
    schemeDatas = Utils.castNonNull(in.createTypedArray(SchemeData.CREATOR));
    schemeDataCount = schemeDatas.length;
  }
  ...
  public DrmInitData copyWithSchemeType(@Nullable String schemeType) {
    if (Utils.areEqual(this.schemeType, schemeType)) {
      return this;
    }
  ...
  public DrmInitData merge(DrmInitData drmInitData) {
    ...
    SchemeData[] mergedSchemeDatas =
        Utils.nullSafeArrayConcatenation(schemeDatas, drmInitData.schemeDatas);
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    return Utils.areEqual(schemeType, other.schemeType)
  ...
  public static final class SchemeData implements Parcelable {
    ...
    /* package */ SchemeData(Parcel in) {
      ...
      mimeType = Utils.castNonNull(in.readString());
    ...
    public boolean equals(@Nullable Object obj) {
      ...
      return Utils.areEqual(licenseServerUrl, other.licenseServerUrl)
          && Utils.areEqual(mimeType, other.mimeType)
          && Utils.areEqual(uuid, other.uuid)
