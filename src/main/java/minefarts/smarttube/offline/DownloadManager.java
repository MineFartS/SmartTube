...
import static minefarts.smarttube.offline.Download.FAILURE_REASON_NONE;
import static minefarts.smarttube.offline.Download.FAILURE_REASON_UNKNOWN;
import static minefarts.smarttube.offline.Download.STATE_COMPLETED;
import static minefarts.smarttube.offline.Download.STATE_DOWNLOADING;
import static minefarts.smarttube.offline.Download.STATE_FAILED;
import static minefarts.smarttube.offline.Download.STATE_QUEUED;
import static minefarts.smarttube.offline.Download.STATE_REMOVING;
import static minefarts.smarttube.offline.Download.STATE_RESTARTING;
import static minefarts.smarttube.offline.Download.STATE_STOPPED;
...
import minefarts.smarttube.scheduler.RequirementsWatcher;
...
public final class DownloadManager {
  ...
  public DownloadManager(
    ...
    Handler mainHandler = Utils.createHandler(this::handleMainMessage);
  ...
  private static final class InternalHandler extends Handler {
    ...
    private static int compareStartTimes(Download first, Download second) {
      return Utils.compareLong(first.startTimeMs, second.startTimeMs);
    }
  }
