...
import static minefarts.smarttube.offline.Download.STOP_REASON_NONE;
...
public abstract class DownloadService extends Service {
    ...
    private void stop() {
        if (foregroundNotificationUpdater != null) {
            ...
            // b/69424260].
            if (startedInForeground && Utils.SDK_INT >= 26) {
                foregroundNotificationUpdater.showNotificationIfNotAlready();
            }
        }
        if (Utils.SDK_INT < 28 && taskRemoved) { // See [Internal: b/74248644].
            stopSelf();
        } else {
