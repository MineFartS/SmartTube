  ...
  static {
    ...
    try {
      ...
      dashDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("minefarts.smarttube.dash.offline.DashDownloader"));
    ...
    try {
      ...
      hlsDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName("minefarts.smarttube.hls.offline.HlsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
    ...
    try {
      ...
      ssDownloaderConstructor =
          getDownloaderConstructor(
              Class.forName(
                  "minefarts.smarttube.ss.offline.SsDownloader"));
      // LINT.ThenChange(../../../../../../../../proguard-rules.txt)
    } catch (ClassNotFoundException e) {
