...
public final class ParsableByteArray {
  ...
  public String readNullTerminatedString(int length) {
    ...
    String result = Utils.fromUtf8Bytes(data, position, stringLength);
    position += length;
    return result;
  }
  ...
  public @Nullable String readNullTerminatedString() {
    ...
    String string = Utils.fromUtf8Bytes(data, position, stringLimit - position);
  ...
  public @Nullable String readLine() {
    ...
    while (lineLimit < limit && !Utils.isLinebreak(data[lineLimit])) {
      lineLimit++;
    }
    ...
    String line = Utils.fromUtf8Bytes(data, position, lineLimit - position);
    position = lineLimit;
    if (position == limit) {
      return line;
    }
