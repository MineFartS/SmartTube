...
public final class Requirements implements Parcelable {
    ...
    @IntDef(flag = true, value = {NETWORK, NETWORK_UNMETERED, DEVICE_IDLE, DEVICE_CHARGING})
    ...
    private int getNotMetNetworkRequirements(Context context) {
        ...
        android.net.NetworkInfo networkInfo =
                Assertions.checkNotNull(connectivityManager).getActiveNetworkInfo();
    ...
    private boolean isDeviceIdle(Context context) {
        ...
        return Utils.SDK_INT >= 23 ? powerManager.isDeviceIdleMode()
                : Utils.SDK_INT >= 20 ? !powerManager.isInteractive() : !powerManager.isScreenOn();
    }
    ...
    public static final Parcelable.Creator<Requirements> CREATOR = new Creator<Requirements>() {
