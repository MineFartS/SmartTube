package minefarts.smarttube.scheduler;
...
public final class RequirementsWatcher {
    ...
    public interface Listener {
         ...
         * @param notMetRequirements {@link Requirements.RequirementFlags RequirementFlags} that are
         *        not met, or 0.
         */
    ...
    public RequirementsWatcher(Context context, Listener listener, Requirements requirements) {
        ...
        handler = new Handler(Utils.getLooper());
    }

    /**
     * Starts watching for changes. Must be called from a thread that has an associated
     * {@link Looper}. Listener methods are called on the caller thread.
     *
     * @return Initial {@link Requirements.RequirementFlags RequirementFlags} that are not met, or
     *         0.
     */
