package minefarts.smarttube.leanback.media;
...
/**
 * This glue extends the {@link minefarts.smarttube.leanback.media.PlaybackControlGlue} with a
 * {@link MediaPlayer} synchronization. It supports 7 actions:
 *
 * <ul>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.FastForwardAction}</li>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.RewindAction}</li>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.PlayPauseAction}</li>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.RepeatAction}</li>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.ThumbsDownAction}</li>
 * <li>{@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.ThumbsUpAction}</li>
 * </ul>
 *
 * @hide
...
public class MediaPlayerGlue extends PlaybackControlGlue implements OnItemViewSelectedListener {
     ...
     * {@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.FastForwardAction} and
     * {@link minefarts.smarttube.leanback.widget.PlaybackControlsRow.RewindAction}. Thus you should <u>NOT</u>
