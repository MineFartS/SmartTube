...
import minefarts.smarttube.leanback.util.StateMachine.Event;
import minefarts.smarttube.leanback.util.StateMachine.State;
import minefarts.smarttube.leanback.widget.BaseOnItemViewClickedListener;
import minefarts.smarttube.leanback.widget.BaseOnItemViewSelectedListener;
import minefarts.smarttube.leanback.widget.BrowseFrameLayout;
import minefarts.smarttube.leanback.widget.DetailsParallax;
import minefarts.smarttube.leanback.widget.FullWidthDetailsOverviewRowPresenter;
import minefarts.smarttube.leanback.widget.ItemAlignmentFacet;
import minefarts.smarttube.leanback.widget.ItemBridgeAdapter;
 ...
 * <li>
 * {@link import minefarts.smarttube.R.style#Theme_Leanback_Details} with activity
 * shared element transition for {@link FullWidthDetailsOverviewRowPresenter}.
 * </li>
 * <li>
 * {@link import minefarts.smarttube.R.style#Theme_Leanback_Details_NoSharedElementTransition}
...
public class DetailsSupportFragment extends BaseSupportFragment {
    ...
    final Fragment findOrCreateVideoSupportFragment() {
        ...
        if (fragment == null && mDetailsBackgroundController != null) {
            ...
            ft2.add(minefarts.smarttube.R.id.video_surface_container,
