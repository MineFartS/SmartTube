...
public final class WavUtil {
  ...
  public static final int RIFF_FOURCC = Utils.getIntegerCodeForString("RIFF");
  /** Four character code for "WAVE". */
  public static final int WAVE_FOURCC = Utils.getIntegerCodeForString("WAVE");
  /** Four character code for "fmt ". */
  public static final int FMT_FOURCC = Utils.getIntegerCodeForString("fmt ");
  /** Four character code for "data". */
  public static final int DATA_FOURCC = Utils.getIntegerCodeForString("data");
  ...
  public static @C.PcmEncoding int getEncodingForType(int type, int bitsPerSample) {
    switch (type) {
      ...
      case TYPE_WAVE_FORMAT_EXTENSIBLE:
        return Utils.getPcmEncoding(bitsPerSample);
      case TYPE_FLOAT:
