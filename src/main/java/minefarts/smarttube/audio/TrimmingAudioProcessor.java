...
/* package */ final class TrimmingAudioProcessor extends BaseAudioProcessor {
  ...
  public TrimmingAudioProcessor() {
    endBuffer = Utils.EMPTY_BYTE_ARRAY;
  }
  ...
  public boolean configure(int sampleRateHz, int channelCount, @C.PcmEncoding int encoding)
    ...
    bytesPerFrame = Utils.getPcmFrameSize(OUTPUT_ENCODING, channelCount);
  ...
  public void queueInput(ByteBuffer inputBuffer) {
    ...
    int endBufferBytesToOutput = Utils.constrainValue(remainingBytesToOutput, 0, endBufferSize);
    ...
    int inputBufferBytesToOutput = Utils.constrainValue(remainingBytesToOutput, 0, remaining);
