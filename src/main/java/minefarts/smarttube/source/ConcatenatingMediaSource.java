...
import minefarts.smarttube.source.ConcatenatingMediaSource.MediaSourceHolder;
import minefarts.smarttube.source.ShuffleOrder.DefaultShuffleOrder;
...
public class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    /**
     * @param isAtomic Whether the concatenating media source will be treated as atomic, i.e.,
     *        treated as a single item for repeating and shuffling.
     * @param mediaSources The {@link MediaSource}s to concatenate. It is valid for the same
     *        {@link MediaSource} instance to be present more than once in the array.
     */
    ...
    public ConcatenatingMediaSource(boolean isAtomic, boolean useLazyPreparation,
            ShuffleOrder shuffleOrder, MediaSource... mediaSources) {
     ...
     */
    public final synchronized void addMediaSource(MediaSource mediaSource, Handler handler,
    ...
    public final synchronized void addMediaSource(int index, MediaSource mediaSource) {
        addPublicMediaSources(index, Collections.singletonList(mediaSource), /* handler= */ null,
    ...
    public final synchronized void addMediaSource(int index, MediaSource mediaSource,
        ...
        addPublicMediaSources(index, Collections.singletonList(mediaSource), handler,
                onCompletionAction);
    }
    ...
    public final synchronized void addMediaSources(Collection<MediaSource> mediaSources) {
        addPublicMediaSources(mediaSourcesPublic.size(), mediaSources, /* handler= */ null,
                /* onCompletionAction= */ null);
    }
     ...
     *
     * @param index The index at which the new {@link MediaSource}s will be inserted. This index
     *        must be in the range of 0 &lt;= index &lt;= {@link #getSize()}.
     * @param mediaSources A collection of {@link MediaSource}s to be added to the list. The media
     *        sources are added in the order in which they appear in this collection.
     */
    public final synchronized void addMediaSources(int index,
            Collection<MediaSource> mediaSources) {
        addPublicMediaSources(index, mediaSources, /* handler= */ null,
                /* onCompletionAction= */ null);
    }

    /**
     * Adds multiple {@link MediaSource}s to the playlist and executes a custom action on
     * completion.
     *
     * @param index The index at which the new {@link MediaSource}s will be inserted. This index
     *        must be in the range of 0 &lt;= index &lt;= {@link #getSize()}.
     ...
     *
     * <p>
     * Note: If you want to move the instance, it's preferable to use
     * {@link #moveMediaSource(int, int)} instead.
     *
     * <p>
     * Note: If you want to remove a set of contiguous sources, it's preferable to use
    ...
    public final synchronized void removeMediaSource(int index) {
        removePublicMediaSources(index, index + 1, /* handler= */ null,
                /* onCompletionAction= */ null);
    }
     ...
     * <p>
     * Note: If you want to move the instance, it's preferable to use
     * {@link #moveMediaSource(int, int, Handler, Runnable)} instead.
     *
     * <p>
     * Note: If you want to remove a set of contiguous sources, it's preferable to use
     * {@link #removeMediaSourceRange(int, int, Handler, Runnable)} instead.
     *
     * @param index The index at which the media source will be removed. This index must be in the
     *        range of 0 &lt;= index &lt; {@link #getSize()}.
     * @param handler The {@link Handler} to run {@code onCompletionAction}.
     ...
     */
    public final synchronized void removeMediaSource(int index, Handler handler,
            Runnable onCompletionAction) {
    ...
    public final synchronized void removeMediaSourceRange(int fromIndex, int toIndex) {
        removePublicMediaSources(fromIndex, toIndex, /* handler= */ null,
                /* onCompletionAction= */ null);
    }
     ...
     * @param newIndex The target index of the media source in the playlist. This index must be in
     *        the range of 0 &lt;= index &lt; {@link #getSize()}.
     */
    public final synchronized void moveMediaSource(int currentIndex, int newIndex) {
        movePublicMediaSource(currentIndex, newIndex, /* handler= */ null,
                /* onCompletionAction= */ null);
    }
     ...
     */
    public final synchronized void moveMediaSource(int currentIndex, int newIndex, Handler handler,
            Runnable onCompletionAction) {
     ...
     */
    public final synchronized void setShuffleOrder(ShuffleOrder shuffleOrder, Handler handler,
            Runnable onCompletionAction) {
    ...
    public void maybeThrowSourceInfoRefreshError() throws IOException {
        // Do nothing. Source info refresh errors of the individual sources will be thrown when
        // calling
    ...
    protected final void onChildSourceInfoRefreshed(MediaSourceHolder mediaSourceHolder,
            MediaSource mediaSource, Timeline timeline, @Nullable Object manifest) {
    ...
    protected @Nullable MediaPeriodId getMediaPeriodIdForChildMediaPeriodId(
        ...
        for (int i = 0; i < mediaSourceHolder.activeMediaPeriods.size(); i++) {
            // Ensure the reported media period id has the same window sequence number as the one
            // created
            // by this media source. Otherwise it does not belong to this child source.
            if (mediaSourceHolder.activeMediaPeriods
                    .get(i).id.windowSequenceNumber == mediaPeriodId.windowSequenceNumber) {
    ...
    @GuardedBy("this")
    private void addPublicMediaSources(int index, Collection<MediaSource> mediaSources,
            @Nullable Handler handler, @Nullable Runnable onCompletionAction) {
        ...
        if (playbackThreadHandler != null && !mediaSources.isEmpty()) {
            HandlerAndRunnable callbackAction =
                    createOnCompletionAction(handler, onCompletionAction);
            playbackThreadHandler
                    .obtainMessage(MSG_ADD,
                            new MessageData<>(index, mediaSourceHolders, callbackAction))
                    .sendToTarget();
    ...
    @GuardedBy("this")
    private void removePublicMediaSources(int fromIndex, int toIndex, @Nullable Handler handler,
            @Nullable Runnable onCompletionAction) {
        Assertions.checkArgument((handler == null) == (onCompletionAction == null));
        Handler playbackThreadHandler = this.playbackThreadHandler;
        Utils.removeRange(mediaSourcesPublic, fromIndex, toIndex);
        if (playbackThreadHandler != null) {
            HandlerAndRunnable callbackAction =
                    createOnCompletionAction(handler, onCompletionAction);
            playbackThreadHandler.obtainMessage(MSG_REMOVE,
                    new MessageData<>(fromIndex, toIndex, callbackAction)).sendToTarget();
        } else if (onCompletionAction != null && handler != null) {
            handler.post(onCompletionAction);
        }
    }
    ...
    @GuardedBy("this")
    private void movePublicMediaSource(int currentIndex, int newIndex, @Nullable Handler handler,
            @Nullable Runnable onCompletionAction) {
        Assertions.checkArgument((handler == null) == (onCompletionAction == null));
        Handler playbackThreadHandler = this.playbackThreadHandler;
        ...
        if (playbackThreadHandler != null) {
            HandlerAndRunnable callbackAction =
                    createOnCompletionAction(handler, onCompletionAction);
            playbackThreadHandler
                    .obtainMessage(MSG_MOVE,
                            new MessageData<>(currentIndex, newIndex, callbackAction))
                    .sendToTarget();
        } else if (onCompletionAction != null && handler != null) {
            handler.post(onCompletionAction);
        }
    ...
    @GuardedBy("this")
    private void setPublicShuffleOrder(ShuffleOrder shuffleOrder, @Nullable Handler handler,
            @Nullable Runnable onCompletionAction) {
        Assertions.checkArgument((handler == null) == (onCompletionAction == null));
        Handler playbackThreadHandler = this.playbackThreadHandler;
        if (playbackThreadHandler != null) {
            ...
            if (shuffleOrder.getLength() != size) {
                shuffleOrder = shuffleOrder.cloneAndClear().cloneAndInsert(/* insertionIndex= */ 0,
                        /* insertionCount= */ size);
            }
            HandlerAndRunnable callbackAction =
                    createOnCompletionAction(handler, onCompletionAction);
            playbackThreadHandler
                    .obtainMessage(MSG_SET_SHUFFLE_ORDER,
    ...
    @GuardedBy("this")
    @Nullable
    private HandlerAndRunnable createOnCompletionAction(@Nullable Handler handler,
        ...
        switch (msg.what) {
            case MSG_ADD:
                MessageData<Collection<MediaSourceHolder>> addMessage =
                        (MessageData<Collection<MediaSourceHolder>>) Utils.castNonNull(msg.obj);
                shuffleOrder =
                        shuffleOrder.cloneAndInsert(addMessage.index, addMessage.customData.size());
            ...
            case MSG_REMOVE:
                MessageData<Integer> removeMessage =
                        (MessageData<Integer>) Utils.castNonNull(msg.obj);
                ...
                break;
            case MSG_MOVE:
                MessageData<Integer> moveMessage = (MessageData<Integer>) Utils.castNonNull(msg.obj);
                shuffleOrder =
                        shuffleOrder.cloneAndRemove(moveMessage.index, moveMessage.index + 1);
            ...
            case MSG_SET_SHUFFLE_ORDER:
                MessageData<ShuffleOrder> shuffleOrderMessage =
                        (MessageData<ShuffleOrder>) Utils.castNonNull(msg.obj);
            ...
            case MSG_ON_COMPLETION:
                Set<HandlerAndRunnable> actions =
                        (Set<HandlerAndRunnable>) Utils.castNonNull(msg.obj);
    ...
    private void scheduleTimelineUpdate(@Nullable HandlerAndRunnable onCompletionAction) {
        if (!timelineUpdateScheduled) {
            getPlaybackThreadHandlerOnPlaybackThread().obtainMessage(MSG_UPDATE_TIMELINE)
                    .sendToTarget();
    ...
    private void updateTimelineAndScheduleOnCompletionActions() {
        ...
        refreshSourceInfo(new ConcatenatedTimeline(mediaSourceHolders, windowCount, periodCount,
                shuffleOrder, isAtomic), /* manifest= */ null);
        getPlaybackThreadHandlerOnPlaybackThread()
                .obtainMessage(MSG_ON_COMPLETION, onCompletionActions).sendToTarget();
    }
    ...
    private void addMediaSourcesInternal(int index,
    ...
    private void addMediaSourceInternal(int newIndex, MediaSourceHolder newMediaSourceHolder) {
        if (newIndex > 0) {
            ...
            newMediaSourceHolder.reset(newIndex,
                    previousHolder.firstWindowIndexInChild
                            + previousHolder.timeline.getWindowCount(),
                    previousHolder.firstPeriodIndexInChild
                            + previousHolder.timeline.getPeriodCount());
        } else {
            newMediaSourceHolder.reset(newIndex, /* firstWindowIndexInChild= */ 0,
                    /* firstPeriodIndexInChild= */ 0);
        }
        correctOffsets(newIndex, /* childIndexUpdate= */ 1,
    ...
    private void updateMediaSourceInternal(MediaSourceHolder mediaSourceHolder, Timeline timeline) {
        ...
        if (windowOffsetUpdate != 0 || periodOffsetUpdate != 0) {
            correctOffsets(mediaSourceHolder.childIndex + 1, /* childIndexUpdate= */ 0,
                    windowOffsetUpdate, periodOffsetUpdate);
        }
        if (mediaSourceHolder.isPrepared) {
            ...
            // We should have at most one deferred media period for the DummyTimeline because the
            // duration
            // is unset and we don't load beyond periods with unset duration. We need to figure out
            // how to
            // handle the prepare positions of multiple deferred media periods, should that ever
            // change.
            Assertions.checkState(mediaSourceHolder.activeMediaPeriods.size() <= 1);
            DeferredMediaPeriod deferredMediaPeriod =
                    mediaSourceHolder.activeMediaPeriods.isEmpty() ? null
            ...
            // 2. The non-zero prepare position of the deferred period under the assumption that
            // this is
            // a non-zero initial seek position in the window.
            // 3. The default window start position if the deferred period has a prepare position of
            // zero
            ...
            Pair<Object, Long> periodPosition = timeline.getPeriodPosition(window, period,
                    /* windowIndex= */ 0, windowStartPositionUs);
            Object periodUid = periodPosition.first;
            long periodPositionUs = periodPosition.second;
            mediaSourceHolder.timeline =
                    DeferredTimeline.createWithRealTimeline(timeline, periodUid);
            if (deferredMediaPeriod != null) {
                deferredMediaPeriod.overridePreparePositionUs(periodPositionUs);
                MediaPeriodId idInSource = deferredMediaPeriod.id.copyWithPeriodUid(
    ...
    private void maybeReleaseChildSource(MediaSourceHolder mediaSourceHolder) {
        // Release if the source has been removed from the playlist, but only if it has been
        // previously
    ...
    private static final class MessageData<T> {
        ...
        public MessageData(int index, T customData,
                @Nullable HandlerAndRunnable onCompletionAction) {
            this.index = index;
    ...
    private static final class ConcatenatedTimeline extends AbstractConcatenatedTimeline {
        ...
        public ConcatenatedTimeline(Collection<MediaSourceHolder> mediaSourceHolders,
                int windowCount, int periodCount, ShuffleOrder shuffleOrder, boolean isAtomic) {
        ...
        protected int getChildIndexByPeriodIndex(int periodIndex) {
            return Utils.binarySearchFloor(firstPeriodInChildIndices, periodIndex + 1, false, false);
        }

        @Override
        protected int getChildIndexByWindowIndex(int windowIndex) {
            return Utils.binarySearchFloor(firstWindowInChildIndices, windowIndex + 1, false, false);
        }
    ...
    private static final class DeferredTimeline extends ForwardingTimeline {
        ...
        /**
         * Returns an instance with a real timeline, replacing the provided period ID with the
         * already assigned dummy period ID.
         *
         * @param timeline The real timeline.
         * @param firstPeriodUid The period UID in the timeline which will be replaced by the
         *        already assigned dummy period UID.
         */
        public static DeferredTimeline createWithRealTimeline(Timeline timeline,
        ...
        public Period getPeriod(int periodIndex, Period period, boolean setIds) {
            ...
            if (Utils.areEqual(period.uid, replacedId)) {
                period.uid = DUMMY_ID;
            }
            return period;
        }
        ...
        public Object getUidOfPeriod(int periodIndex) {
            ...
            return Utils.areEqual(uid, replacedId) ? DUMMY_ID : uid;
        }
    }
    ...
    private static final class DummyTimeline extends Timeline {
        ...
        public Window getWindow(int windowIndex, Window window, boolean setTag,
            ...
            return window.set(tag, /* presentationStartTimeMs= */ C.TIME_UNSET,
                    /* windowStartTimeMs= */ C.TIME_UNSET, /* isSeekable= */ false,
                    // Dynamic window to indicate pending timeline updates.
                    /* isDynamic= */ true, /* defaultPositionUs= */ 0,
                    /* durationUs= */ C.TIME_UNSET, /* firstPeriodIndex= */ 0,
                    /* lastPeriodIndex= */ 0, /* positionInFirstPeriodUs= */ 0);
        }
        ...
        @Override
        public Period getPeriod(int periodIndex, Period period, boolean setIds) {
            return period.set(/* id= */ 0, /* uid= */ DeferredTimeline.DUMMY_ID,
                    /* windowIndex= */ 0, /* durationUs = */ C.TIME_UNSET,
