...
public class CustomBrowseSupportFragment extends BrowseSupportFragment {
  ...
  public View onCreateView(
    ...
    HeadersSupportFragment customHeadersSupportFragment =
        (HeadersSupportFragment) Helpers.getField(this, "mHeadersSupportFragment");

    if (customHeadersSupportFragment != null) {
      mCustomOnHeaderClickedListener =
          (OnHeaderClickedListener)
              Helpers.getField(customHeadersSupportFragment, "mOnHeaderClickedListener");
      mCustomWrapper =
          (ItemBridgeAdapter.Wrapper) Helpers.getField(customHeadersSupportFragment, "mWrapper");
      sCustomLayoutChangeListener =
          (OnLayoutChangeListener)
              Helpers.getField(customHeadersSupportFragment, "sLayoutChangeListener");
