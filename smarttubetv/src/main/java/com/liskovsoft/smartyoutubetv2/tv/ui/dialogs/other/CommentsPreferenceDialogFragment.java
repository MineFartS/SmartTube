...
public class CommentsPreferenceDialogFragment extends LeanbackPreferenceDialogFragment {
  ...
  private static class CommentsBackup implements Backup {
    public CommentsBackup(
        List<ChatItemMessage> backupMessages,
        ChatItemMessage focusedMessage,
  ...
  public static CommentsPreferenceDialogFragment newInstance(
      CommentsReceiver commentsReceiver, String key) {
  ...
  public View onCreateView(
    ...
    final View view = inflater.inflate(R.layout.chat_preference_fragment, container, false);
    ...
    MessagesListAdapter<ChatItemMessage> adapter =
    ...
    adapter.setLoadMoreListener(
        (page, totalItemsCount) -> mCommentsReceiver.onLoadMore(mCurrentGroup));
          ...
          public void onCommentGroup(CommentGroup commentGroup) {
            ...
            for (CommentItem commentItem : commentGroup.getComments()) {
              if (ChatItemMessage.shouldSplit(commentItem)) {
                List<ChatItemMessage> split =
                    ChatItemMessage.fromSplit(view.getContext(), commentItem);
  ...
  private void appendMessage(
      MessagesListAdapter<ChatItemMessage> adapter, ChatItemMessage message) {
  ...
  public void onDestroy() {
    ...
    if (mCommentsReceiver != null && mFocusedMessage != null) {
      mCommentsReceiver.onFinish(
          new CommentsBackup(mBackupMessages, mFocusedMessage, mCurrentGroup));
    }
  }
  ...
  private void backupMessages() {
    ...
    MessagesListAdapter<ChatItemMessage> adapter =
        (MessagesListAdapter<ChatItemMessage>) messagesList.getAdapter();
