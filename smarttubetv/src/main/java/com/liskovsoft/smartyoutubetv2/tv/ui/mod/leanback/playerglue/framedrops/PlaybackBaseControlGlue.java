...
/**
 * A base abstract class for managing a {@link PlaybackControlsRow} being displayed in {@link
 ...
 * components {@link PlaybackControlsRow} {@link PlaybackRowPresenter} and a functional {@link
 * PlayerAdapter} which represents the underlying media player.
 *
 * <p>The app must pass a {@link PlayerAdapter} in constructor for a specific implementation e.g. a
...
public abstract class PlaybackBaseControlGlue<T extends PlayerAdapter> extends PlaybackGlue
  ...
  /**
   * Sets the controls row to be managed by the glue layer. If {@link
   * PlaybackControlsRow#getPrimaryActionsAdapter()} is not provided, a default {@link
   * ArrayObjectAdapter} will be created and initialized in {@link
   * #onCreatePrimaryActions(ArrayObjectAdapter)}. If {@link
   * PlaybackControlsRow#getSecondaryActionsAdapter()} is not provided, a default {@link
   * ArrayObjectAdapter} will be created and initialized in {@link
   * #onCreateSecondaryActions(ArrayObjectAdapter)}. The primary actions and playback state related
   * aspects of the row are updated by the glue.
   */
      ...
      ArrayObjectAdapter adapter =
          new ArrayObjectAdapter(
              new ControlButtonPresenterSelector(
                  PlayerData.instance(getContext()).isTooltipsEnabled()));
  ...
  /**
   * May be overridden to add primary actions to the adapter. Default implementation add {@link
  ...
  private void updateProgress() {
    if (mControlsRow != null) {
      mControlsRow.setCurrentPosition(mPlayerAdapter.isPrepared() ? getCurrentPosition() : -1);
    }
  }
  ...
  protected void onUpdateDuration() {
    if (mControlsRow != null) {
      mControlsRow.setDuration(mPlayerAdapter.isPrepared() ? mPlayerAdapter.getDuration() : -1);
    }
  }
  ...
  /**
   * Sets the media body (located under subtitle). The body will be rendered by default description
   * presenter {@link PlaybackTransportRowPresenter#setDescriptionPresenter(Presenter)}.
   *
  ...
  /**
   * Sets the media subtitle. The subtitle will be rendered by default description presenter {@link
   * PlaybackTransportRowPresenter#setDescriptionPresenter(Presenter)}.
   *
  ...
  /**
   * Sets the media title. The title will be rendered by default description presenter {@link
   * PlaybackTransportRowPresenter#setDescriptionPresenter(Presenter)}.
   */
