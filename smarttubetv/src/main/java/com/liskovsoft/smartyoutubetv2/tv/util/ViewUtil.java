...
public class ViewUtil {
  ...
  public static void disableMarquee(TextView... textViews) {
    if (VERSION.SDK_INT <= 19
        || textViews == null
        || textViews.length == 0) { // Android 4: Broken grid layout fix
      return;
    }
  ...
  /**
   * <a href="https://stackoverflow.com/questions/3332924/textview-marquee-not-working">More
   * info</a>
   */
  ...
  public static void enableTransparentDialog(Context context, View rootView) {
    ...
    if (itemsContainer instanceof VerticalGridView) {
      ...
      ((VerticalGridView) itemsContainer)
          .setOnChildLaidOutListener(
              (parent, view, position, id) ->
                  view.setBackgroundResource(R.drawable.transparent_dialog_item_bg));
    }
