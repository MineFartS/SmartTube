...
public class ChannelFragment extends MultipleRowsFragment implements ChannelView {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    mRestoredItemIndex =
        savedInstanceState != null ? savedInstanceState.getInt(SELECTED_ITEM_INDEX, -1) : -1;
        ...
        new ChannelHeaderCallback() {
          ...
          public String getChannelTitle() {
            ...
            if (mChannelPresenter.getChannel() == null) {
              return Helpers.startsWith(mChannelPresenter.getChannelId(), "@")
                  ? mChannelPresenter.getChannelId()
                  : null;
            }
            ...
            return Helpers.toString(
                YouTubeHelper.createInfo(Helpers.firstNonNull(author, title), subs));
          }
        });
  }
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    mProgressBarManager.setRootView(
