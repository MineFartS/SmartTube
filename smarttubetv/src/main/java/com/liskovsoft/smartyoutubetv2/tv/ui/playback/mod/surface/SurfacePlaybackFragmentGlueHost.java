...
public class SurfacePlaybackFragmentGlueHost extends PlaybackSupportFragmentGlueHost
  ...
  /**
   * Sets the {@link SurfaceHolder.Callback} on the host. {@link PlaybackGlueHost} is assumed to
   * either host the {@link SurfaceHolder} or have a reference to the component hosting it for
   * rendering the video.
   */
  @Override
