...
public class IconHeaderItemPresenter extends RowHeaderPresenter {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup viewGroup) {
    ...
    mDefaultIcon =
        new ColorDrawable(ContextCompat.getColor(viewGroup.getContext(), R.color.lb_grey));
  ...
  public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
    ...
    if (iconView != null) {
      if (mIconUrl != null) {
        ...
        Drawable icon =
            mResId > 0 ? ContextCompat.getDrawable(rootView.getContext(), mResId) : mDefaultIcon;
