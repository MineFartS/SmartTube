...
class FindAddress {
  ...
  private static final Pattern sHouseNumberRe =
      Pattern.compile(
          HOUSE_COMPONENT + "(?:-" + HOUSE_COMPONENT + ")*" + HOUSE_END, Pattern.CASE_INSENSITIVE);
  ...
  /**
   * Attempt to match a house number beginnning at position offset in content. The house number must
   ...
   *
   * @return true if zipCode is a valid zip code, is legal for the matched state, and is followed by
   *     a word delimiter or the end of the string.
   */
  ...
  /**
   * Test whether zipCode matches the U.S. zip code format (ddddd or ddddd-dddd) and is within the
   * expected range, given that state holds a string that will match sStateRe.
   *
   * @return true if zipCode is a valid zip code, is legal for the given state, and is followed by a
   *     word delimiter or the end of the string.
   */
  @VisibleForTesting
   ...
   *
   * @return true if zipCode is a valid zip code followed by a word delimiter or the end of the
   *     string.
   */
  @VisibleForTesting
   ...
   *
   * @return true if location starts with a valid location name followed by a word delimiter or the
   *     end of the string.
   */
  @VisibleForTesting
   ...
   * @return +ve: the end of the match +ve: the position to restart searching for house numbers,
   *     negated.
   */
