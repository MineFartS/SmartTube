...
public class TwoStateAction extends MultiAction {
  ...
  public TwoStateAction(
      Context context, int actionId, int offIconResId, boolean enableLongPressMsg) {
    this(
        context,
        actionId,
        offIconResId,
        ActionHelpers.getIconHighlightColor(context),
        enableLongPressMsg);
  }
