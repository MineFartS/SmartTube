...
public class TagPresenter extends LongClickPresenter {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent) {
    sDefaultBackgroundColor =
        ContextCompat.getColor(
            parent.getContext(),
            Helpers.getThemeAttr(parent.getContext(), R.attr.cardDefaultBackground));
    sDefaultTextColor = ContextCompat.getColor(parent.getContext(), R.color.card_default_text);
    ...
    TagCardView cardView =
        new TagCardView(parent.getContext()) {
          @Override
  ...
  public void onBindViewHolder(ViewHolder viewHolder, Object item) {
    ...
    viewHolder.view.setOnFocusChangeListener(
        (v, hasFocus) -> {
