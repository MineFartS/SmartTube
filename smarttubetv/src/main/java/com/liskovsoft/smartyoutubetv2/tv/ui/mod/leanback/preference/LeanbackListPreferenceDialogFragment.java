...
public class LeanbackListPreferenceDialogFragment extends LeanbackPreferenceDialogFragment {
  ...
  public static LeanbackListPreferenceDialogFragment newInstanceSingle(String key) {
    ...
    final LeanbackListPreferenceDialogFragment fragment =
        new LeanbackListPreferenceDialogFragment();
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      if (mMulti) {
        final String[] initialSelections =
            savedInstanceState.getStringArray(SAVE_STATE_INITIAL_SELECTIONS);
        mInitialSelections =
            new ArraySet<>(initialSelections != null ? initialSelections.length : 0);
  ...
  public @Nullable View onCreateView(
    ...
    final View view =
        inflater.inflate(
            androidx.leanback.preference.R.layout.leanback_list_preference_fragment,
            container,
            false);
    ...
    if (!TextUtils.isEmpty(title)) {
      final TextView titleView =
          (TextView) view.findViewById(androidx.leanback.preference.R.id.decor_title);
    ...
    if (!TextUtils.isEmpty(message)) {
      ...
      LinkifyCompat.addLinks(
          messageView,
          LinkifyCompat.WEB_URLS | LinkifyCompat.TIME_CODES,
          new LinkifyClickHandler() {
  ...
  public class AdapterSingle extends RecyclerView.Adapter<ViewHolder>
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      final View view =
          inflater.inflate(
              androidx.leanback.preference.R.layout.leanback_list_preference_item_single,
              parent,
              false);
  ...
  public class AdapterMulti extends RecyclerView.Adapter<ViewHolder>
    ...
    public AdapterMulti(
        CharSequence[] entries, CharSequence[] entryValues, Set<String> initialSelections) {
      mEntries = entries;
      mEntryValues = entryValues;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      final View view =
          inflater.inflate(
              androidx.leanback.preference.R.layout.leanback_list_preference_item_multi,
              parent,
              false);
      return new ViewHolder(view, this);
    }
    ...
    public void onItemClick(ViewHolder viewHolder) {
      ...
      if (multiSelectListPreference != null
          && multiSelectListPreference.callChangeListener(new HashSet<>(mSelections))) {
