...
public class FadeAndShortSlide extends Visibility {
  ...
  static final CalculateSlide sCalculateStartEnd =
      new CalculateSlide() {
        ...
        public float getGoneX(FadeAndShortSlide t, ViewGroup sceneRoot, View view, int[] position) {
          ...
          final int sceneRootCenter =
              center == null ? (position[0] + sceneRoot.getWidth() / 2) : center.centerX();
  ...
  final CalculateSlide sCalculateTopBottom =
      new CalculateSlide() {
        ...
        public float getGoneY(FadeAndShortSlide t, ViewGroup sceneRoot, View view, int[] position) {
          ...
          final int sceneRootCenter =
              center == null ? (position[1] + sceneRoot.getHeight() / 2) : center.centerY();
          if (viewCenter < sceneRootCenter) {
            return view.getTranslationY() - t.getVerticalDistance(sceneRoot);
          } else {
            return view.getTranslationY() + t.getVerticalDistance(sceneRoot);
  ...
  public Animator onAppear(
    ...
    final Animator slideAnimator =
        TranslationAnimationCreator.createAnimation(
            view, endValues, left, top, startX, startY, endX, endY, sDecelerate, this);
  ...
  /**
   * Returns distance to slide. When negative value is returned, it will use 1/4 of sceneRoot
   * dimension.
   */
