        ...
        public void onCreate(final ItemBridgeAdapter.ViewHolder viewHolder) {
          ItemBridgeAdapter.Wrapper wrapper =
              (ItemBridgeAdapter.Wrapper)
                  Helpers.getField(ExtendedHeadersSupportFragment.this, "mWrapper");
          OnLayoutChangeListener layoutChangeListener =
              (OnLayoutChangeListener)
                  Helpers.getField(ExtendedHeadersSupportFragment.this, "sLayoutChangeListener");
              ...
              v -> {
                OnHeaderClickedListener onHeaderClickedListener =
                    (OnHeaderClickedListener)
                        Helpers.getField(
                            ExtendedHeadersSupportFragment.this, "mOnHeaderClickedListener");
