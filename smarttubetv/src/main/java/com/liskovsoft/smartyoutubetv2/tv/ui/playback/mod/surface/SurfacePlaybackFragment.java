...
/**
 * Subclass of {@link PlaybackSupportFragment} that is responsible for providing a {@link
 * SurfaceView} and rendering video.
 */
public class SurfacePlaybackFragment extends PlaybackSupportFragment {
  ...
  public View onCreateView(
    ...
    mVideoSurfaceWrapper =
        (PlayerTweaksData.instance(getContext()).isTextureViewEnabled()
            ...
            ? new TextureViewWrapper(getContext(), root)
  ...
  protected void setFlipEnabled(boolean enabled) {
    ...
    if (Helpers.floatEquals(mVideoSurfaceRoot.getScaleX(), scaleX)
        || mVideoSurfaceWrapper == null) {
      return;
    }
