...
public class ActionHelpers {
  ...
  public static BitmapDrawable createDrawable(
      Context context, BitmapDrawable bitmapDrawable, int bitmapColor) {
    return bitmapDrawable == null
        ? null
        : new BitmapDrawable(
            context.getResources(), createBitmap(bitmapDrawable.getBitmap(), bitmapColor));
  }
