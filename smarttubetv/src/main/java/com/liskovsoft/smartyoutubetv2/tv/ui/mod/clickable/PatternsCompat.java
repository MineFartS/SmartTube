...
public final class PatternsCompat {
   ...
   *
   * <p>List accurate as of 2015/11/24. List taken from:
  ...
  static final String IANA_TOP_LEVEL_DOMAINS =
      "(?:(?:aaa|aarp|abb|abbott|abogado|academy|accenture|accountant|accountants|aco|active"
          ...
          + "|protection|pub|p[aefghklmnrstwy])|(?:qpon|quebec|qa)"
  ...
  /**
   * Regular expression that matches domain names using either {@link #STRICT_HOST_NAME} or {@link
   * #IP_ADDRESS}
   */
  ...
  /**
   * Regular expression to match strings that do not start with a supported protocol. The TLDs are
  ...
  public static final Pattern AUTOLINK_WEB_URL =
      Pattern.compile("(" + WEB_URL_WITH_PROTOCOL + "|" + WEB_URL_WITHOUT_PROTOCOL + ")");
  ...
  public static final Pattern AUTOLINK_TIME_CODE =
      Pattern.compile("(" + WORD_BOUNDARY + "(?:" + TIME_CODE_PART + ")" + WORD_BOUNDARY + ")");
