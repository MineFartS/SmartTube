...
public class ChannelCardPresenter extends LongClickPresenter {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent) {
    ...
    mNewContentBackgroundColor = ContextCompat.getColor(context, R.color.dark_red);
    ...
    container.setOnFocusChangeListener(
        (v, hasFocus) -> {
          int backgroundColor =
              hasFocus
                  ? mSelectedBackgroundColor
                  : textView.getTag(R.id.channel_new_content) != null
  ...
  public void onBindViewHolder(ViewHolder viewHolder, Object item) {
    ...
    ViewUtil.setDimensions(
        viewHolder.view.findViewById(R.id.channel_card_wrapper),
        mWidth,
        -1); // don't do auto height
    ...
    textView.setBackgroundColor(
        video.hasNewContent ? mNewContentBackgroundColor : mDefaultBackgroundColor);
