...
/**
 * Every successfully handled event invokes {@link PlaybackSupportFragment#tickle} that makes ui to
 * appear. Fixing that for keys.
 */
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (onTouchInterceptListener != null) {
      Helpers.setField(
          ...
          (VerticalGridView.OnTouchInterceptListener) this::onInterceptInputEvent);
    }
    ...
    if (onKeyInterceptListener != null) {
      Helpers.setField(
          ...
          (VerticalGridView.OnKeyInterceptListener) this::onInterceptInputEvent);
    }
  }
