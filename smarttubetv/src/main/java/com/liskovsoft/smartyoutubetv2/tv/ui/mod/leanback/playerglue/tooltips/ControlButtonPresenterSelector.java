 ...
 *
 * <p>Binds to items of type {@link Action}.
 */
public class ControlButtonPresenterSelector extends PresenterSelector {
  ...
  public static class ControlButtonPresenter extends Presenter {
    ...
    // Used inside:
    // com.liskovsoft.smartyoutubetv2.tv.ui.mod.leanback.playerglue.tweaks.ControlBarPresenter.ViewHolder.bindControlToAction()
    // Restore focus:
    // com.liskovsoft.smartyoutubetv2.tv.ui.mod.leanback.playerglue.tweaks.ControlBar.onRequestFocusInDescendants()
    @Override
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
      ...
      CharSequence contentDescription =
          TextUtils.isEmpty(action.getLabel2()) ? action.getLabel1() : action.getLabel2();
    ...
    public void setOnLongClickListener(ViewHolder viewHolder, View.OnLongClickListener listener) {
