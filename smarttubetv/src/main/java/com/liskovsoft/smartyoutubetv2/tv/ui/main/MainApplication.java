...
public class MainApplication
    extends MultiDexApplication { // fix: Didn't find class
  ...
  private void setupViewManager() {
    ...
    viewManager.register(
        SplashView.class, SplashActivity.class); // no parent, because it's root activity
    viewManager.register(
        BrowseView.class, BrowseActivity.class); // no parent, because it's root activity
