...
/**
 * A PlaybackTransportRowPresenter renders a {@link PlaybackControlsRow} to display a series of
 * playback control buttons. Typically this row will be the first row in a fragment such as the
 * {@link androidx.leanback.app.PlaybackSupportFragment}.
 *
 * <p>The detailed description is rendered using a {@link Presenter} passed in {@link
 * #setDescriptionPresenter(Presenter)}. This can be an instance of {@link
 * AbstractDetailsDescriptionPresenter}. The application can access the detailed description
 * ViewHolder from {@link ViewHolder#getDescriptionViewHolder()}.
 */
public class PlaybackTransportRowPresenter extends PlaybackRowPresenter {
  ...
  public class ViewHolder extends PlaybackRowPresenter.ViewHolder implements PlaybackSeekUi {
    ...
    void updateThumbsInSeek(int thumbHeroIndex, boolean forward) {
      ...
      if (mThumbHeroIndex < 0) {
        ...
        final int oldEnd = Math.min(mThumbHeroIndex + (totalNum / 2), mPositionsLength - 1);
        if (forward) {
      ...
      for (int childIndex = 0;
          childIndex < heroChildIndex - mThumbHeroIndex + start;
          childIndex++) {
    ...
    PlaybackSeekDataProvider.ResultCallback mThumbResult =
        new PlaybackSeekDataProvider.ResultCallback() {
          ...
          public void onThumbnailLoaded(Bitmap bitmap, int index) {
            int childIndex =
                mThumbsBar.getChildCount() == 1
                    ? // single frame carousel check
                    0
                    : index - (mThumbHeroIndex - mThumbsBar.getChildCount() / 2);
     ...
     * @param descriptionPresenter The presenter that will be used to create description ViewHolder.
     *     The description view will be added into tree.
     */
    public ViewHolder(View rootView, Presenter descriptionPresenter) {
      ...
      PlaybackTransportRowPresenter.this.mPlaybackControlsPresenter.setSyncedFocusIndexEnabled(
          tweaksData.isSyncRowButtonIndexEnabled());
      PlaybackTransportRowPresenter.this.mSecondaryControlsPresenter.setSyncedFocusIndexEnabled(
          tweaksData.isSyncRowButtonIndexEnabled());
      ...
      mQualityInfo =
          (TextView) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.quality_info);
      mDateTime =
          (TextView) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.date_time);

      mRemainingTimeFormat =
          rootView
              .getContext()
              .getString(com.liskovsoft.smartyoutubetv2.tv.R.string.player_remaining_time);
      mAdditionalInfo =
          (ViewGroup) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.additional_info);
      mTimeInfo =
          (ViewGroup) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.time_info);
      mTopEdge = (ViewGroup) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.top_edge);
      mTopEdge.setOnFocusChangeListener(
          (v, hasFocus) -> {
            if (hasFocus) {
              mTopEdge.clearFocus();
            ...
            public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
              ...
              switch (keyCode) {
                ...
                case KeyEvent.KEYCODE_MEDIA_FAST_FORWARD:
                  ...
                  return true;
                  // case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE: // MOD: act as OK? (handled somewhere
                  // else, inside player glue)
                  ...
                  if (keyEvent.getAction() == KeyEvent.ACTION_UP) {
                    ...
                    stopSeek(
                        Build.VERSION.SDK_INT >= 21
                            ? !mProgressBar.isAccessibilityFocused()
                            : true);
                  }
                  return true;
              }
      ...
      mProgressBar.setAccessibilitySeekListener(
          new SeekBar.AccessibilitySeekListener() {
            @Override
            ...
            public boolean onAccessibilitySeekProgress(int progress) {
              mSeekClient.onSeekPositionChanged(
                  (long) ((double) (progress) / Integer.MAX_VALUE * mTotalTimeInMs));
      ...
      mSecondaryControlsDock = (ViewGroup) rootView.findViewById(R.id.secondary_controls_dock);
      ...
      mThumbsBarTitle =
          (TextView) rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.thumbs_row_title);
      mThumbsBarWrapper =
          (ViewGroup)
              rootView.findViewById(com.liskovsoft.smartyoutubetv2.tv.R.id.thumbs_row_wrapper);
    }
      ...
      if (mSelectedViewHolder == null) {
        ...
        if (getOnItemViewSelectedListener() != null) {
          getOnItemViewSelectedListener()
              .onItemSelected(mSelectedViewHolder, mSelectedItem, ViewHolder.this, getRow());
        }
      }
    }
    ;
    ...
    /**
     * Returns the TextView that showing total time label. This method might be used in {@link
     * #onSetDurationLabel}.
     *
    ...
    /**
     * Called to update total time label. Default implementation updates the TextView {@link
    ...
    /**
     * Returns the TextView that showing current position label. This method might be used in {@link
    ...
    /**
     * Called to update current time label. Default implementation updates the TextView {@link
  ...
  private final OnControlSelectedListener mOnControlSelectedListener =
      new OnControlSelectedListener() {
        ...
        public void onControlSelected(
            Presenter.ViewHolder itemViewHolder, Object item, ControlBarPresenter.BoundData data) {
  ...
  private final OnControlLongClickedListener mOnControlLongClickedListener =
      new OnControlLongClickedListener() {
        @Override
        public boolean onControlLongClicked(
            Presenter.ViewHolder itemViewHolder, Object item, ControlBarPresenter.BoundData data) {
  ...
  public PlaybackTransportRowPresenter() {
    ...
    mPlaybackControlsPresenter =
        new ControlBarPresenter(com.liskovsoft.smartyoutubetv2.tv.R.layout.lb_control_bar);
  ...
  /**
   * Sets the secondary color for the progress bar. If not set, a default from the theme {@link
   * R.attr#playbackProgressSecondaryColor} will be used.
   *
  ...
  public void onReappear(RowPresenter.ViewHolder rowViewHolder) {
    ...
    if (vh.view.hasFocus()) {
      ...
      vh.stopSeek(Build.VERSION.SDK_INT >= 21 ? !vh.mProgressBar.isAccessibilityFocused() : true);
  ...
  protected RowPresenter.ViewHolder createRowViewHolder(ViewGroup parent) {
    View v =
        LayoutInflater.from(parent.getContext())
            .inflate(
                com.liskovsoft.smartyoutubetv2.tv.R.layout.lb_playback_transport_controls_row,
                parent,
                false);
  ...
  private void initRow(final ViewHolder vh) {
    vh.mControlsVh =
        (ControlBarPresenter.ViewHolder)
    ...
    vh.mProgressBar.setSecondaryProgressColor(
        mSecondaryProgressColorSet
  ...
  protected void onRowViewAttachedToWindow(RowPresenter.ViewHolder vh) {
    ...
    if (mDescriptionPresenter != null) {
      mDescriptionPresenter.onViewAttachedToWindow(((ViewHolder) vh).mDescriptionViewHolder);
    }
  }
  ...
  protected void onRowViewDetachedFromWindow(RowPresenter.ViewHolder vh) {
    ...
    if (mDescriptionPresenter != null) {
      mDescriptionPresenter.onViewDetachedFromWindow(((ViewHolder) vh).mDescriptionViewHolder);
    }
  }
}
