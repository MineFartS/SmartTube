...
public class ThumbsBar extends LinearLayout {
  ...
  public ThumbsBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    mThumbHeightInPixel =
        (int) (mThumbWidthInPixel / 1.77); // limit height by 16:9 ratio (vertical videos fix)
    ...
    mHeroThumbHeightInPixel =
        (int) (mHeroThumbWidthInPixel / 1.77); // limit height by 16:9 ratio (vertical videos fix)
  ...
  private void setNumberOfThumbsInternal() {
    ...
    while (getChildCount() < mNumOfThumbs) {
      ...
      LayoutParams lp = new LayoutParams(mThumbWidthInPixel, mThumbHeightInPixel);
      addView(view, lp);
    }
    int heroIndex = getHeroIndex();
    for (int i = 0; i < getChildCount(); i++) {
