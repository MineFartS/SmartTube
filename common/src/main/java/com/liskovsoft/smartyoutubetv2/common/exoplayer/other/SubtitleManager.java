...
public class SubtitleManager implements TextOutput, OnDataChange {
  ...
  public static class SubtitleStyle {
    ...
    public SubtitleStyle(
        int nameResId, int subsColorResId, int backgroundColorResId, int captionStyle) {
  ...
  private void applySystemStyle() {
    ...
    if (captioningManager != null) {
      ...
      CaptionStyleCompat style =
          new CaptionStyleCompat(
              userStyle.foregroundColor,
              userStyle.backgroundColor,
              VERSION.SDK_INT >= 21 ? userStyle.windowColor : Color.TRANSPARENT,
              userStyle.edgeType,
              userStyle.edgeColor,
      ...
      mSubtitleView.setFixedTextSize(
          TypedValue.COMPLEX_UNIT_PX, textSizePx * captioningManager.getFontScale());
    }
  }
  ...
  private float getTextSizePx() {
    ...
    float textSizePx =
        mSubtitleView.getContext().getResources().getDimension(R.dimen.subtitle_text_size);
