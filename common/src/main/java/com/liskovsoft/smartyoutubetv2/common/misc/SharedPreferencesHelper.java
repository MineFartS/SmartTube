...
public class SharedPreferencesHelper {
  ...
  public static void restoreFromObj(
      Context context, InputStream backupFile, String preferenceName) {
  ...
  public static void restoreFromXml(
      Context context, InputStream backupFile, String preferenceName) {
    if (preferenceName.endsWith(".xml")) {
      preferenceName = preferenceName.replace(".xml", "");
    }
    ...
    try {
      ...
      for (int i = 0; i < nodeList.getLength(); i++) {
        ...
        String value =
            "string".equals(type) ? element.getTextContent() : element.getAttribute("value");
