...
public class AppDialogUtil {
  ...
  public static void appendShareLinkDialogItem(
      Context context, AppDialogPresenter dialogPresenter, Video video) {
    appendShareLinkDialogItem(context, dialogPresenter, video, -1);
  }

  /** Adds share link items to existing dialog. */
  public static void appendShareLinkDialogItem(
      Context context, AppDialogPresenter dialogPresenter, Video video, int positionSec) {
    if (video == null) {
      return;
    }
        ...
        UiOptionItem.from(
            ...
            optionItem -> {
              if (video.videoId != null) {
                Utils.displayShareVideoDialog(
                    context,
                    video.videoId,
                    positionSec == -1 ? Utils.toSec(video.getPositionMs()) : positionSec);
  ...
  /** Adds share link items to existing dialog. */
  public static void appendShareEmbedLinkDialogItem(
      Context context, AppDialogPresenter dialogPresenter, Video video) {
  ...
  public static void appendShareEmbedLinkDialogItem(
    ...
    dialogPresenter.appendSingleButton(
        UiOptionItem.from(
            context.getString(R.string.share_embed_link),
            optionItem -> {
              if (video.videoId != null) {
                Utils.displayShareEmbedVideoDialog(
                    context,
                    video.videoId,
                    positionSec == -1 ? Utils.toSec(video.getPositionMs()) : positionSec);
              }
  ...
  public static void appendShareQRLinkDialogItem(
      Context context, AppDialogPresenter dialogPresenter, Video video) {
  ...
  public static void appendShareQRLinkDialogItem(
    ...
    dialogPresenter.appendSingleButton(
        UiOptionItem.from(
            context.getString(R.string.share_qr_link),
            optionItem -> {
              ...
              if (video.videoId != null) {
                Utils.openLink(
                    context,
                    Utils.toQrCodeLink(
                        Utils.convertToFullVideoUrl(
                                video.videoId,
                                positionSec == -1
                                    ? Utils.toSec(video.getPositionMs())
                                    : positionSec)
                            .toString()));
              }
            }));
  ...
  public static OptionCategory createBackgroundPlaybackCategory(
      Context context, PlayerData playerData, GeneralData generalData) {
    return createBackgroundPlaybackCategory(context, playerData, generalData, () -> {});
  }

  public static OptionCategory createBackgroundPlaybackCategory(
      Context context, PlayerData playerData, GeneralData generalData, Runnable onSetCallback) {
    ...
    options.add(
        UiOptionItem.from(
            ...
            optionItem -> {
              ...
              generalData.setBackgroundPlaybackShortcut(
    ...
    if (Helpers.isPictureInPictureSupported(context)) {
      ...
      options.add(
          UiOptionItem.from(
              ...
              playerData.getBackgroundMode() == PlayerData.BACKGROUND_MODE_PIP
                  && generalData.getBackgroundPlaybackShortcut()
                      == GeneralData.BACKGROUND_PLAYBACK_SHORTCUT_HOME));

      options.add(
          UiOptionItem.from(
              String.format("%s (%s)", pip, context.getString(R.string.pressing_home_back)),
              optionItem -> {
                playerData.setBackgroundMode(PlayerData.BACKGROUND_MODE_PIP);
                generalData.setBackgroundPlaybackShortcut(
      ...
      options.add(
          UiOptionItem.from(
              String.format("%s (%s)", pip, context.getString(R.string.pressing_back)),
              optionItem -> {
                playerData.setBackgroundMode(PlayerData.BACKGROUND_MODE_PIP);
                generalData.setBackgroundPlaybackShortcut(
    ...
    options.add(
        UiOptionItem.from(
            String.format("%s (%s)", audio, context.getString(R.string.pressing_home)),
            optionItem -> {
    ...
    options.add(
        UiOptionItem.from(
            String.format("%s (%s)", audio, context.getString(R.string.pressing_home_back)),
            optionItem -> {
              playerData.setBackgroundMode(PlayerData.BACKGROUND_MODE_SOUND);
              generalData.setBackgroundPlaybackShortcut(
                  GeneralData.BACKGROUND_PLAYBACK_SHORTCUT_HOME_BACK);
    ...
    options.add(
        UiOptionItem.from(
            String.format("%s (%s)", audio, context.getString(R.string.pressing_back)),
            optionItem -> {
              playerData.setBackgroundMode(PlayerData.BACKGROUND_MODE_SOUND);
              generalData.setBackgroundPlaybackShortcut(
                  GeneralData.BACKGROUND_PLAYBACK_SHORTCUT_BACK);
    ...
    if (Helpers.isAndroidTV(context) && Build.VERSION.SDK_INT < 26) { // useful only for pre-Oreo UI
      ...
      options.add(
          UiOptionItem.from(
              String.format(
                  "%s (%s - %s)",
                  behind, "Android TV 5,6,7", context.getString(R.string.pressing_home)),
              optionItem -> {
      ...
      options.add(
          UiOptionItem.from(
              String.format(
                  "%s (%s - %s)",
                  behind, "Android TV 5,6,7", context.getString(R.string.pressing_home_back)),
              optionItem -> {
                playerData.setBackgroundMode(PlayerData.BACKGROUND_MODE_PLAY_BEHIND);
                generalData.setBackgroundPlaybackShortcut(
                    GeneralData.BACKGROUND_PLAYBACK_SHORTCUT_HOME_BACK);
    ...
    return OptionCategory.from(
        BACKGROUND_PLAYBACK_ID, OptionCategory.TYPE_RADIO_LIST, categoryTitle, options);
  }
  ...
  public static OptionCategory createVideoPresetsCategory(
      Context context, Runnable onFormatSelected) {
    return OptionCategory.from(
        VIDEO_PRESETS_ID,
        OptionCategory.TYPE_RADIO_LIST,
        context.getString(R.string.title_video_presets),
        fromPresets(context, AppDataSourceManager.instance().getVideoPresets(), onFormatSelected));
  }

  private static List<OptionItem> fromPresets(
      Context context, VideoPreset[] presets, Runnable onFormatSelected) {
    ...
    FormatItem noVideo =
        ExoFormatItem.from(
            MediaTrack.forRendererIndex(TrackSelectorManager.RENDERER_INDEX_VIDEO), true);
    result.add(
        0,
        UiOptionItem.from(
            context.getString(R.string.video_disabled),
            optionItem -> setFormat(noVideo, playerData, onFormatSelected),
    ...
    result.add(
        ...
        UiOptionItem.from(
            ...
            optionItem ->
                setFormat(playerData.getDefaultVideoFormat(), playerData, onFormatSelected),
            !isPresetSelection));
  ...
  private static void setFormat(
      FormatItem formatItem, PlayerData playerData, Runnable onFormatSelected) {
  ...
  public static OptionCategory createAudioLanguageCategory(
      Context context, Runnable onSetCallback) {
    PlayerData playerData = PlayerData.instance(context);
    ...
    // Alphabetical order
    Collections.sort(
        options, (o1, o2) -> ((String) o1.getTitle()).compareTo((String) o2.getTitle()));
    ...
    options.add(
        0,
        UiOptionItem.from(
            context.getString(R.string.original_lang),
            optionItem -> {
  ...
  public static OptionCategory createVideoRotateCategory(
      Context context, PlayerData playerData, Runnable onRotate) {
    List<OptionItem> options = new ArrayList<>();
    ...
    return OptionCategory.from(
        SUBTITLE_STYLES_ID, OptionCategory.TYPE_RADIO_LIST, videoRotateTitle, options);
  }
  ...
  public static OptionCategory createSpeedListCategory(
      Context context, PlayerManager playbackController) {
    PlayerData playerData = PlayerData.instance(context);
    List<OptionItem> items = new ArrayList<>();

    PlayerTweaksData data = PlayerTweaksData.instance(context);
    for (float speed :
        data.isLongSpeedListEnabled()
            ? Utils.SPEED_LIST_LONG
            : data.isExtraLongSpeedListEnabled()
                ? Utils.SPEED_LIST_EXTRA_LONG
                : Utils.SPEED_LIST_SHORT) {
      items.add(
          UiOptionItem.from(
              ...
              (playbackController != null ? playbackController.getSpeed() : playerData.getSpeed())
                  == speed));
    }

    return OptionCategory.from(
        PLAYER_SPEED_LIST_ID,
        OptionCategory.TYPE_RADIO_LIST,
        context.getString(R.string.video_speed),
        items);
  }
  ...
  public static OptionCategory createRememberSpeedCategory(Context context) {
    ...
    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_remember_speed_none),
            optionItem -> {
    ...
    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_remember_speed_all),
            optionItem -> playerData.setAllSpeedEnabled(true),
            playerData.isAllSpeedEnabled()));

    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_remember_speed_each),
            optionItem -> playerData.setSpeedPerVideoEnabled(true),
            playerData.isSpeedPerVideoEnabled()));

    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_speed_per_channel),
    ...
    return OptionCategory.from(
        PLAYER_REMEMBER_SPEED_ID, OptionCategory.TYPE_RADIO_LIST, title, options);
  }
  ...
  public static OptionCategory createSpeedMiscCategory(Context context) {
    ...
    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_long_speed_list),
            option -> playerTweaksData.setLongSpeedListEnabled(option.isSelected()),
            playerTweaksData.isLongSpeedListEnabled()));

    options.add(
        UiOptionItem.from(
            context.getString(R.string.player_extra_long_speed_list),
    ...
    return OptionCategory.from(
        PLAYER_SPEED_MISC_ID, OptionCategory.TYPE_CHECKBOX_LIST, title, options);
  }
  ...
  public static OptionCategory createPlaybackModeCategory(
      Context context, Runnable onModeSelected) {
    PlayerData playerData = PlayerData.instance(context);
    List<OptionItem> options = new ArrayList<>();
  ...
  public static OptionItem createSubscriptionsBackupButton(Context context) {
    ...
    String filePickerTitle =
        context.getString(R.string.import_subscriptions_group) + " (GrayJay/PocketTube/NewPipe)";
    OptionItem item =
        UiOptionItem.from(
            filePickerTitle,
            optionItem -> {
  ...
  private static MotherActivity getMotherActivity(Context context) {
    ...
    activity.addOnResult(
        (requestCode, resultCode, data) -> {
          if (FILE_PICKER_REQUEST_CODE == requestCode && resultCode == Activity.RESULT_OK) {
            String filePath = data.getStringExtra(FilePickerActivity.RESULT_FILE_PATH);
            RxHelper.execute(
                mService.importGroupsObserve(new File(filePath)),
                result -> pinGroups(context, result),
  ...
  public static void showConfirmationDialog(
      Context context, String title, Runnable onConfirm, Runnable onCancel) {
  ...
  public static void showAddToPlaylistDialog(
      Context context, Video video, VideoMenuCallback callback) {
    ...
    Disposable playlistsInfoAction =
        itemManager
            ...
            .subscribe(
                videoPlaylistInfos ->
                    showAddToPlaylistDialog(context, video, callback, videoPlaylistInfos, null),
                error -> {
  ...
  private static void appendPlaylistDialogContent(
          ...
          UiOptionItem.from(
              ...
              (item) -> {
                ...
                addRemoveFromPlaylist(
                    context, video, callback, playlistInfo.getPlaylistId(), item.isSelected());
    ...
    dialogPresenter.appendCheckedCategory(
        context.getString(R.string.dialog_add_to_playlist), options);
  }

  private static void addRemoveFromPlaylist(
      Context context, Video video, VideoMenuCallback callback, String playlistId, boolean add) {
    if (video == null) {
      return;
    }
    ...
    if (add) {
      editObserve =
          video.mediaItem != null
              ? itemManager.addToPlaylistObserve(playlistId, video.mediaItem)
              : itemManager.addToPlaylistObserve(playlistId, video.videoId);
    } else {
    ...
    RxHelper.execute(
        editObserve, error -> MessageHelpers.showLongMessage(context, error.getMessage()));
  }
  ...
  public static void showPlaylistOrderDialog(Context context, String playlistId, Runnable onClose) {
    ...
    for (int[] pair :
        new int[][] {
          {
            R.string.playlist_order_added_date_newer_first,
            MediaItemService.PLAYLIST_ORDER_ADDED_DATE_NEWER_FIRST
          },
          {
            R.string.playlist_order_added_date_older_first,
            MediaItemService.PLAYLIST_ORDER_ADDED_DATE_OLDER_FIRST
          },
          {R.string.playlist_order_popularity, MediaItemService.PLAYLIST_ORDER_POPULARITY},
          {
            R.string.playlist_order_published_date_newer_first,
            MediaItemService.PLAYLIST_ORDER_PUBLISHED_DATE_NEWER_FIRST
          },
          {
            R.string.playlist_order_published_date_older_first,
            MediaItemService.PLAYLIST_ORDER_PUBLISHED_DATE_OLDER_FIRST
          }
        }) {
      options.add(
          UiOptionItem.from(
              ...
              optionItem -> {
                if (optionItem.isSelected()) {
                  RxHelper.execute(
                      YouTubeMediaItemService.instance()
                          .setPlaylistOrderObserve(playlistId, pair[1]),
                      (error) ->
  ...
  public static void showPlaybackQueueDialog(Context context, OnVideoClick onClick) {
    ...
    for (Video video : playlist.getAll()) {
      ...
      options.add(
          UiOptionItem.from( // Add to end (like on mobile client)
              String.format(
                  "%s - %s", title != null ? title : "...", author != null ? author : "..."),
              optionItem -> {
