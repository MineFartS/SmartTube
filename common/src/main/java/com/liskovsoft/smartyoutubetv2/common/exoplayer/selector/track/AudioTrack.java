  ...
  public int inBounds(MediaTrack track2) {
    ...
    if (Helpers.equals(id1, id2)) {
      ...
      result = 1;
        ...
        && (TrackSelectorUtil.is51Audio(format) || !TrackSelectorUtil.is51Audio(track2.format))) {
      result = 1;
    }
