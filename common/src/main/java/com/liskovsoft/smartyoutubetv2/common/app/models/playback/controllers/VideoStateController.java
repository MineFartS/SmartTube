...
public class VideoStateController extends BasePlayerController {
    ...
    private static final long SHORT_LIVE_BUFFER_MS = 0; // Note, on buffer lower than the 60sec you'll notice segment
                                                        // skip
    ...
    public void onNewVideo(Video item) {
        ...
        if (getPlayer() != null && getPlayer().containsMedia()) {
            ...
            // NOTE: even for the same videos it's good to save state (switch from embed,
            // video reload
            // etc)
        ...
        // Don't do reset on videoLoaded state because this will influences minimized
        // music videos.
    ...
    public void onSourceChanged(Video item) {
        // At this stage video isn't loaded yet. So format switch isn't take any
        // resources.
        restoreFormats();
    }
    ...
    private void savePosition() {
        ...
        if (isPositionActual && !isLiveBroken) { // partially viewed
            ...
            // Mark video as fully viewed. This could help to restore proper progress marker
            // on the video
            // card later.
    ...
    private void restorePosition() {
        ...
        if (item.isLive
                && (state == null
                        || state.durationMs - state.positionMs < Math.max(RESTORE_LIVE_BUFFER_MS,
                                getLiveThreshold()))) {
