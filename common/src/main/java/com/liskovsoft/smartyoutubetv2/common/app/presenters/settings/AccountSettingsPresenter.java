...
public class AccountSettingsPresenter extends BasePresenter<Void> {
  ...
  private void appendSelectAccountSection(
      List<Account> accounts, AppDialogPresenter settingsPresenter) {
    ...
    settingsPresenter.appendRadioCategory(
        getContext().getString(R.string.dialog_account_list) + accountName, optionItems);
  }
  ...
  private void appendSignOutSection(List<Account> accounts, AppDialogPresenter settingsPresenter) {
    ...
    settingsPresenter.appendStringsCategory(
        getContext().getString(R.string.dialog_remove_account), optionItems);
  }
