...
public class ExoFormatItem implements FormatItem {
  ...
  public String toString() {
    ...
    return String.format(
        "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s",
        mType, rendererIndex, id, codecs, width, height, frameRate, language, isPreset, bitrate);
  }
      ...
      switch (mType) {
        ...
        case TYPE_AUDIO:
          ...
          return mIsPreset == formatItem.mIsPreset
              ...
              && Helpers.contains(
                  SubtitleTrack.trim(mLanguage), SubtitleTrack.trim(formatItem.mLanguage));
        case TYPE_SUBTITLE:
          return mType == formatItem.mType
              && Helpers.contains(
                  SubtitleTrack.trim(mLanguage), SubtitleTrack.trim(formatItem.mLanguage));
  ...
  public static ExoFormatItem from(
      int type,
      int rendererIndex,
      String id,
      String codecs,
    ...
    switch (type) {
      ...
      case TYPE_SUBTITLE:
        // Fake format. It's used in app internal comparison routine.
        mediaTrack.format = Format.createTextSampleFormat(id, null, -1, language);
        break;
    }
  ...
  public static ExoFormatItem from(String spec) {
    ...
    return from(
        type, rendererIndex, id, codecs, width, height, frameRate, language, isPreset, bitrate);
  }
  ...
  public static FormatItem fromVideoParams(int resolution, int format, int frameRate) {
    ...
    // Fake format. It's used in app internal comparison routine.
    mediaTrack.format =
        Format.createVideoSampleFormat(null, null, codec, -1, -1, width, height, fps, null, null);
  ...
  public static ExoFormatItem fromAudioData(int format) {
    ...
    // Fake format. It's used in app internal comparison routine.
    mediaTrack.format =
        Format.createAudioSampleFormat(null, null, codec, -1, -1, 0, 0, null, null, 0, null);
  ...
  public static ExoFormatItem fromAudioSpecs(String spec) {
    ...
    return from(
        TYPE_AUDIO,
        TrackSelectorManager.RENDERER_INDEX_AUDIO,
        null,
        codec,
        0,
        0,
  ...
  public static FormatItem fromSubtitleParams(String langCode) {
    ...
    MediaTrack mediaTrack =
        MediaTrack.forRendererIndex(TrackSelectorManager.RENDERER_INDEX_SUBTITLE);
    formatItem.mTrack = mediaTrack;
