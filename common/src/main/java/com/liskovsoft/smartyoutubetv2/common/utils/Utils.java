...
public class Utils {
  ...
  private static final String REMOTE_CONTROL_RECEIVER_CLASS_NAME =
      "com.liskovsoft.smartyoutubetv2.common.misc.RemoteControlReceiver";
  private static final String UPDATE_CHANNELS_RECEIVER_CLASS_NAME =
      "com.liskovsoft.leanbackassistant.channels.UpdateChannelsReceiver";
  private static final String BOOTSTRAP_ACTIVITY_CLASS_NAME =
  ...
  private static final String QR_CODE_URL_TEMPLATE =
  ...
  public static void showMultiChooser(Context context, Uri url) {
    ...
    Intent chooserIntent =
        Intent.createChooser(primaryIntent, context.getResources().getText(R.string.share_link));
  ...
  public static void startRemoteControlWorkRequest(Context context) {
    PeriodicWorkRequest workRequest =
        new PeriodicWorkRequest.Builder(RemoteControlWorker.class, 30, TimeUnit.MINUTES).build();
  ...
  /**
   * <a href="https://stackoverflow.com/questions/2891337/turning-on-screen-programmatically">More
   * info</a>
   */
  ...
  /**
   * <a href="https://developer.chrome.com/docs/android/custom-tabs/integration-guide/">Chrome
   * custom tabs</a>
   */
  ...
  private static List<RunningServiceInfo> getRunningServices(Context context) {
    ...
    try {
      ...
      // android.os.Parcelable$Creator.createFromParcel(android.os.Parcel)' on a null object
      // reference
      e.printStackTrace();
    }
  ...
  public static Notification createNotification(
    ...
    NotificationCompat.Builder builder =
        new NotificationCompat.Builder(context).setSmallIcon(iconResId).setContentTitle(title);
  ...
  public static void sendKey(Activity activity, int keyCode) {
    BaseInputConnection inputConnection =
        new BaseInputConnection(activity.getWindow().getDecorView().getRootView(), true);
