...
public class UiOptionItem implements OptionItem {
  ...
  public static List<OptionItem> from(
      List<FormatItem> formats, OptionCallback callback, String defaultTitle) {
    if (formats == null) {
      return null;
    }
  ...
  public static OptionItem from(
      CharSequence title, CharSequence description, OptionCallback callback, boolean isChecked) {
    return from(title, description, callback, isChecked, null);
  }

  public static OptionItem from(
      CharSequence title, OptionCallback callback, boolean isChecked, Object data) {
