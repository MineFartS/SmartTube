...
public class DebugInfoMediaCodecVideoRenderer extends MediaCodecVideoRenderer {
  ...
  // Exo 2.10, 2.11
  public DebugInfoMediaCodecVideoRenderer(
      Context context,
  ...
  protected boolean codecNeedsSetOutputSurfaceWorkaround(String name) {
    // Null surface error on Android 9 (VERSION.SDK_INT >= 28) and above (appears on background
    // audio playback)
  ...
  /**
   * Null surface error on Android 9 (VERSION.SDK_INT >= 28) and above (appears on background audio
   * playback)<br>
