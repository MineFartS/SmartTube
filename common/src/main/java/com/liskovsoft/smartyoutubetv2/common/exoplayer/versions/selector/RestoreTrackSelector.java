...
public class RestoreTrackSelector extends DefaultTrackSelector {
  ...
  public interface TrackSelectorCallback {
    ...
    void updateVideoTrackSelection(
        TrackGroupArray groups, Parameters params, Definition definition);

    void updateAudioTrackSelection(
        TrackGroupArray groups, Parameters params, Definition definition);

    void updateSubtitleTrackSelection(
        TrackGroupArray groups, Parameters params, Definition definition);
  }
  ...
  protected Definition selectVideoTrack(
    ...
    Definition definition =
        super.selectVideoTrack(
            groups, formatSupports, mixedMimeTypeAdaptationSupports, params, false);
    ...
    if (mCallback != null) {
      ...
      if (resultPair != null) {
        ...
        return new Pair<>(
            resultPair.first,
            new AudioTrackScore(
                resultPair.second.format, params, RendererCapabilities.FORMAT_HANDLED));
      } else {
  ...
  protected Pair<Definition, TextTrackScore> selectTextTrack(
    ...
    Pair<Definition, TextTrackScore> definitionPair =
        super.selectTextTrack(groups, formatSupport, params, selectedAudioLanguage);
