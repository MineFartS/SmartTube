...
public class ChannelUploadsMenuPresenter extends BaseMenuPresenter {
  ...
  private void appendOpenChannelButton() {
    ...
    mDialogPresenter.appendSingleButton(
        UiOptionItem.from(
            getContext().getString(R.string.open_channel),
            optionItem -> ChannelPresenter.instance(getContext()).openChannel(mVideo)));
  }
  ...
  private void appendUnsubscribeButton() {
    ...
    mDialogPresenter.appendSingleButton(
        UiOptionItem.from(
            getContext().getString(R.string.unsubscribe_from_channel),
            optionItem -> {
  ...
  private void appendMarkAsWatched() {
    ...
    mDialogPresenter.appendSingleButton(
        UiOptionItem.from(
            getContext().getString(R.string.mark_channel_as_watched),
            optionItem -> {
