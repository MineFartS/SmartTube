...
public abstract class CustomRenderersFactoryBase extends DefaultRenderersFactory {
  ...
  protected void replaceVideoRenderer(
      ArrayList<Renderer> renderers, MediaCodecVideoRenderer videoRenderer) {
  ...
  protected void replaceAudioRenderer(
      ArrayList<Renderer> renderers, MediaCodecAudioRenderer audioRenderer) {
