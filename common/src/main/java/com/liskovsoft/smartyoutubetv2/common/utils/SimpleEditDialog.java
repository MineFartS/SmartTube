...
public class SimpleEditDialog {
  ...
  public static void show(
      Context context, String dialogTitle, String defaultValue, OnChange onChange) {
  ...
  private static void show(
    ...
    configDialog
        ...
        .setOnClickListener((view) -> configDialog.dismiss());

    // editField.setNextFocusDownId(configDialog.getButton(AlertDialog.BUTTON_POSITIVE).getId()); //
    // OK button
  }
}
