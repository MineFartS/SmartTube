...
public class ViewManager {
  ...
  public void register(
      ...
      Class<? extends Activity> parentActivityClass) {
  ...
  public boolean isPlayerOnlyModeEnabled() {
    // return mIsPlayerOnlyModeEnabled && PlaybackPresenter.instance(mContext).getBackgroundMode()
    // != PlayerEngine.BACKGROUND_MODE_PIP;
  ...
  public void properlyFinishTheApp(Context activity) {
    if (activity instanceof MotherActivity) {
      ...
      // NOTE: The device may hung (SecurityException: requires
  ...
  private void safeStartActivityInt(Context context, Intent intent) {
    try {
      context.startActivity(intent);
        ...
        | SecurityException e) {
      // NPE: Attempt to write to field 'boolean
      // com.android.server.am.ActivityStack.mConfigWillChange' on a null object reference
  ...
  public boolean isVisible(Object view) {
    ...
    if (view instanceof androidx.fragment.app.Fragment) {
      ...
      return ((androidx.fragment.app.Fragment) view)
          .getLifecycle()
          .getCurrentState()
  ...
  public static MotherActivity getMotherActivity(Object view) {
    ...
    if (view instanceof androidx.fragment.app.Fragment
        && ((androidx.fragment.app.Fragment) view).getActivity() instanceof MotherActivity) {
