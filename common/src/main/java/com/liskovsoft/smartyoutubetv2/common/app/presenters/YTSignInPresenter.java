...
public class YTSignInPresenter extends SignInPresenter {
  ...
  // private static final String SIGN_IN_URL = "https://youtube.com/tv/activate"; // 18+, no search
  // history
  // private static final String SIGN_IN_URL = "https://youtube.com/activate"; // age restricted,
