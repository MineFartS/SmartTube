...
public class StableRestorePresenter extends BridgePresenter {
  ...
  private static final String STABLE_PKG_URL_ARM =
      "https://github.com/yuliskov/SmartTube/releases/download/latest/smarttube_stable.apk";
  private static final String STABLE_PKG_URL_ARM64 =
      "https://github.com/yuliskov/SmartTube/releases/download/latest/smarttube_stable_arm64-v8a.apk";
  private static final String STABLE_PKG_URL_X86 =
      "https://github.com/yuliskov/SmartTube/releases/download/latest/smarttube_stable_x86.apk";
