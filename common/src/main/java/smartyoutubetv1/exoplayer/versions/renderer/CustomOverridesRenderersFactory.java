package smartyoutubetv1.exoplayer.versions.renderer;
...
import smartyoutubetv1.exoplayer.versions.selector.BlacklistMediaCodecSelector;
...
public class CustomOverridesRenderersFactory extends CustomRenderersFactoryBase {
    ...
    protected void buildAudioRenderers(Context context, @ExtensionRendererMode int extensionRendererMode, MediaCodecSelector mediaCodecSelector,
        ...
        DelayMediaCodecAudioRenderer audioRenderer = new DelayMediaCodecAudioRenderer(
            context, 
            mediaCodecSelector, 
            drmSessionManager, 
